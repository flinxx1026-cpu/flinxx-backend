...
const Chat = () => {
  ...
  const VideoChatScreen = () => (
    <div className="flex flex-col md:flex-row-reverse w-full max-w-[1500px] mx-auto gap-12 px-10 mt-20 items-start overflow-visible" style={{ minHeight: '100vh', height: 'auto', backgroundColor: '#0f0f0f', overflow: 'visible' }}>
      {/* Main video container - responsive layout */}
      <div className="flex flex-col w-full gap-10 items-stretch justify-center" style={{ minHeight: '100vh', paddingTop: '80px', paddingBottom: '40px', overflow: 'visible' }}>
