import{r as A,a as Td,R as Kn,u as dt,b as Ad,c as yc,B as Cd,d as Sd,e as gt}from"./vendor-CWYb8WqM.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))r(s);new MutationObserver(s=>{for(const o of s)if(o.type==="childList")for(const a of o.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&r(a)}).observe(document,{childList:!0,subtree:!0});function t(s){const o={};return s.integrity&&(o.integrity=s.integrity),s.referrerPolicy&&(o.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?o.credentials="include":s.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function r(s){if(s.ep)return;s.ep=!0;const o=t(s);fetch(s.href,o)}})();var vc={exports:{}},oi={};/**
 * @license React
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const tf="FirebaseError";class bt extends Error{constructor(e,t,r){super(t),this.code=e,this.customData=r,this.name=tf,Object.setPrototypeOf(this,bt.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,Pn.prototype.create)}}class Pn{constructor(e,t,r){this.service=e,this.serviceName=t,this.errors=r}create(e,...t){const r=t[0]||{},s=`${this.service}/${e}`,o=this.errors[e],a=o?nf(o,r):"Error",u=`${this.serviceName}: ${a} (${s}).`;return new bt(s,u,r)}}function nf(n,e){return n.replace(rf,(t,r)=>{const s=e[r];return s!=null?String(s):`<${r}?>`})}const rf=/\{\$([^}]+)}/g;function sf(n){for(const e in n)if(Object.prototype.hasOwnProperty.call(n,e))return!1;return!0}function Dr(n,e){if(n===e)return!0;const t=Object.keys(n),r=Object.keys(e);for(const s of t){if(!r.includes(s))return!1;const o=n[s],a=e[s];if(nl(o)&&nl(a)){if(!Dr(o,a))return!1}else if(o!==a)return!1}for(const s of r)if(!t.includes(s))return!1;return!0}function nl(n){return n!==null&&typeof n=="object"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const up="firebase-heartbeat-database",hp=1,Lr="firebase-heartbeat-store";let Bi=null;function jc(){return Bi||(Bi=kc(up,hp,{upgrade:(n,e)=>{switch(e){case 0:try{n.createObjectStore(Lr)}catch(t){console.warn(t)}}}}).catch(n=>{throw an.create("idb-open",{originalErrorMessage:n.message})})),Bi}async function dp(n){try{const t=(await jc()).transaction(Lr),r=await t.objectStore(Lr).get(Oc(n));return await t.done,r}catch(e){if(e instanceof bt)Jt.warn(e.message);else{const t=an.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});Jt.warn(t.message)}}}async function cl(n,e){try{const r=(await jc()).transaction(Lr,"readwrite");await r.objectStore(Lr).put(e,Oc(n)),await r.done}catch(t){if(t instanceof bt)Jt.warn(t.message);else{const r=an.create("idb-set",{originalErrorMessage:t==null?void 0:t.message});Jt.warn(r.message)}}}function Oc(n){return`${n.name}!${n.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Kr{constructor(e,t){this.shortDelay=e,this.longDelay=t,Qt(t>e,"Short delay should be less than long delay!"),this.isMobile=Kd()||Yd()}get(){return Ep()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Mr(n,e,t=!1){if(t)return e;try{return await e}catch(r){throw r instanceof bt&&Np(r)&&n.auth.currentUser===n&&await n.auth.signOut(),r}}function Np({code:n}){return n==="auth/user-disabled"||n==="auth/user-token-expired"}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function zp(n,e){const t=jn(n,"auth");if(t.isInitialized()){const s=t.getImmediate(),o=t.getOptions();if(Dr(o,e??{}))return s;Rt(s,"already-initialized")}return t.initialize({options:e})}function Kp(n,e){const t=(e==null?void 0:e.persistence)||[],r=(Array.isArray(t)?t:[t]).map(qt);e!=null&&e.errorMap&&n._updateErrorMap(e.errorMap),n._initializeWithPersistence(r,e==null?void 0:e.popupRedirectResolver)}function Jp(n,e,t){const r=rr(n);J(r._canInitEmulator,r,"emulator-config-failed"),J(/^https?:\/\//.test(e),r,"invalid-emulator-scheme");const s=!1,o=Zc(e),{host:a,port:u}=Qp(e),h=u===null?"":`:${u}`;r.config.emulator={url:`${o}//${a}${h}/`},r.settings.appVerificationDisabledForTesting=!0,r.emulatorConfig=Object.freeze({host:a,port:u,protocol:o.replace(":",""),options:Object.freeze({disableWarnings:s})}),Yp()}function Zc(n){const e=n.indexOf(":");return e<0?"":n.substr(0,e+1)}function Qp(n){const e=Zc(n),t=/(\/\/)?([^?#/]+)/.exec(n.substr(e.length));if(!t)return{host:"",port:null};const r=t[2].split("@").pop()||"",s=/^(\[[^\]]+\])(:|$)/.exec(r);if(s){const o=s[1];return{host:o,port:vl(r.substr(o.length+1))}}else{const[o,a]=r.split(":");return{host:o,port:vl(a)}}}function vl(n){if(!n)return null;const e=Number(n);return isNaN(e)?null:e}function Yp(){function n(){const e=document.createElement("p"),t=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",t.position="fixed",t.width="100%",t.backgroundColor="#ffffff",t.border=".1em solid #000000",t.color="#b50000",t.bottom="0px",t.left="0px",t.margin="0px",t.zIndex="10000",t.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}typeof console<"u"&&typeof console.info=="function"&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials."),typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?window.addEventListener("DOMContentLoaded",n):n())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Gt extends Jr{constructor(){super("google.com"),this.addScope("profile")}static credential(e,t){return An._fromParams({providerId:Gt.PROVIDER_ID,signInMethod:Gt.GOOGLE_SIGN_IN_METHOD,idToken:e,accessToken:t})}static credentialFromResult(e){return Gt.credentialFromTaggedObject(e)}static credentialFromError(e){return Gt.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e)return null;const{oauthIdToken:t,oauthAccessToken:r}=e;if(!t&&!r)return null;try{return Gt.credential(t,r)}catch{return null}}}Gt.GOOGLE_SIGN_IN_METHOD="google.com";Gt.PROVIDER_ID="google.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class rn extends Jr{constructor(){super("github.com")}static credential(e){return An._fromParams({providerId:rn.PROVIDER_ID,signInMethod:rn.GITHUB_SIGN_IN_METHOD,accessToken:e})}static credentialFromResult(e){return rn.credentialFromTaggedObject(e)}static credentialFromError(e){return rn.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e||!("oauthAccessToken"in e)||!e.oauthAccessToken)return null;try{return rn.credential(e.oauthAccessToken)}catch{return null}}}rn.GITHUB_SIGN_IN_METHOD="github.com";rn.PROVIDER_ID="github.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class sn extends Jr{constructor(){super("twitter.com")}static credential(e,t){return An._fromParams({providerId:sn.PROVIDER_ID,signInMethod:sn.TWITTER_SIGN_IN_METHOD,oauthToken:e,oauthTokenSecret:t})}static credentialFromResult(e){return sn.credentialFromTaggedObject(e)}static credentialFromError(e){return sn.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e)return null;const{oauthAccessToken:t,oauthTokenSecret:r}=e;if(!t||!r)return null;try{return sn.credential(t,r)}catch{return null}}}sn.TWITTER_SIGN_IN_METHOD="twitter.com";sn.PROVIDER_ID="twitter.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function em(n,e,t=!1){const{auth:r}=n;if(At(r.app))return Promise.reject(ln(r));const s="reauthenticate";try{const o=await Mr(n,tu(r,s,e,n),t);J(o.idToken,r,"internal-error");const a=Do(o.idToken);J(a,r,"internal-error");const{sub:u}=a;return J(n.uid===u,r,"user-mismatch"),Jn._forOperation(n,s,o)}catch(o){throw(o==null?void 0:o.code)==="auth/user-not-found"&&Rt(r,"user-mismatch"),o}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function km(n,e,t){return Pm(n,e,t)}async function Pm(n,e,t){if(At(n.app))return Promise.reject(ln(n));const r=rr(n);Mc(n,e,ci),await r._initializationPromise;const s=Vo(r,t);return await Rm(s,r),s._openRedirect(r,e,"signInViaRedirect")}async function jm(n,e){return await rr(n)._initializationPromise,fu(n,e,!1)}async function fu(n,e,t=!1){if(At(n.app))return Promise.reject(ln(n));const r=rr(n),s=Vo(r,e),a=await new Cm(r,s,t).execute();return a&&!t&&(delete a.user._redirectEventId,await r._persistUserIfCurrent(a.user),await r._setRedirectUser(null,e)),a}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const $m=new Kr(3e4,6e4);function bl(){const n=Ct().___jsl;if(n!=null&&n.H){for(const e of Object.keys(n.H))if(n.H[e].r=n.H[e].r||[],n.H[e].L=n.H[e].L||[],n.H[e].r=[...n.H[e].L],n.CP)for(let t=0;t<n.CP.length;t++)n.CP[t]=null}}function Gm(n){return new Promise((e,t)=>{var r,s,o;function a(){bl(),gapi.load("gapi.iframes",{callback:()=>{e(gapi.iframes.getContext())},ontimeout:()=>{bl(),t(It(n,"network-request-failed"))},timeout:$m.get()})}if(!((s=(r=Ct().gapi)===null||r===void 0?void 0:r.iframes)===null||s===void 0)&&s.Iframe)e(gapi.iframes.getContext());else if(!((o=Ct().gapi)===null||o===void 0)&&o.load)a();else{const u=qp("iframefcb");return Ct()[u]=()=>{gapi.load?a():t(It(n,"network-request-failed"))},Hp(`${Wp()}?onload=${u}`).catch(h=>t(h))}}).catch(e=>{throw ks=null,e})}let ks=null;function Hm(n){return ks=ks||Gm(n),ks}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function dg(n){switch(n){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";case"WebExtension":return"web-extension";default:return}}function fg(n){St(new Et("auth",(e,{options:t})=>{const r=e.getProvider("app").getImmediate(),s=e.getProvider("heartbeat"),o=e.getProvider("app-check-internal"),{apiKey:a,authDomain:u}=r.options;J(a&&!a.includes(":"),"invalid-api-key",{appName:r.name});const h={apiKey:a,authDomain:u,clientPlatform:n,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:Xc(n)},f=new $p(r,s,o,h);return Kp(f,t),f},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((e,t,r)=>{e.getProvider("auth-internal").initialize()})),St(new Et("auth-internal",e=>{const t=rr(e.getProvider("auth").getImmediate());return(r=>new hg(r))(t)},"PRIVATE").setInstantiationMode("EXPLICIT")),ht(Al,Cl,dg(n)),ht(Al,Cl,"esm2017")}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class _t{constructor(e){this.value=e}static empty(){return new _t({mapValue:{}})}field(e){if(e.isEmpty())return this.value;{let t=this.value;for(let r=0;r<e.length-1;++r)if(t=(t.mapValue.fields||{})[e.get(r)],!js(t))return null;return t=(t.mapValue.fields||{})[e.lastSegment()],t||null}}set(e,t){this.getFieldsMap(e.popLast())[e.lastSegment()]=Rr(t)}setAll(e){let t=Ge.emptyPath(),r={},s=[];e.forEach((a,u)=>{if(!t.isImmediateParentOf(u)){const h=this.getFieldsMap(t);this.applyChanges(h,r,s),r={},s=[],t=u.popLast()}a?r[u.lastSegment()]=Rr(a):s.push(u.lastSegment())});const o=this.getFieldsMap(t);this.applyChanges(o,r,s)}delete(e){const t=this.field(e.popLast());js(t)&&t.mapValue.fields&&delete t.mapValue.fields[e.lastSegment()]}isEqual(e){return kt(this.value,e.value)}getFieldsMap(e){let t=this.value;t.mapValue.fields||(t.mapValue={fields:{}});for(let r=0;r<e.length;++r){let s=t.mapValue.fields[e.get(r)];js(s)&&s.mapValue.fields||(s={mapValue:{fields:{}}},t.mapValue.fields[e.get(r)]=s),t=s}return t.mapValue.fields}applyChanges(e,t,r){Yr(t,(s,o)=>e[s]=o);for(const s of r)delete e[s]}clone(){return new _t(Rr(this.value))}}function Cu(n){const e=[];return Yr(n.fields,(t,r)=>{const s=new Ge([t]);if(js(r)){const o=Cu(r.mapValue).fields;if(o.length===0)e.push(s);else for(const a of o)e.push(s.child(a))}else e.push(s)}),new wt(e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class My{constructor(){this.changes=new ir(e=>e.toString(),(e,t)=>e.isEqual(t)),this.changesApplied=!1}addEntry(e){this.assertNotApplied(),this.changes.set(e.key,e)}removeEntry(e,t){this.assertNotApplied(),this.changes.set(e,vt.newInvalidDocument(e).setReadTime(t))}getEntry(e,t){this.assertNotApplied();const r=this.changes.get(t);return r!==void 0?O.resolve(r):this.getFromCache(e,t)}getEntries(e,t){return this.getAllFromCache(e,t)}apply(e){return this.assertNotApplied(),this.changesApplied=!0,this.applyChanges(e)}assertNotApplied(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Qy{constructor(){this.Gi=!1,this.zi=!1,this.ji=100,this.Hi=function(){return Zd()?8:Dg(Xe())>0?6:4}()}initialize(e,t){this.Ji=e,this.indexManager=t,this.Gi=!0}getDocumentsMatchingQuery(e,t,r,s){const o={result:null};return this.Yi(e,t).next(a=>{o.result=a}).next(()=>{if(!o.result)return this.Zi(e,t,s,r).next(a=>{o.result=a})}).next(()=>{if(o.result)return;const a=new Jy;return this.Xi(e,t,a).next(u=>{if(o.result=u,this.zi)return this.es(e,t,a,u.size)})}).next(()=>o.result)}es(e,t,r,s){return r.documentReadCount<this.ji?(br()<=ie.DEBUG&&W("QueryEngine","SDK will not create cache indexes for query:",xr(t),"since it only creates cache indexes for collection contains","more than or equal to",this.ji,"documents"),O.resolve()):(br()<=ie.DEBUG&&W("QueryEngine","Query:",xr(t),"scans",r.documentReadCount,"local documents and returns",s,"documents as results."),r.documentReadCount>this.Hi*s?(br()<=ie.DEBUG&&W("QueryEngine","The SDK decides to create cache indexes for query:",xr(t),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(e,Tn(t))):O.resolve())}Yi(e,t){if(Fl(t))return O.resolve(null);let r=Tn(t);return this.indexManager.getIndexType(e,r).next(s=>s===0?null:(t.limit!==null&&s===1&&(t=po(t,null,"F"),r=Tn(t)),this.indexManager.getDocumentsMatchingTarget(e,r).next(o=>{const a=Qe(...o);return this.Ji.getDocuments(e,a).next(u=>this.indexManager.getMinOffset(e,r).next(h=>{const f=this.ts(t,u);return this.ns(t,f,a,h.readTime)?this.Yi(e,po(t,null,"F")):this.rs(e,f,t,h)}))})))}Zi(e,t,r,s){return Fl(t)||s.isEqual(be.min())?O.resolve(null):this.Ji.getDocuments(e,r).next(o=>{const a=this.ts(t,o);return this.ns(t,a,r,s)?O.resolve(null):(br()<=ie.DEBUG&&W("QueryEngine","Re-using previous result from %s to execute query: %s",s.toString(),xr(t)),this.rs(e,a,t,Ng(s,-1)).next(u=>u))})}ts(e,t){let r=new Ye(ny(e));return t.forEach((s,o)=>{zo(e,o)&&(r=r.add(o))}),r}ns(e,t,r,s){if(e.limit===null)return!1;if(r.size!==t.size)return!0;const o=e.limitType==="F"?t.last():t.first();return!!o&&(o.hasPendingWrites||o.version.compareTo(s)>0)}Xi(e,t,r){return br()<=ie.DEBUG&&W("QueryEngine","Using full collection scan to execute query:",xr(t)),this.Ji.getDocumentsMatchingQuery(e,t,un.min(),r)}rs(e,t,r,s){return this.Ji.getDocumentsMatchingQuery(e,r,s).next(o=>(t.forEach(a=>{o=o.insert(a.key,a)}),o))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class na{constructor(e,t,r){this.converter=t,this._query=r,this.type="query",this.firestore=e}withConverter(e){return new na(this.firestore,e,this._query)}}class Kt{constructor(e,t,r){this.converter=t,this._key=r,this.type="document",this.firestore=e}get _path(){return this._key.path}get id(){return this._key.path.lastSegment()}get path(){return this._key.path.canonicalString()}get parent(){return new Gr(this.firestore,this.converter,this._key.path.popLast())}withConverter(e){return new Kt(this.firestore,e,this._key)}}class Gr extends na{constructor(e,t,r){super(e,t,Zg(r)),this._path=r,this.type="collection"}get id(){return this._query.path.lastSegment()}get path(){return this._query.path.canonicalString()}get parent(){const e=this._path.popLast();return e.isEmpty()?null:new Kt(this.firestore,null,new re(e))}withConverter(e){return new Gr(this.firestore,e,this._path)}}function Ov(n,e,...t){if(n=tt(n),arguments.length===1&&(e=Eu.newId()),kv("doc","path",e),n instanceof ta){const r=Se.fromString(e,...t);return Zl(r),new Kt(n,null,new re(r))}{if(!(n instanceof Kt||n instanceof Gr))throw new Q(D.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const r=n._path.child(Se.fromString(e,...t));return Zl(r),new Kt(n.firestore,n instanceof Gr?n.converter:null,new re(r))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Hr{constructor(e){this._byteString=e}static fromBase64String(e){try{return new Hr(Nt.fromBase64String(e))}catch(t){throw new Q(D.INVALID_ARGUMENT,"Failed to construct data from Base64 string: "+t)}}static fromUint8Array(e){return new Hr(Nt.fromUint8Array(e))}toBase64(){return this._byteString.toBase64()}toUint8Array(){return this._byteString.toUint8Array()}toString(){return"Bytes(base64: "+this.toBase64()+")"}isEqual(e){return this._byteString.isEqual(e._byteString)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`),!1}},[S]);A.useEffect(()=>{fn.current={reinitializeCamera:dr}},[dr]),A.useEffect(()=>{if(!de)return;const N=setInterval(()=>{_(G=>G+1)},1e3);return()=>clearInterval(N)},[de]),A.useEffect(()=>{U&&S&&console.log("🎬 [PARTNER FOUND] Transitioning to video chat screen")},[U,S]);const ss=async()=>{var N;try{if(console.log("📹 [START CAMERA] User clicked to start camera"),console.log("📹 [START CAMERA] Checking DOM state..."),console.log("   localVideoRef.current:",!!ae.current),console.log("   localVideoRef.current in DOM:",(N=ae.current)!=null&&N.parentElement?"YES":"NO"),console.log("   All videos in DOM:",document.querySelectorAll("video").length),!ae.current){console.error("📹 [START CAMERA] ❌ Video element not in DOM - cannot proceed");return}console.log("📹 [START CAMERA] Requesting camera from browser...");const G=await navigator.mediaDevices.getUserMedia({video:!0,audio:!1});Xt.current=G,te.current=G,console.log("📹 [START CAMERA] ✅ Stream obtained:",G),console.log("📹 [START CAMERA] Stream tracks:",G.getTracks().map(M=>({kind:M.kind,enabled:M.enabled,id:M.id}))),ae.current&&(ae.current.srcObject=G,console.log("📹 [START CAMERA] ✅ Stream attached to video element"),ae.current.onloadedmetadata=()=>{console.log("📹 [START CAMERA] ✅ Video metadata loaded, calling play()"),ae.current.play().then(()=>{console.log("📹 [START CAMERA] ✅ Video playing - setting isLocalCameraReady=true"),Tt(!0)}).catch(M=>{console.warn("📹 [START CAMERA] ⚠️ Play warning (but video loaded):",M.message),Tt(!0)})})}catch(G){console.error("📹 [START CAMERA] ❌ CRITICAL ERROR:",G),console.error("   Error name:",G.name),console.error("   Error message:",G.message),G.name==="NotAllowedError"?console.error("❌ Camera permission DENIED by user - User clicked deny in browser prompt"):G.name==="NotFoundError"?console.error("❌ No camera device found - Check if device has a camera"):G.name==="NotReadableError"?console.error("❌ Camera is already in use by another app - Close other apps using camera"):G.name==="SecurityError"&&console.error("❌ Camera access blocked by security policy - Must use HTTPS")}};A.useEffect(()=>()=>{console.log("📹 [DASHBOARD CLEANUP] Component unmounting"),console.log("📹 [DASHBOARD CLEANUP] ⚠️ NOT stopping camera - will be reused on return")},[]),A.useEffect(()=>{const N=setInterval(()=>{},500);return()=>clearInterval(N)},[]);const Zt=async()=>{if(console.log("🔧 createPeerConnection called"),console.log("   Current localStreamRef:",te.current),!te.current){console.warn("⚠️ CRITICAL: localStreamRef.current is null - attempting to reacquire camera stream");try{const ee=await navigator.mediaDevices.getUserMedia({video:{width:{ideal:640},height:{ideal:480}},audio:!0});if(te.current=ee,ae.current){ae.current.srcObject=ee,ae.current.muted=!0;try{await ae.current.play()}catch(V){console.warn("⚠️ Play error during reacquisition:",V)}}console.log("✅ LOCAL STREAM RE-ACQUIRED SUCCESSFULLY"),console.log("   Tracks:",ee.getTracks().map(V=>({kind:V.kind,id:V.id})))}catch(ee){throw console.error("❌ FATAL: Could not reacquire camera stream:",ee.message),new Error("Cannot proceed: local camera stream unavailable - "+ee.message)}}AI();const N=await fr(),G=[{urls:["stun:global.xirsys.net","turn:global.xirsys.net:3478?transport=udp","turn:global.xirsys.net:3478?transport=tcp"],username:"nkhlvdv",credential:"a8e244b8-cf5b-11f0-8771-0242ac140002"},...N];console.log("🔧 ICE Servers Configuration:",{count:G.length,servers:G.map(ee=>({urls:ee.urls,username:ee.username?"***":void 0,credential:ee.credential?"***":void 0}))});const M=new RTCPeerConnection({iceServers:G,iceTransportPolicy:"all"});if(z.current=M,console.log("✅ RTCPeerConnection created with iceTransportPolicy: all"),M.onicecandidate=ee=>{if(ee.candidate){const V=ee.candidate;console.log("🧊 ICE candidate generated:",{candidate:V.candidate,protocol:V.protocol,port:V.port,address:V.address,type:V.type,priority:V.priority,sdpMLineIndex:V.sdpMLineIndex,sdpMId:V.sdpMid}),V.type==="relay"?(console.log("🔄 RELAY (TURN) candidate generated - TURN server is reachable"),console.log("   Protocol:",V.protocol,"Port:",V.port)):V.type==="srflx"?(console.log("📍 SRFLX (server reflexive) candidate - STUN working"),console.log("   Found public address via STUN")):V.type==="host"&&console.log("🏠 HOST candidate - direct LAN connection possible"),console.log("🔌 Sending ICE candidate to partner socket:",st.current),K.emit("ice_candidate",{candidate:V,to:st.current}),console.log("📤 ICE candidate sent to peer")}else console.log("🧊 ICE gathering complete (null candidate received)"),console.log("📊 ICE gathering summary:"),console.log("   Connection State:",M.connectionState),console.log("   ICE Connection State:",M.iceConnectionState),console.log("   ICE Gathering State:",M.iceGatheringState)},M.oniceconnectionstatechange=()=>{const ee=M.iceConnectionState;switch(console.log(`
🧊 ===== ICE CONNECTION STATE CHANGED =====`),console.log("🧊 New ICE Connection State:",ee),ee){case"new":console.log("🧊 State: NEW - Gathering ICE candidates");break;case"checking":console.log("🧊 State: CHECKING - Testing ICE candidate pairs"),console.log("🧊 Connection in progress - waiting for connectivity");break;case"connected":console.log("✅ State: CONNECTED - Found working ICE candidate pair"),console.log("🧊 Peer-to-peer communication established");break;case"completed":console.log("✅ State: COMPLETED - ICE checks completed, ready for media"),console.log("🧊 All connectivity checks passed");break;case"failed":console.error("❌ State: FAILED - All ICE candidate pairs failed"),console.error("❌ Could not establish peer-to-peer connection"),console.error("❌ TURN server may be unreachable or blocked by ISP"),console.error("🔍 Troubleshooting:"),console.error("   - Check console for TURN error details"),console.error("   - TURN error 701 = Network/ISP blocking ports 3478, 5349"),console.error("   - Solutions: Try VPN, different WiFi, or mobile hotspot"),console.error("   - User can retry with a retry button (do NOT auto-restart ICE)");break;case"disconnected":console.warn("⚠️ State: DISCONNECTED - Lost connection to peer"),console.warn("   Note: ICE restart is manual only to prevent stream loss");break;case"closed":console.log("🛑 State: CLOSED - Connection closed");break}console.log("📊 Full connection states:"),console.log("   Signaling State:",M.signalingState),console.log("   Connection State:",M.connectionState),console.log("   ICE Gathering State:",M.iceGatheringState)},z.current._remoteStream||(z.current._remoteStream=new MediaStream,console.log("✅ PERSISTENT REMOTE STREAM CREATED - will accumulate all incoming tracks")),M.ontrack=ee=>{console.log(`

🔴🔴🔴 ===== CRITICAL: ONTRACK HANDLER FIRING! =====`),console.log("🔴 ONTRACK CALLED AT:",new Date().toISOString()),console.log("🔴 Track received:",{kind:ee.track.kind,id:ee.track.id,enabled:ee.track.enabled});const V=z.current._remoteStream;if(console.log("🔴 Using persistent remote stream ID:",V.id),V.addTrack(ee.track),console.log("✅ Track added to persistent remote stream"),console.log("📥 Remote stream now has",V.getTracks().length,"track(s)"),console.log("📥 Tracks:",V.getTracks().map(le=>({kind:le.kind,id:le.id,enabled:le.enabled}))),!lt.current){console.error("❌ CRITICAL ERROR: remoteVideoRef.current is NULL!"),console.error("   Cannot attach remote track - video element not available");return}lt.current.srcObject!==V?(console.log("📺 ATTACHING PERSISTENT STREAM to remoteVideoRef"),lt.current.srcObject=V,lt.current.muted=!1,console.log("📺 srcObject attached, attempting play()..."),lt.current.play().catch(()=>{console.log("ℹ️ Autoplay blocked - will play on user interaction")})):(console.log("📺 STREAM ALREADY ATTACHED - skipping re-attachment"),console.log("   Stream has",V.getTracks().length,"tracks now")),console.log(`✅ ✅ ✅ ONTRACK COMPLETE - Remote stream persisted and attached
...
📋 ===== PARTNER FOUND EVENT RECEIVED =====`),console.log("👥 RAW DATA from server:",JSON.stringify(N,null,2)),console.log("👥 My socket ID:",K.id),console.log("👥 currentUser object:",JSON.stringify(Z,null,2)),console.log("👥 userIdRef.current (SHOULD USE THIS):",he.current),console.log("👥 currentUser.googleId:",Z==null?void 0:Z.googleId),console.log("👥 currentUser.id:",Z==null?void 0:Z.id),console.log("👥 data.socketId:",N.socketId),console.log("👥 data.partnerId:",N.partnerId),console.log("👥 data.userName:",N.userName),b(!1),X(!0),Lt(!1),console.log(`
👥 SELF-MATCH CHECK - START`);const G=he.current,M=N.partnerId;if(console.log("👥 COMPARISON VALUES:"),console.log("   myUserId type:",typeof G,"value:",G),console.log("   partnerUserId type:",typeof M,"value:",M),console.log("   Are they EQUAL?",G===M),console.log("   String comparison:",String(G)===String(M)),G===M){console.error(`
❌❌❌ CRITICAL ERROR: SELF-MATCH DETECTED! ❌❌❌`),console.error("   My user ID:",G,"type:",typeof G),console.error("   Partner user ID:",M,"type:",typeof M),console.error("   Match IDs:",G===M),console.error("   These should be DIFFERENT!"),Lt(!0),console.error("   Emitting skip_user..."),K.emit("skip_user",{partnerSocketId:N.socketId}),console.error("   Emitting find_partner..."),K.emit("find_partner",{userId:he.current,userName:Z.name||"Anonymous",userAge:Z.age||18,userLocation:Z.location||"Unknown"}),console.error("   Returning - match REJECTED");return}console.log("✅ SELF-MATCH CHECK PASSED - partner is different user"),console.log("   Accepting match and proceeding with WebRTC setup"),console.log(`👥 SELF-MATCH CHECK - END
`),st.current=N.socketId,console.log("🔌 CRITICAL: Stored partner socket ID:",st.current),console.log("🔌 CRITICAL: Verification - partnerSocketIdRef.current is now:",st.current),console.log("🎬 ABOUT TO CALL setHasPartner(true)"),B(!0),console.log("🎬 ✅ setHasPartner(true) CALLED - force attach effect should trigger");const ee={...N,picture:N.userPicture||N.picture||null,userName:N.userName||N.name||"Anonymous",userLocation:N.userLocation||N.location||"Unknown",userAge:N.userAge||N.age||18};m(ee),console.log("🎬 ✅ setPartnerInfo CALLED with data:",ee);const V=K.id,le=N.socketId,pe=V<le;if(console.log("🔍 SOCKET ID COMPARISON:"),console.log("   My socket ID:",V),console.log("   Partner socket ID:",le),console.log("   Am I offerer? (myID < partnerID):",pe),console.log(`
🔐 ===== CRITICAL STREAM VERIFICATION =====`),console.log("🔐 Checking localStreamRef.current status:"),console.log("   exists:",!!te.current),console.log("   tracks:",((ke=te.current)==null?void 0:ke.getTracks().length)||0),console.log("   video element srcObject:",!!((We=ae.current)!=null&&We.srcObject)),!te.current){console.error("🔐 ❌ CRITICAL: localStreamRef.current is NULL - cannot proceed to WebRTC"),console.error("   This means the camera stream was never acquired or was lost"),console.error("   Attempting emergency camera reacquisition...");try{const fe=await navigator.mediaDevices.getUserMedia({video:{width:{ideal:640},height:{ideal:480}},audio:!0});if(te.current=fe,ae.current){ae.current.srcObject=fe,ae.current.muted=!0;try{await ae.current.play()}catch{console.warn("⚠️ Play error in emergency reacquisition")}}console.log("🔐 ✅ EMERGENCY: Camera stream re-acquired")}catch(fe){console.error("🔐 ❌ EMERGENCY FAILED: Could not reacquire camera -",fe.message),console.error("   User must allow camera permission to continue");return}}if(console.log(`🔐 ✅ STREAM VERIFICATION PASSED - proceeding with WebRTC
...
🏠 OFFERER: Creating peer connection`),z.current){console.warn("⚠️ OFFERER: WARNING - Peer connection already exists! Not recreating."),console.warn("   Existing PC state:",{connectionState:z.current.connectionState,iceConnectionState:z.current.iceConnectionState,signalingState:z.current.signalingState});return}let fe;try{fe=await Zt()}catch(Ie){console.error("❌ OFFERER: Error creating peer connection:",Ie);return}if(z.current=fe,console.log("✅ OFFERER: Peer connection created"),console.log("📊 OFFERER Stream status after peer connection creation:",{exists:!!te.current,trackCount:(Ee=te.current)==null?void 0:Ee.getTracks().length,tracks:(Pe=te.current)==null?void 0:Pe.getTracks().map(Ie=>({kind:Ie.kind,enabled:Ie.enabled,state:Ie.readyState}))}),te.current){console.log(`
👤 OFFERER localStream:`,te.current);const Ie=te.current.getTracks();console.log("👤 OFFERER: All available tracks:",Ie),console.log("📹 OFFERER tracks detail:",Ie.map(Ve=>({kind:Ve.kind,id:Ve.id,enabled:Ve.enabled,state:Ve.readyState})));const Ft=fe.getSenders();if(console.log("📤 OFFERER: Existing senders count:",Ft.length),Ft.length>0)console.warn("⚠️ OFFERER WARNING: Tracks already added! Senders:",Ft.map(Ve=>{var je,pt;return{kind:(je=Ve.track)==null?void 0:je.kind,id:(pt=Ve.track)==null?void 0:pt.id}})),console.warn("   Not adding tracks again to avoid duplicates");else{console.log(`
📹 OFFERER: Adding ${Ie.length} local tracks to peer connection`),Ie.forEach((je,pt)=>{console.log(`  [${pt}] Adding ${je.kind} track (id: ${je.id}, enabled: ${je.enabled})`);try{const Vt=fe.addTrack(je,te.current);console.log(`  [${pt}] ✅ addTrack succeeded, sender:`,Vt)}catch(Vt){console.error(`  [${pt}] ❌ addTrack failed:`,Vt)}}),console.log(`
✅ OFFERER: All tracks added to peer connection`);const Ve=fe.getSenders();console.log("📤 OFFERER senders count:",Ve.length),console.log("📤 OFFERER senders after addTrack:",Ve.map((je,pt)=>{var Vt,ls,mn;return{index:pt,kind:(Vt=je.track)==null?void 0:Vt.kind,id:(ls=je.track)==null?void 0:ls.id,trackExists:!!je.track,trackEnabled:(mn=je.track)==null?void 0:mn.enabled}})),console.log("🚀 OFFERER: Ready to send offer with",Ie.length,`tracks
...
📋 ===== OFFERER CREATING AND SENDING OFFER =====`),console.log("🎬 OFFERER: Creating WebRTC offer with offerToReceiveVideo/Audio");const ct=await fe.createOffer({offerToReceiveVideo:!0,offerToReceiveAudio:!0});console.log("✅ OFFERER: Offer created with receive constraints:",ct),console.log("📋 OFFERER SDP CHECK - Looking for a=sendrecv:");const it=ct.sdp.split(`
`).filter(Ie=>Ie.includes("sendrecv")||Ie.includes("recvonly")||Ie.includes("sendonly"));console.log("   Media direction lines:"),it.forEach(Ie=>console.log("   ",Ie)),console.log("🔄 OFFERER: Setting local description (offer)"),await fe.setLocalDescription(ct),console.log("✅ OFFERER: Local description set"),console.log(`
📤 OFFERER: Sending offer with tracks:`,fe.getSenders().map(Ie=>{var Ft,Ve,je;return{kind:(Ft=Ie.track)==null?void 0:Ft.kind,id:(Ve=Ie.track)==null?void 0:Ve.id,enabled:(je=Ie.track)==null?void 0:je.enabled}})),console.log("📤 OFFERER: Partner socket ID from data:",N.socketId),console.log("📤 OFFERER: partnerSocketIdRef.current value:",st.current),console.log("🔌🔌🔌 CRITICAL: About to emit webrtc_offer with to:",N.socketId),console.log("🔌🔌🔌 CRITICAL: Is to value empty/null/undefined?",!N.socketId),K.emit("webrtc_offer",{offer:z.current.localDescription,to:N.socketId}),console.log("✅ OFFERER: webrtc_offer emitted successfully"),console.log("✅ OFFERER: webrtc_offer sent to socket ID:",N.socketId),console.log("✅ OFFERER: webrtc_offer contains",z.current.getSenders().length,"senders"),console.log("✅ OFFERER: Sent to socket:",N.socketId)}catch(fe){console.error("❌ OFFERER: Error in partner_found handler:",fe),console.error("❌ OFFERER: Stack trace:",fe.stack)}}),K.on("webrtc_offer",async N=>{console.log(`

🎉🎉🎉🎉🎉🎉🎉🎉🎉🎉🎉🎉🎉🎉🎉🎉🎉🎉🎉🎉🎉🎉🎉`),console.log("🎉🎉🎉 ⭐️ ANSWERER HANDLER FIRED ⭐️ 🎉🎉🎉"),console.log("🎉🎉🎉🎉🎉🎉🎉🎉🎉🎉🎉🎉🎉🎉🎉🎉🎉🎉🎉🎉🎉🎉🎉"),console.log("📋 ===== ANSWERER RECEIVED OFFER ====="),console.log("⭐️ ANSWERER: WEBRTC_OFFER EVENT FIRED - OFFER WAS RECEIVED"),console.log("📨 ANSWERER: Received WebRTC offer from offerer"),console.log("📨 ANSWERER: My socket ID:",K.id),console.log("📨 ANSWERER: Offer from:",N.from),console.log("📨 ANSWERER: Full data:",N),console.log("📨 ANSWERER: data.from (offerer socket ID):",N.from),st.current=N.from,console.log("🔌 CRITICAL: Stored offerer socket ID:",st.current);try{if(z.current)console.log("⚠️ ANSWERER: WARNING - peerConnectionRef already exists (should be null for answerer)");else{console.log("📍 ANSWERER: Creating new peer connection for the first time");let V;try{V=await Zt()}catch(le){console.error("❌ ANSWERER: Error creating peer connection:",le);return}z.current=V,console.log("✅ ANSWERER: Peer connection created")}if(console.log(`
🔍 ANSWERER: ALWAYS executing track addition logic`),console.log("👤 ANSWERER: Checking localStreamRef.current..."),console.log("👤 ANSWERER localStreamRef.current:",te.current),console.log("👤 ANSWERER localStreamRef.current === null?",te.current===null),console.log("👤 ANSWERER localStreamRef.current === undefined?",te.current===void 0),!te.current){console.warn("⚠️ ANSWERER: localStreamRef.current is NULL - attempting emergency reacquisition");try{const V=await navigator.mediaDevices.getUserMedia({video:{width:{ideal:640},height:{ideal:480}},audio:!0});if(te.current=V,ae.current){ae.current.srcObject=V,ae.current.muted=!0;try{await ae.current.play()}catch{console.warn("⚠️ Play error in answerer emergency reacquisition")}}console.log("✅ ANSWERER: Emergency stream acquisition successful")}catch(V){throw console.error("❌ ANSWERER: Emergency stream acquisition failed:",V.message),new Error("ANSWERER: Cannot reacquire camera stream - "+V.message)}}if(te.current){console.log(`
✅ ANSWERER: localStream EXISTS - will add tracks`),console.log("📊 ANSWERER localStream object:",te.current);const V=te.current.getTracks();console.log("👤 ANSWERER: getAllTracks() returned:",V),console.log("👤 ANSWERER: Track array length:",V.length),V.length>0?console.log("👤 ANSWERER: Tracks detail:",V.map(pe=>({kind:pe.kind,id:pe.id,enabled:pe.enabled,readyState:pe.readyState}))):console.warn("⚠️ ANSWERER: WARNING - localStream exists but getTracks() returned empty array!");const le=z.current.getSenders();if(console.log("📤 ANSWERER: Existing senders count:",le.length),le.length>0)console.warn("⚠️ ANSWERER WARNING: Tracks already added! Senders:",le.map(pe=>{var ke,We;return{kind:(ke=pe.track)==null?void 0:ke.kind,id:(We=pe.track)==null?void 0:We.id}})),console.warn("   Not adding tracks again to avoid duplicates");else{console.log(`
📹 ANSWERER: Attempting to add ${V.length} local tracks to peer connection`);let pe=0,ke=0;V.forEach((Ee,Pe)=>{console.log(`  [${Pe}] About to add ${Ee.kind} track (id: ${Ee.id}, enabled: ${Ee.enabled})`);try{const fe=z.current.addTrack(Ee,te.current);console.log(`  [${Pe}] ✅ addTrack SUCCEEDED`),console.log(`  [${Pe}] Sender:`,fe),pe++}catch(fe){console.error(`  [${Pe}] ❌ addTrack FAILED`),console.error(`  [${Pe}] Error:`,fe.message),ke++}}),console.log(`
✅ ANSWERER: Track addition complete (${pe} succeeded, ${ke} failed)`);const We=z.current.getSenders();console.log("📤 ANSWERER: Final senders count:",We.length),console.log("📤 ANSWERER: Senders:",We.map((Ee,Pe)=>{var fe,ct,it;return{index:Pe,kind:(fe=Ee.track)==null?void 0:fe.kind,id:(ct=Ee.track)==null?void 0:ct.id,trackExists:!!Ee.track,trackEnabled:(it=Ee.track)==null?void 0:it.enabled}}))}}else throw console.error(`
...
🔄 ANSWERER: Setting remote description (offer from offerer)`),await z.current.setRemoteDescription(new RTCSessionDescription(N.offer)),console.log("✅ ANSWERER: Remote description set successfully"),console.log("🎬 ANSWERER: Creating answer");const G=await z.current.createAnswer({offerToReceiveVideo:!0,offerToReceiveAudio:!0});console.log("✅ ANSWERER: Answer created with receive constraints"),console.log("📋 ANSWERER SDP CHECK - Looking for a=sendrecv:");const M=G.sdp.split(`
`).filter(V=>V.includes("sendrecv")||V.includes("recvonly")||V.includes("sendonly"));console.log("   Media direction lines:"),M.forEach(V=>console.log("   ",V)),console.log("🔄 ANSWERER: Setting local description (answer)"),await z.current.setLocalDescription(G),console.log("✅ ANSWERER: Local description set successfully"),console.log(`
📋 ===== ANSWERER SENDING ANSWER =====`);const ee=z.current.getSenders();console.log("📤 ANSWERER: Final senders count:",ee.length),console.log("📤 ANSWERER: Sending answer with tracks:",ee.map(V=>{var le,pe,ke;return{kind:(le=V.track)==null?void 0:le.kind,id:(pe=V.track)==null?void 0:pe.id,enabled:(ke=V.track)==null?void 0:ke.enabled}})),console.log("🔌 CRITICAL: Offerer socket ID from offer:",N.from),console.log("🔌 SERVER sending ANSWER to:",N.from),K.emit("webrtc_answer",{answer:z.current.localDescription,to:N.from}),console.log("📤 ANSWERER: Answer emitted to offerer via socket:",N.from),console.log(`📋 ===== ANSWERER ANSWER SENT =====

`)}catch(G){console.error(`
❌ ANSWERER: ERROR in webrtc_offer handler:`,G),console.error("❌ ANSWERER: Error message:",G.message),console.error("❌ ANSWERER: Stack trace:",G.stack)}}),K.on("webrtc_answer",async N=>{console.log(`
...
`)}catch(G){console.error("❌ OFFERER: Error handling answer:",G),console.error("❌ OFFERER: Stack trace:",G.stack)}}),K.on("ice_candidate",async N=>{if(console.log(`
...
`)):console.warn("⚠️ No peer connection available for ICE candidate")}catch(G){console.error("❌ Error adding ICE candidate:",G)}}),K.on("partner_disconnected",N=>{console.log(`
