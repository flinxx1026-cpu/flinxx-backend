 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function zp(n,e){const t=jn(n,"auth");if(t.isInitialized()){const s=t.getImmediate(),o=t.getOptions();if(Dr(o,e??{}))return s;Nt(s,"already-initialized")}return t.initialize({options:e})}function Kp(n,e){const t=(e==null?void 0:e.persistence)||[],r=(Array.isArray(t)?t:[t]).map(zt);e!=null&&e.errorMap&&n._updateErrorMap(e.errorMap),n._initializeWithPersistence(r,e==null?void 0:e.popupRedirectResolver)}function Jp(n,e,t){const r=rr(n);J(r._canInitEmulator,r,"emulator-config-failed"),J(/^https?:\/\//.test(e),r,"invalid-emulator-scheme");const s=!1,o=Zc(e),{host:a,port:u}=Qp(e),h=u===null?"":`:${u}`;r.config.emulator={url:`${o}//${a}${h}/`},r.settings.appVerificationDisabledForTesting=!0,r.emulatorConfig=Object.freeze({host:a,port:u,protocol:o.replace(":",""),options:Object.freeze({disableWarnings:s})}),Yp()}function Zc(n){const e=n.indexOf(":");return e<0?"":n.substr(0,e+1)}function Qp(n){const e=Zc(n),t=/(\/\/)?([^?#/]+)/.exec(n.substr(e.length));if(!t)return{host:"",port:null};const r=t[2].split("@").pop()||"",s=/^(\[[^\]]+\])(:|$)/.exec(r);if(s){const o=s[1];return{host:o,port:vl(r.substr(o.length+1))}}else{const[o,a]=r.split(":");return{host:o,port:vl(a)}}}function vl(n){if(!n)return null;const e=Number(n);return isNaN(e)?null:e}function Yp(){function n(){const e=document.createElement("p"),t=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",t.position="fixed",t.width="100%",t.backgroundColor="#ffffff",t.border=".1em solid #000000",t.color="#b50000",t.bottom="0px",t.left="0px",t.margin="0px",t.zIndex="10000",t.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}typeof console<"u"&&typeof console.info=="function"&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials."),typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?window.addEventListener("DOMContentLoaded",n):n())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
🔐 ===== CRITICAL STREAM VERIFICATION =====`),console.log("🔐 Checking localStreamRef.current status:"),console.log("   exists:",!!Z.current),console.log("   tracks:",((ke=Z.current)==null?void 0:ke.getTracks().length)||0),console.log("   video element srcObject:",!!((We=ae.current)!=null&&We.srcObject)),!Z.current){console.error("🔐 ❌ CRITICAL: localStreamRef.current is NULL - cannot proceed to WebRTC"),console.error("   This means the camera stream was never acquired or was lost"),console.error("   Attempting emergency camera reacquisition...");try{const fe=await navigator.mediaDevices.getUserMedia({video:{width:{ideal:640},height:{ideal:480}},audio:!0});if(Z.current=fe,ae.current){ae.current.srcObject=fe,ae.current.muted=!0;try{await ae.current.play()}catch{console.warn("⚠️ Play error in emergency reacquisition")}}console.log("🔐 ✅ EMERGENCY: Camera stream re-acquired")}catch(fe){console.error("🔐 ❌ EMERGENCY FAILED: Could not reacquire camera -",fe.message),console.error("   User must allow camera permission to continue");return}}if(console.log(`🔐 ✅ STREAM VERIFICATION PASSED - proceeding with WebRTC
...
🏠 OFFERER: Creating peer connection`),z.current){console.warn("⚠️ OFFERER: WARNING - Peer connection already exists! Not recreating."),console.warn("   Existing PC state:",{connectionState:z.current.connectionState,iceConnectionState:z.current.iceConnectionState,signalingState:z.current.signalingState});return}let fe;try{fe=await en()}catch(Ie){console.error("❌ OFFERER: Error creating peer connection:",Ie);return}if(z.current=fe,console.log("✅ OFFERER: Peer connection created"),console.log("📊 OFFERER Stream status after peer connection creation:",{exists:!!Z.current,trackCount:(Ee=Z.current)==null?void 0:Ee.getTracks().length,tracks:(Pe=Z.current)==null?void 0:Pe.getTracks().map(Ie=>({kind:Ie.kind,enabled:Ie.enabled,state:Ie.readyState}))}),Z.current){console.log(`
👤 OFFERER localStream:`,Z.current);const Ie=Z.current.getTracks();console.log("👤 OFFERER: All available tracks:",Ie),console.log("📹 OFFERER tracks detail:",Ie.map(Ve=>({kind:Ve.kind,id:Ve.id,enabled:Ve.enabled,state:Ve.readyState})));const Vt=fe.getSenders();if(console.log("📤 OFFERER: Existing senders count:",Vt.length),Vt.length>0)console.warn("⚠️ OFFERER WARNING: Tracks already added! Senders:",Vt.map(Ve=>{var je,mt;return{kind:(je=Ve.track)==null?void 0:je.kind,id:(mt=Ve.track)==null?void 0:mt.id}})),console.warn("   Not adding tracks again to avoid duplicates");else{console.log(`
📹 OFFERER: Adding ${Ie.length} local tracks to peer connection`),Ie.forEach((je,mt)=>{console.log(`  [${mt}] Adding ${je.kind} track (id: ${je.id}, enabled: ${je.enabled})`);try{const Ut=fe.addTrack(je,Z.current);console.log(`  [${mt}] ✅ addTrack succeeded, sender:`,Ut)}catch(Ut){console.error(`  [${mt}] ❌ addTrack failed:`,Ut)}}),console.log(`
...
🔍 ANSWERER: ALWAYS executing track addition logic`),console.log("👤 ANSWERER: Checking localStreamRef.current..."),console.log("👤 ANSWERER localStreamRef.current:",Z.current),console.log("👤 ANSWERER localStreamRef.current === null?",Z.current===null),console.log("👤 ANSWERER localStreamRef.current === undefined?",Z.current===void 0),!Z.current){console.warn("⚠️ ANSWERER: localStreamRef.current is NULL - attempting emergency reacquisition");try{const V=await navigator.mediaDevices.getUserMedia({video:{width:{ideal:640},height:{ideal:480}},audio:!0});if(Z.current=V,ae.current){ae.current.srcObject=V,ae.current.muted=!0;try{await ae.current.play()}catch{console.warn("⚠️ Play error in answerer emergency reacquisition")}}console.log("✅ ANSWERER: Emergency stream acquisition successful")}catch(V){throw console.error("❌ ANSWERER: Emergency stream acquisition failed:",V.message),new Error("ANSWERER: Cannot reacquire camera stream - "+V.message)}}if(Z.current){console.log(`
...
📹 ANSWERER: Attempting to add ${V.length} local tracks to peer connection`);let pe=0,ke=0;V.forEach((Ee,Pe)=>{console.log(`  [${Pe}] About to add ${Ee.kind} track (id: ${Ee.id}, enabled: ${Ee.enabled})`);try{const fe=z.current.addTrack(Ee,Z.current);console.log(`  [${Pe}] ✅ addTrack SUCCEEDED`),console.log(`  [${Pe}] Sender:`,fe),pe++}catch(fe){console.error(`  [${Pe}] ❌ addTrack FAILED`),console.error(`  [${Pe}] Error:`,fe.message),ke++}}),console.log(`
...
//# sourceMappingURL=index-Cwh_rMRH.js.map
