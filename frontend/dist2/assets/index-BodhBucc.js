import{r as A,a as Td,R as qr,u as ft,b as Ad,c as yc,B as Cd,d as Sd,e as yt}from"./vendor-CWYb8WqM.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))r(s);new MutationObserver(s=>{for(const o of s)if(o.type==="childList")for(const a of o.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&r(a)}).observe(document,{childList:!0,subtree:!0});function t(s){const o={};return s.integrity&&(o.integrity=s.integrity),s.referrerPolicy&&(o.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?o.credentials="include":s.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function r(s){if(s.ep)return;s.ep=!0;const o=t(s);fetch(s.href,o)}})();var vc={exports:{}},oi={};/**
 * @license React
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Xe(){return typeof navigator<"u"&&typeof navigator.userAgent=="string"?navigator.userAgent:""}function Kd(){return typeof window<"u"&&!!(window.cordova||window.phonegap||window.PhoneGap)&&/ios|iphone|ipod|ipad|android|blackberry|iemobile/i.test(Xe())}function Yd(){var n;const e=(n=ai())===null||n===void 0?void 0:n.forceEnvironment;if(e==="node")return!0;if(e==="browser")return!1;try{return Object.prototype.toString.call(global.process)==="[object process]"}catch{return!1}}function Jd(){return typeof navigator<"u"&&navigator.userAgent==="Cloudflare-Workers"}function Ac(){const n=typeof chrome=="object"?chrome.runtime:typeof browser=="object"?browser.runtime:void 0;return typeof n=="object"&&n.id!==void 0}function Qd(){return typeof navigator=="object"&&navigator.product==="ReactNative"}function Xd(){const n=Xe();return n.indexOf("MSIE ")>=0||n.indexOf("Trident/")>=0}function Zd(){return!Yd()&&!!navigator.userAgent&&navigator.userAgent.includes("Safari")&&!navigator.userAgent.includes("Chrome")}function Cc(){try{return typeof indexedDB=="object"}catch{return!1}}function Sc(){return new Promise((n,e)=>{try{let t=!0;const r="validate-browser-context-for-indexeddb-analytics-module",s=self.indexedDB.open(r);s.onsuccess=()=>{s.result.close(),t||self.indexedDB.deleteDatabase(r),n(!0)},s.onupgradeneeded=()=>{t=!1},s.onerror=()=>{var o;e(((o=s.error)===null||o===void 0?void 0:o.message)||"")}}catch(t){e(t)}})}function ef(){return!(typeof navigator>"u"||!navigator.cookieEnabled)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Jt=new li("@firebase/app"),jf="@firebase/app-compat",Of="@firebase/analytics-compat",Df="@firebase/analytics",Lf="@firebase/app-check-compat",Mf="@firebase/app-check",Ff="@firebase/auth",Vf="@firebase/auth-compat",Uf="@firebase/database",Bf="@firebase/data-connect",$f="@firebase/database-compat",Gf="@firebase/functions",Hf="@firebase/functions-compat",Wf="@firebase/installations",qf="@firebase/installations-compat",zf="@firebase/messaging",Kf="@firebase/messaging-compat",Yf="@firebase/performance",Jf="@firebase/performance-compat",Qf="@firebase/remote-config",Xf="@firebase/remote-config-compat",Zf="@firebase/storage",ep="@firebase/storage-compat",tp="@firebase/firestore",np="@firebase/vertexai-preview",rp="@firebase/firestore-compat",sp="firebase",ip="10.14.1";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const so="[DEFAULT]",op={[ro]:"fire-core",[jf]:"fire-core-compat",[Df]:"fire-analytics",[Of]:"fire-analytics-compat",[Mf]:"fire-app-check",[Lf]:"fire-app-check-compat",[Ff]:"fire-auth",[Vf]:"fire-auth-compat",[Uf]:"fire-rtdb",[Bf]:"fire-data-connect",[$f]:"fire-rtdb-compat",[Gf]:"fire-fn",[Hf]:"fire-fn-compat",[Wf]:"fire-iid",[qf]:"fire-iid-compat",[zf]:"fire-fcm",[Kf]:"fire-fcm-compat",[Yf]:"fire-perf",[Jf]:"fire-perf-compat",[Qf]:"fire-rc",[Xf]:"fire-rc-compat",[Zf]:"fire-gcs",[ep]:"fire-gcs-compat",[tp]:"fire-fst",[rp]:"fire-fst-compat",[np]:"fire-vertex","fire-js":"fire-js",[sp]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Kr{constructor(e,t){this.shortDelay=e,this.longDelay=t,Qt(t>e,"Short delay should be less than long delay!"),this.isMobile=Kd()||Qd()}get(){return Ep()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const pl=new Map;function zt(n){Qt(n instanceof Function,"Expected a class definition");let e=pl.get(n);return e?(Qt(e instanceof n,"Instance stored in cache mismatched with class"),e):(e=new n,pl.set(n,e),e)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function gl(n){const e=n.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(zc(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(Hc(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(Yc(e))return"Blackberry";if(Jc(e))return"Webos";if(Wc(e))return"Safari";if((e.includes("chrome/")||qc(e))&&!e.includes("edge/"))return"Chrome";if(Kc(e))return"Android";{const t=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,r=n.match(t);if((r==null?void 0:r.length)===2)return r[1]}return"Other"}function Hc(n=Xe()){return/firefox\//i.test(n)}function Wc(n=Xe()){const e=n.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function qc(n=Xe()){return/crios\//i.test(n)}function zc(n=Xe()){return/iemobile/i.test(n)}function Kc(n=Xe()){return/android/i.test(n)}function Yc(n=Xe()){return/blackberry/i.test(n)}function Jc(n=Xe()){return/webos/i.test(n)}function Lo(n=Xe()){return/iphone|ipad|ipod/i.test(n)||/macintosh/i.test(n)&&/mobile/i.test(n)}function Lp(n=Xe()){var e;return Lo(n)&&!!(!((e=window.navigator)===null||e===void 0)&&e.standalone)}function Mp(){return Xd()&&document.documentMode===10}function Qc(n=Xe()){return Lo(n)||Kc(n)||Jc(n)||Yc(n)||/windows phone/i.test(n)||zc(n)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Xc(n,e=[]){let t;switch(n){case"Browser":t=gl(Xe());break;case"Worker":t=`${gl(Xe())}-${n}`;break;default:t=n}const r=e.length?e.join(","):"FirebaseCore-web";return`${t}/JsCore/${er}/${r}`}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function zp(n,e){const t=jn(n,"auth");if(t.isInitialized()){const s=t.getImmediate(),o=t.getOptions();if(Or(o,e??{}))return s;Nt(s,"already-initialized")}return t.initialize({options:e})}function Kp(n,e){const t=(e==null?void 0:e.persistence)||[],r=(Array.isArray(t)?t:[t]).map(zt);e!=null&&e.errorMap&&n._updateErrorMap(e.errorMap),n._initializeWithPersistence(r,e==null?void 0:e.popupRedirectResolver)}function Yp(n,e,t){const r=nr(n);Y(r._canInitEmulator,r,"emulator-config-failed"),Y(/^https?:\/\//.test(e),r,"invalid-emulator-scheme");const s=!1,o=Zc(e),{host:a,port:u}=Jp(e),h=u===null?"":`:${u}`;r.config.emulator={url:`${o}//${a}${h}/`},r.settings.appVerificationDisabledForTesting=!0,r.emulatorConfig=Object.freeze({host:a,port:u,protocol:o.replace(":",""),options:Object.freeze({disableWarnings:s})}),Qp()}function Zc(n){const e=n.indexOf(":");return e<0?"":n.substr(0,e+1)}function Jp(n){const e=Zc(n),t=/(\/\/)?([^?#/]+)/.exec(n.substr(e.length));if(!t)return{host:"",port:null};const r=t[2].split("@").pop()||"",s=/^(\[[^\]]+\])(:|$)/.exec(r);if(s){const o=s[1];return{host:o,port:vl(r.substr(o.length+1))}}else{const[o,a]=r.split(":");return{host:o,port:vl(a)}}}function vl(n){if(!n)return null;const e=Number(n);return isNaN(e)?null:e}function Qp(){function n(){const e=document.createElement("p"),t=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",t.position="fixed",t.width="100%",t.backgroundColor="#ffffff",t.border=".1em solid #000000",t.color="#b50000",t.bottom="0px",t.left="0px",t.margin="0px",t.zIndex="10000",t.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}typeof console<"u"&&typeof console.info=="function"&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials."),typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?window.addEventListener("DOMContentLoaded",n):n())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Yr extends ci{constructor(){super(...arguments),this.scopes=[]}addScope(e){return this.scopes.includes(e)||this.scopes.push(e),this}getScopes(){return[...this.scopes]}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Gt extends Yr{constructor(){super("facebook.com")}static credential(e){return An._fromParams({providerId:Gt.PROVIDER_ID,signInMethod:Gt.FACEBOOK_SIGN_IN_METHOD,accessToken:e})}static credentialFromResult(e){return Gt.credentialFromTaggedObject(e)}static credentialFromError(e){return Gt.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e||!("oauthAccessToken"in e)||!e.oauthAccessToken)return null;try{return Gt.credential(e.oauthAccessToken)}catch{return null}}}Gt.FACEBOOK_SIGN_IN_METHOD="facebook.com";Gt.PROVIDER_ID="facebook.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ht extends Yr{constructor(){super("google.com"),this.addScope("profile")}static credential(e,t){return An._fromParams({providerId:Ht.PROVIDER_ID,signInMethod:Ht.GOOGLE_SIGN_IN_METHOD,idToken:e,accessToken:t})}static credentialFromResult(e){return Ht.credentialFromTaggedObject(e)}static credentialFromError(e){return Ht.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e)return null;const{oauthIdToken:t,oauthAccessToken:r}=e;if(!t&&!r)return null;try{return Ht.credential(t,r)}catch{return null}}}Ht.GOOGLE_SIGN_IN_METHOD="google.com";Ht.PROVIDER_ID="google.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class sn extends Yr{constructor(){super("github.com")}static credential(e){return An._fromParams({providerId:sn.PROVIDER_ID,signInMethod:sn.GITHUB_SIGN_IN_METHOD,accessToken:e})}static credentialFromResult(e){return sn.credentialFromTaggedObject(e)}static credentialFromError(e){return sn.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e||!("oauthAccessToken"in e)||!e.oauthAccessToken)return null;try{return sn.credential(e.oauthAccessToken)}catch{return null}}}sn.GITHUB_SIGN_IN_METHOD="github.com";sn.PROVIDER_ID="github.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class on extends Yr{constructor(){super("twitter.com")}static credential(e,t){return An._fromParams({providerId:on.PROVIDER_ID,signInMethod:on.TWITTER_SIGN_IN_METHOD,oauthToken:e,oauthTokenSecret:t})}static credentialFromResult(e){return on.credentialFromTaggedObject(e)}static credentialFromError(e){return on.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e)return null;const{oauthAccessToken:t,oauthTokenSecret:r}=e;if(!t||!r)return null;try{return on.credential(t,r)}catch{return null}}}on.TWITTER_SIGN_IN_METHOD="twitter.com";on.PROVIDER_ID="twitter.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Wm=new Kr(5e3,15e3),qm="__/auth/iframe",zm="emulator/auth/iframe",Km={style:{position:"absolute",top:"-100px",width:"1px",height:"1px"},"aria-hidden":"true",tabindex:"-1"},Ym=new Map([["identitytoolkit.googleapis.com","p"],["staging-identitytoolkit.sandbox.googleapis.com","s"],["test-identitytoolkit.sandbox.googleapis.com","t"]]);function Jm(n){const e=n.config;Y(e.authDomain,n,"auth-domain-config-required");const t=e.emulator?jo(e,zm):`https://${n.config.authDomain}/${qm}`,r={apiKey:e.apiKey,appName:n.name,v:er},s=Ym.get(n.config.apiHost);s&&(r.eid=s);const o=n._getFrameworks();return o.length&&(r.fw=o.join(",")),`${t}?${zr(r).slice(1)}`}async function Qm(n){const e=await Hm(n),t=St().gapi;return Y(t,n,"internal-error"),e.open({where:document.body,url:Jm(n),messageHandlersFilter:t.iframes.CROSS_ORIGIN_IFRAMES_FILTER,attributes:Km,dontclear:!0},r=>new Promise(async(s,o)=>{await r.restyle({setHideOnLeave:!1});const a=Et(n,"network-request-failed"),u=St().setTimeout(()=>{o(a)},Wm.get());function h(){St().clearTimeout(u),s(r)}r.ping(h).then(h,()=>{o(a)})}))}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Gi="webStorageSupport";class cg{constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=iu,this._completeRedirectFn=fu,this._overrideRedirectResult=Nm}async _openPopup(e,t,r,s){var o;Qt((o=this.eventManagers[e._key()])===null||o===void 0?void 0:o.manager,"_initialize() not called before _openPopup()");const a=await Tl(e,t,r,oo(),s);return rg(e,a,Fo())}async _openRedirect(e,t,r,s){await this._originValidation(e);const o=await Tl(e,t,r,oo(),s);return hm(o),new Promise(()=>{})}_initialize(e){const t=e._key();if(this.eventManagers[t]){const{manager:s,promise:o}=this.eventManagers[t];return s?Promise.resolve(s):(Qt(o,"If manager is not set, promise should be"),o)}const r=this.initAndGetManager(e);return this.eventManagers[t]={promise:r},r.catch(()=>{delete this.eventManagers[t]}),r}async initAndGetManager(e){const t=await Qm(e),r=new Dm(e);return t.register("authEvent",s=>(Y(s==null?void 0:s.authEvent,e,"invalid-auth-event"),{status:r.onEvent(s.authEvent)?"ACK":"ERROR"}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[e._key()]={manager:r},this.iframes[e._key()]=t,r}_isIframeWebStorageSupported(e,t){this.iframes[e._key()].send(Gi,{type:Gi},s=>{var o;const a=(o=s==null?void 0:s[0])===null||o===void 0?void 0:o[Gi];a!==void 0&&t(!!a),Nt(e,"internal-error")},gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(e){const t=e._key();return this.originValidationPromises[t]||(this.originValidationPromises[t]=Um(e)),this.originValidationPromises[t]}get _shouldInitProactively(){return Qc()||Wc()||Lo()}}const ug=cg;var Al="@firebase/auth",Cl="1.7.9";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
*/var gu,Tr,yu,Ps,co,vu,_u,wu;(function(){var n,e=typeof Object.defineProperties=="function"?Object.defineProperty:function(i,c,d){return i==Array.prototype||i==Object.prototype||(i[c]=d.value),i};function t(i){i=[typeof globalThis=="object"&&globalThis,i,typeof window=="object"&&window,typeof self=="object"&&self,typeof Is=="object"&&Is];for(var c=0;c<i.length;++c){var d=i[c];if(d&&d.Math==Math)return d}throw Error("Cannot find global object")}var r=t(this);function s(i,c){if(c)e:{var d=r;i=i.split(".");for(var p=0;p<i.length-1;p++){var T=i[p];if(!(T in d))break e;d=d[T]}i=i[i.length-1],p=d[i],c=c(p),c!=p&&c!=null&&e(d,i,{configurable:!0,writable:!0,value:c})}}function o(i,c){i instanceof String&&(i+="");var d=0,p=!1,T={next:function(){if(!p&&d<i.length){var R=d++;return{value:c(R,i[R]),done:!1}}return p=!0,{done:!0,value:void 0}}};return T[Symbol.iterator]=function(){return T},T}s("Array.prototype.values",function(i){return i||function(){return o(this,function(c,d){return d})}});/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/var a=a||{},u=this||self;function h(i){var c=typeof i;return c=c!="object"?c:i?Array.isArray(i)?"array":c:"null",c=="array"||c=="object"&&typeof i.length=="number"}function f(i){var c=typeof i;return c=="object"&&i!=null||c=="function"}function y(i,c,d){return i.call.apply(i.bind,arguments)}function E(i,c,d){if(!i)throw Error();if(2<arguments.length){var p=Array.prototype.slice.call(arguments,2);return function(){var T=Array.prototype.slice.call(arguments);return Array.prototype.unshift.apply(T,p),i.apply(c,T)}}return function(){return i.apply(c,arguments)}}function x(i,c,d){return x=Function.prototype.bind&&Function.prototype.bind.toString().indexOf("native code")!=-1?y:E,x.apply(null,arguments)}function C(i,c){var d=Array.prototype.slice.call(arguments,1);return function(){var p=d.slice();return p.push.apply(p,arguments),i.apply(this,p)}}function P(i,c){function d(){}d.prototype=c.prototype,i.aa=c.prototype,i.prototype=new d,i.prototype.constructor=i,i.Qb=function(p,T,R){for(var F=Array(arguments.length-2),me=2;me<arguments.length;me++)F[me-2]=arguments[me];return c.prototype[T].apply(p,F)}}function S(i){const c=i.length;if(0<c){const d=Array(c);for(let p=0;p<c;p++)d[p]=i[p];return d}return[]}function k(i,c){for(let d=1;d<arguments.length;d++){const p=arguments[d];if(h(p)){const T=i.length||0,R=p.length||0;i.length=T+R;for(let F=0;F<R;F++)i[T+F]=p[F]}else i.push(p)}}class G{constructor(c,d){this.i=c,this.j=d,this.h=0,this.g=null}get(){let c;return 0<this.h?(this.h--,c=this.g,this.g=c.next,c.next=null):c=this.i(),c}}function H(i){return/^[\s\xa0]*$/.test(i)}function U(){var i=u.navigator;return i&&(i=i.userAgent)?i:""}function B(i){return B[" "](i),i}B[" "]=function(){};var de=U().indexOf("Gecko")!=-1&&!(U().toLowerCase().indexOf("webkit")!=-1&&U().indexOf("Edge")==-1)&&!(U().indexOf("Trident")!=-1||U().indexOf("MSIE")!=-1)&&U().indexOf("Edge")==-1;function L(i,c,d){for(const p in i)c.call(d,i[p],p,i)}function I(i,c){for(const d in i)c.call(void 0,i[d],d,i)}function m(i){const c={};for(const d in i)c[d]=i[d];return c}const g="constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" ");function _(i,c){let d,p;for(let T=1;T<arguments.length;T++){p=arguments[T];for(d in p)i[d]=p[d];for(let R=0;R<g.length;R++)d=g[R],Object.prototype.hasOwnProperty.call(p,d)&&(i[d]=p[d])}}function w(i){var c=1;i=i.split(":");const d=[];for(;0<c&&i.length;)d.push(i.shift()),c--;return i.length&&d.push(i.join(":")),d}function b(i){u.setTimeout(()=>{throw i},0)}function v(){var i=pt;let c=null;return i.g&&(c=i.g,i.g=i.g.next,i.g||(i.h=null),c.next=null),c}class X{constructor(){this.h=this.g=null}add(c,d){const p=_e.get();p.set(c,d),this.h?this.h.next=p:this.g=p,this.h=p}}var _e=new G(()=>new Q,i=>i.reset());class Q{constructor(){this.next=this.g=this.h=null}set(c,d){this.h=c,this.g=d,this.next=null}reset(){this.next=this.g=this.h=null}}let ye,Oe=!1,pt=new X,Ze=()=>{const i=u.Promise.resolve(void 0);ye=()=>{i.then(Dn)}};var Dn=()=>{for(var i;i=v();){try{i.h.call(i.g)}catch(d){b(d)}var c=_e;c.j(i),100>c.h&&(c.h++,i.next=c.g,c.g=i)}Oe=!1};function rt(){this.s=this.s,this.C=this.C}rt.prototype.s=!1,rt.prototype.ma=function(){this.s||(this.s=!0,this.N())},rt.prototype.N=function(){if(this.C)for(;this.C.length;)this.C.shift()()};function Ne(i,c){this.type=i,this.g=this.target=c,this.defaultPrevented=!1}Ne.prototype.h=function(){this.defaultPrevented=!0};var ts=function(){if(!u.addEventListener||!Object.defineProperty)return!1;var i=!1,c=Object.defineProperty({},"passive",{get:function(){i=!0}});try{const d=()=>{};u.addEventListener("test",d,c),u.removeEventListener("test",d,c)}catch{}return i}();function Xt(i,c){if(Ne.call(this,i?i.type:""),this.relatedTarget=this.g=this.target=null,this.button=this.screenY=this.screenX=this.clientY=this.clientX=0,this.key="",this.metaKey=this.shiftKey=this.altKey=this.ctrlKey=!1,this.state=null,this.pointerId=0,this.pointerType="",this.i=null,i){var d=this.type=i.type,p=i.changedTouches&&i.changedTouches.length?i.changedTouches[0]:null;if(this.target=i.target||i.srcElement,this.g=c,c=i.relatedTarget){if(de){e:{try{B(c.nodeName);var T=!0;break e}catch{}T=!1}T||(c=null)}}else d=="mouseover"?c=i.fromElement:d=="mouseout"&&(c=i.toElement);this.relatedTarget=c,p?(this.clientX=p.clientX!==void 0?p.clientX:p.pageX,this.clientY=p.clientY!==void 0?p.clientY:p.pageY,this.screenX=p.screenX||0,this.screenY=p.screenY||0):(this.clientX=i.clientX!==void 0?i.clientX:i.pageX,this.clientY=i.clientY!==void 0?i.clientY:i.pageY,this.screenX=i.screenX||0,this.screenY=i.screenY||0),this.button=i.button,this.key=i.key||"",this.ctrlKey=i.ctrlKey,this.altKey=i.altKey,this.shiftKey=i.shiftKey,this.metaKey=i.metaKey,this.pointerId=i.pointerId||0,this.pointerType=typeof i.pointerType=="string"?i.pointerType:j[i.pointerType]||"",this.state=i.state,this.i=i,i.defaultPrevented&&Xt.aa.h.call(this)}}P(Xt,Ne);var j={2:"touch",3:"pen",4:"mouse"};Xt.prototype.h=function(){Xt.aa.h.call(this);var i=this.i;i.preventDefault?i.preventDefault():i.returnValue=!1};var q="closure_listenable_"+(1e6*Math.random()|0),ne=0;function De(i,c,d,p,T){this.listener=i,this.proxy=null,this.src=c,this.type=d,this.capture=!!p,this.ha=T,this.key=++ne,this.da=this.fa=!1}function xe(i){i.da=!0,i.listener=null,i.proxy=null,i.src=null,i.ha=null}function Tt(i){this.src=i,this.g={},this.h=0}Tt.prototype.add=function(i,c,d,p,T){var R=i.toString();i=this.g[R],i||(i=this.g[R]=[],this.h++);var F=Ln(i,c,p,T);return-1<F?(c=i[F],d||(c.fa=!1)):(c=new De(c,this.src,R,!!p,T),c.fa=d,i.push(c)),c};function Dt(i,c){var d=c.type;if(d in i.g){var p=i.g[d],T=Array.prototype.indexOf.call(p,c,void 0),R;(R=0<=T)&&Array.prototype.splice.call(p,T,1),R&&(xe(c),i.g[d].length==0&&(delete i.g[d],i.h--))}}function Ln(i,c,d,p){for(var T=0;T<i.length;++T){var R=i[T];if(!R.da&&R.listener==c&&R.capture==!!d&&R.ha==p)return T}return-1}var At="closure_lm_"+(1e6*Math.random()|0),He={};function Lt(i,c,d,p,T){if(Array.isArray(c)){for(var R=0;R<c.length;R++)Lt(i,c[R],d,p,T);return null}return d=ar(d),i&&i[q]?i.K(c,d,f(p)?!!p.capture:!1,T):va(i,c,d,!1,p,T)}function va(i,c,d,p,T,R){if(!c)throw Error("Invalid event type");var F=f(T)?!!T.capture:!!T,me=pn(i);if(me||(i[At]=me=new Tt(i)),d=me.add(c,d,p,F,R),d.proxy)return d;if(p=ns(),d.proxy=p,p.src=i,p.listener=d,i.addEventListener)ts||(T=F),T===void 0&&(T=!1),i.addEventListener(c.toString(),p,T);else if(i.attachEvent)i.attachEvent(or(c.toString()),p);else if(i.addListener&&i.removeListener)i.addListener(p);else throw Error("addEventListener and attachEvent are unavailable.");return d}function ns(){function i(d){return c.call(i.src,i.listener,d)}const c=Mt;return i}function Ai(i,c,d,p,T){if(Array.isArray(c))for(var R=0;R<c.length;R++)Ai(i,c[R],d,p,T);else p=f(p)?!!p.capture:!!p,d=ar(d),i&&i[q]?(i=i.i,c=String(c).toString(),c in i.g&&(R=i.g[c],d=Ln(R,d,p,T),-1<d&&(xe(R[d]),Array.prototype.splice.call(R,d,1),R.length==0&&(delete i.g[c],i.h--)))):i&&(i=pn(i))&&(c=i.g[c.toString()],i=-1,c&&(i=Ln(c,d,p,T)),(d=-1<i?c[i]:null)&&rs(d))}function rs(i){if(typeof i!="number"&&i&&!i.da){var c=i.src;if(c&&c[q])Dt(c.i,i);else{var d=i.type,p=i.proxy;c.removeEventListener?c.removeEventListener(d,p,i.capture):c.detachEvent?c.detachEvent(or(d),p):c.addListener&&c.removeListener&&c.removeListener(p),(d=pn(c))?(Dt(d,i),d.h==0&&(d.src=null,c[At]=null)):xe(i)}}}function or(i){return i in He?He[i]:He[i]="on"+i}function Mt(i,c){if(i.da)i=!0;else{c=new Xt(c,this);var d=i.listener,p=i.ha||i.src;i.fa&&rs(i),i=d.call(p,c)}return i}function pn(i){return i=i[At],i instanceof Tt?i:null}var z="__closure_events_fn_"+(1e9*Math.random()>>>0);function ar(i){return typeof i=="function"?i:(i[z]||(i[z]=function(c){return i.handleEvent(c)}),i[z])}function he(){rt.call(this),this.i=new Tt(this),this.M=this,this.F=null}P(he,rt),he.prototype[q]=!0,he.prototype.removeEventListener=function(i,c,d,p){Ai(this,i,c,d,p)};function Z(i,c){var d,p=i.F;if(p)for(d=[];p;p=p.F)d.push(p);if(i=i.M,p=c.type||c,typeof c=="string")c=new Ne(c,i);else if(c instanceof Ne)c.target=c.target||i;else{var T=c;c=new Ne(p,i),_(c,T)}if(T=!0,d)for(var R=d.length-1;0<=R;R--){var F=c.g=d[R];T=Mn(F,p,!0,c)&&T}if(F=c.g=i,T=Mn(F,p,!0,c)&&T,T=Mn(F,p,!1,c)&&T,d)for(R=0;R<d.length;R++)F=c.g=d[R],T=Mn(F,p,!1,c)&&T}he.prototype.N=function(){if(he.aa.N.call(this),this.i){var i=this.i,c;for(c in i.g){for(var d=i.g[c],p=0;p<d.length;p++)xe(d[p]);delete i.g[c],i.h--}}this.F=null},he.prototype.K=function(i,c,d,p){return this.i.add(String(i),c,!1,d,p)},he.prototype.L=function(i,c,d,p){return this.i.add(String(i),c,!0,d,p)};function Mn(i,c,d,p){if(c=i.i.g[String(c)],!c)return!0;c=c.concat();for(var T=!0,R=0;R<c.length;++R){var F=c[R];if(F&&!F.da&&F.capture==d){var me=F.listener,Ue=F.ha||F.src;F.fa&&Dt(i.i,F),T=me.call(Ue,p)!==!1&&T}}return T&&!p.defaultPrevented}function ae(i,c,d){if(typeof i=="function")d&&(i=x(i,d));else if(i&&typeof i.handleEvent=="function")i=x(i.handleEvent,i);else throw Error("Invalid listener argument");return 2147483647<Number(c)?-1:u.setTimeout(i,c||0)}function ct(i){i.g=ae(()=>{i.g=null,i.i&&(i.i=!1,ct(i))},i.l);const c=i.h;i.h=null,i.m.apply(null,c)}class ee extends rt{constructor(c,d){super(),this.m=c,this.l=d,this.h=null,this.i=!1,this.g=null}j(c){this.h=arguments,this.g?this.i=!0:ct(this)}N(){super.N(),this.g&&(u.clearTimeout(this.g),this.g=null,this.i=!1,this.h=null)}}function Zt(i){rt.call(this),this.h=i,this.g={}}P(Zt,rt);var st=[];function lr(i){L(i.g,function(c,d){this.g.hasOwnProperty(d)&&rs(c)},i),i.g={}}Zt.prototype.N=function(){Zt.aa.N.call(this),lr(this)},Zt.prototype.handleEvent=function(){throw Error("EventHandler.handleEvent not implemented")};var cr=u.JSON.stringify,_a=u.JSON.parse,Ci=class{stringify(i){return u.JSON.stringify(i,void 0)}parse(i){return u.JSON.parse(i,void 0)}};function ur(){}ur.prototype.h=null;function hr(i){return i.h||(i.h=i.i())}function ss(){}var en={OPEN:"a",kb:"b",Ja:"c",wb:"d"};function dr(){Ne.call(this,"d")}P(dr,Ne);function fr(){Ne.call(this,"c")}P(fr,Ne);var Ft={},is=null;function Fn(){return is=is||new he}Ft.La="serverreachability";function os(i){Ne.call(this,Ft.La,i)}P(os,Ne);function mn(i){const c=Fn();Z(c,new os(c))}Ft.STAT_EVENT="statevent";function as(i,c){Ne.call(this,Ft.STAT_EVENT,i),this.stat=c}P(as,Ne);function N(i){const c=Fn();Z(c,new as(c,i))}Ft.Ma="timingevent";function $(i,c){Ne.call(this,Ft.Ma,i),this.size=c}P($,Ne);function M(i,c){if(typeof i!="function")throw Error("Fn must not be null and must be a function");return u.setTimeout(function(){i()},c)}function te(){this.g=!0}te.prototype.xa=function(){this.g=!1};function V(i,c,d,p,T,R){i.info(function(){if(i.g)if(R)for(var F="",me=R.split("&"),Ue=0;Ue<me.length;Ue++){var ue=me[Ue].split("=");if(1<ue.length){var qe=ue[0];ue=ue[1];var ze=qe.split("_");F=2<=ze.length&&ze[1]=="type"?F+(qe+"="+ue+"&"):F+(qe+"=redacted&")}}else F=null;else F=R;return"XMLHTTP REQ ("+p+") [attempt "+T+"]: "+c+`
`+d+`
`+F})}function le(i,c,d,p,T,R,F){i.info(function(){return"XMLHTTP RESP ("+p+") [ attempt "+T+"]: "+c+`
`+d+`
`+R+" "+F})}function pe(i,c,d,p){i.info(function(){return"XMLHTTP TEXT ("+c+"): "+We(i,d)+(p?" "+p:"")})}function ke(i,c){i.info(function(){return"TIMEOUT: "+c})}te.prototype.info=function(){};function We(i,c){if(!i.g)return c;if(!c)return null;try{var d=JSON.parse(c);if(d){for(i=0;i<d.length;i++)if(Array.isArray(d[i])){var p=d[i];if(!(2>p.length)){var T=p[1];if(Array.isArray(T)&&!(1>T.length)){var R=T[0];if(R!="noop"&&R!="stop"&&R!="close")for(var F=1;F<T.length;F++)T[F]=""}}}}return cr(d)}catch{return c}}var Ee={NO_ERROR:0,gb:1,tb:2,sb:3,nb:4,rb:5,ub:6,Ia:7,TIMEOUT:8,xb:9},Pe={lb:"complete",Hb:"success",Ja:"error",Ia:"abort",zb:"ready",Ab:"readystatechange",TIMEOUT:"timeout",vb:"incrementaldata",yb:"progress",ob:"downloadprogress",Pb:"uploadprogress"},fe;function ut(){}P(ut,ur),ut.prototype.g=function(){return new XMLHttpRequest},ut.prototype.i=function(){return{}},fe=new ut;function it(i,c,d,p){this.j=i,this.i=c,this.l=d,this.R=p||1,this.U=new Zt(this),this.I=45e3,this.H=null,this.o=!1,this.m=this.A=this.v=this.L=this.F=this.S=this.B=null,this.D=[],this.g=null,this.C=0,this.s=this.u=null,this.X=-1,this.J=!1,this.O=0,this.M=null,this.W=this.K=this.T=this.P=!1,this.h=new Ie}function Ie(){this.i=null,this.g="",this.h=!1}var Vt={},Ve={};function je(i,c,d){i.L=1,i.v=hs(Bt(c)),i.m=d,i.P=!0,mt(i,null)}function mt(i,c){i.F=Date.now(),gn(i),i.A=Bt(i.v);var d=i.A,p=i.R;Array.isArray(p)||(p=[String(p)]),Pa(d.i,"t",p),i.C=0,d=i.j.J,i.h=new Ie,i.g=Ja(i.j,d?c:null,!i.m),0<i.O&&(i.M=new ee(x(i.Y,i,i.g),i.O)),c=i.U,d=i.g,p=i.ca;var T="readystatechange";Array.isArray(T)||(T&&(st[0]=T.toString()),T=st);for(var R=0;R<T.length;R++){var F=Lt(d,T[R],p||c.handleEvent,!1,c.h||c);if(!F)break;c.g[F.key]=F}c=i.H?m(i.H):{},i.m?(i.u||(i.u="POST"),c["Content-Type"]="application/x-www-form-urlencoded",i.g.ea(i.A,i.u,i.m,c)):(i.u="GET",i.g.ea(i.A,i.u,null,c)),mn(),V(i.i,i.u,i.A,i.l,i.R,i.m)}it.prototype.ca=function(i){i=i.target;const c=this.M;c&&$t(i)==3?c.j():this.Y(i)},it.prototype.Y=function(i){try{if(i==this.g)e:{const ze=$t(this.g);var c=this.g.Ba();const Bn=this.g.Z();if(!(3>ze)&&(ze!=3||this.g&&(this.h.h||this.g.oa()||Va(this.g)))){this.J||ze!=4||c==7||(c==8||0>=Bn?mn(3):mn(2)),Si(this);var d=this.g.Z();this.X=d;t:if(Ut(this)){var p=Va(this.g);i="";var T=p.length,R=$t(this.g)==4;if(!this.h.i){if(typeof TextDecoder>"u"){yn(this),pr(this);var F="";break t}this.h.i=new u.TextDecoder}for(c=0;c<T;c++)this.h.h=!0,i+=this.h.i.decode(p[c],{stream:!(R&&c==T-1)});p.length=0,this.h.g+=i,this.C=0,F=this.h.g}else F=this.g.oa();if(this.o=d==200,le(this.i,this.u,this.A,this.l,this.R,ze,d),this.o){if(this.T&&!this.K){t:{if(this.g){var me,Ue=this.g;if((me=Ue.g?Ue.g.getResponseHeader("X-HTTP-Initial-Response"):null)&&!H(me)){var ue=me;break t}}ue=null}if(d=ue)pe(this.i,this.l,d,"Initial handshake response via X-HTTP-Initial-Response"),this.K=!0,Ri(this,d);else{this.o=!1,this.s=3,N(12),yn(this),pr(this);break e}}if(this.P){d=!0;let gt;for(;!this.J&&this.C<F.length;)if(gt=ls(this,F),gt==Ve){ze==4&&(this.s=4,N(14),d=!1),pe(this.i,this.l,null,"[Incomplete Response]");break}else if(gt==Vt){this.s=4,N(15),pe(this.i,this.l,F,"[Invalid Chunk]"),d=!1;break}else pe(this.i,this.l,gt,null),Ri(this,gt);if(Ut(this)&&this.C!=0&&(this.h.g=this.h.g.slice(this.C),this.C=0),ze!=4||F.length!=0||this.h.h||(this.s=1,N(16),d=!1),this.o=this.o&&d,!d)pe(this.i,this.l,F,"[Invalid Chunked Response]"),yn(this),pr(this);else if(0<F.length&&!this.W){this.W=!0;var qe=this.j;qe.g==this&&qe.ba&&!qe.M&&(qe.j.info("Great, no buffering proxy detected. Bytes received: "+F.length),Di(qe),qe.M=!0,N(11))}}else pe(this.i,this.l,F,null),Ri(this,F);ze==4&&yn(this),this.o&&!this.J&&(ze==4?qa(this.j,this):(this.o=!1,gn(this)))}else bd(this.g),d==400&&0<F.indexOf("Unknown SID")?(this.s=3,N(12)):(this.s=0,N(13)),yn(this),pr(this)}}}catch{}finally{}};function Ut(i){return i.g?i.u=="GET"&&i.L!=2&&i.j.Ca:!1}function ls(i,c){var d=i.C,p=c.indexOf(`
`,d);return p==-1?Ve:(d=Number(c.substring(d,p)),isNaN(d)?Vt:(p+=1,p+d>c.length?Ve:(c=c.slice(p,p+d),i.C=p+d,c)))}it.prototype.cancel=function(){this.J=!0,yn(this)};function gn(i){i.S=Date.now()+i.I,wa(i,i.I)}function wa(i,c){if(i.B!=null)throw Error("WatchDog timer not null");i.B=M(x(i.ba,i),c)}function Si(i){i.B&&(u.clearTimeout(i.B),i.B=null)}it.prototype.ba=function(){this.B=null;const i=Date.now();0<=i-this.S?(ke(this.i,this.A),this.L!=2&&(mn(),N(17)),yn(this),this.s=2,pr(this)):wa(this,this.S-i)};function pr(i){i.j.G==0||i.J||qa(i.j,i)}function yn(i){Si(i);var c=i.M;c&&typeof c.ma=="function"&&c.ma(),i.M=null,lr(i.U),i.g&&(c=i.g,i.g=null,c.abort(),c.ma())}function Ri(i,c){try{var d=i.j;if(d.G!=0&&(d.g==i||Ni(d.h,i))){if(!i.K&&Ni(d.h,i)&&d.G==3){try{var p=d.Da.g.parse(c)}catch{p=null}if(Array.isArray(p)&&p.length==3){var T=p;if(T[0]==0){e:if(!d.u){if(d.g)if(d.g.F+3e3<i.F)ys(d),ms(d);else break e;Oi(d),N(18)}}else d.za=T[1],0<d.za-d.T&&37500>T[2]&&d.F&&d.v==0&&!d.C&&(d.C=M(x(d.Za,d),6e3));if(1>=ba(d.h)&&d.ca){try{d.ca()}catch{}d.ca=void 0}}else _n(d,11)}else if((i.K||d.g==i)&&ys(d),!H(c))for(T=d.Da.g.parse(c),c=0;c<T.length;c++){let ue=T[c];if(d.T=ue[0],ue=ue[1],d.G==2)if(ue[0]=="c"){d.K=ue[1],d.ia=ue[2];const qe=ue[3];qe!=null&&(d.la=qe,d.j.info("VER="+d.la));const ze=ue[4];ze!=null&&(d.Aa=ze,d.j.info("SVER="+d.Aa));const Bn=ue[5];Bn!=null&&typeof Bn=="number"&&0<Bn&&(p=1.5*Bn,d.L=p,d.j.info("backChannelRequestTimeoutMs_="+p)),p=d;const gt=i.g;if(gt){const _s=gt.g?gt.g.getResponseHeader("X-Client-Wire-Protocol"):null;if(_s){var R=p.h;R.g||_s.indexOf("spdy")==-1&&_s.indexOf("quic")==-1&&_s.indexOf("h2")==-1||(R.j=R.l,R.g=new Set,R.h&&(ki(R,R.h),R.h=null))}if(p.D){const Li=gt.g?gt.g.getResponseHeader("X-HTTP-Session-Id"):null;Li&&(p.ya=Li,we(p.I,p.D,Li))}}d.G=3,d.l&&d.l.ua(),d.ba&&(d.R=Date.now()-i.F,d.j.info("Handshake RTT: "+d.R+"ms")),p=d;var F=i;if(p.qa=Ya(p,p.J?p.ia:null,p.W),F.K){xa(p.h,F);var me=F,Ue=p.L;Ue&&(me.I=Ue),me.B&&(Si(me),gn(me)),p.g=F}else Ha(p);0<d.i.length&&gs(d)}else ue[0]!="stop"&&ue[0]!="close"||_n(d,7);else d.G==3&&(ue[0]=="stop"||ue[0]=="close"?ue[0]=="stop"?_n(d,7):ji(d):ue[0]!="noop"&&d.l&&d.l.ta(ue),d.v=0)}}mn(4)}catch{}}var ad=class{constructor(i,c){this.g=i,this.map=c}};function Ia(i){this.l=i||10,u.PerformanceNavigationTiming?(i=u.performance.getEntriesByType("navigation"),i=0<i.length&&(i[0].nextHopProtocol=="hq"||i[0].nextHopProtocol=="h2")):i=!!(u.chrome&&u.chrome.loadTimes&&u.chrome.loadTimes()&&u.chrome.loadTimes().wasFetchedViaSpdy),this.j=i?this.l:1,this.g=null,1<this.j&&(this.g=new Set),this.h=null,this.i=[]}function Ea(i){return i.h?!0:i.g?i.g.size>=i.j:!1}function ba(i){return i.h?1:i.g?i.g.size:0}function Ni(i,c){return i.h?i.h==c:i.g?i.g.has(c):!1}function ki(i,c){i.g?i.g.add(c):i.h=c}function xa(i,c){i.h&&i.h==c?i.h=null:i.g&&i.g.has(c)&&i.g.delete(c)}Ia.prototype.cancel=function(){if(this.i=Ta(this),this.h)this.h.cancel(),this.h=null;else if(this.g&&this.g.size!==0){for(const i of this.g.values())i.cancel();this.g.clear()}};function Ta(i){if(i.h!=null)return i.i.concat(i.h.D);if(i.g!=null&&i.g.size!==0){let c=i.i;for(const d of i.g.values())c=c.concat(d.D);return c}return S(i.i)}function ld(i){if(i.V&&typeof i.V=="function")return i.V();if(typeof Map<"u"&&i instanceof Map||typeof Set<"u"&&i instanceof Set)return Array.from(i.values());if(typeof i=="string")return i.split("");if(h(i)){for(var c=[],d=i.length,p=0;p<d;p++)c.push(i[p]);return c}c=[],d=0;for(p in i)c[d++]=i[p];return c}function cd(i){if(i.na&&typeof i.na=="function")return i.na();if(!i.V||typeof i.V!="function"){if(typeof Map<"u"&&i instanceof Map)return Array.from(i.keys());if(!(typeof Set<"u"&&i instanceof Set)){if(h(i)||typeof i=="string"){var c=[];i=i.length;for(var d=0;d<i;d++)c.push(d);return c}c=[],d=0;for(const p in i)c[d++]=p;return c}}}function Aa(i,c){if(i.forEach&&typeof i.forEach=="function")i.forEach(c,void 0);else if(h(i)||typeof i=="string")Array.prototype.forEach.call(i,c,void 0);else for(var d=cd(i),p=ld(i),T=p.length,R=0;R<T;R++)c.call(void 0,p[R],d&&d[R],i)}var Ca=RegExp("^(?:([^:/?#.]+):)?(?://(?:([^\\\\/?#]*)@)?([^\\\\/?#]*?)(?::([0-9]+))?(?=[\\\\/?#]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#([\\s\\S]*))?$");function ud(i,c){if(i){i=i.split("&");for(var d=0;d<i.length;d++){var p=i[d].indexOf("="),T=null;if(0<=p){var R=i[d].substring(0,p);T=i[d].substring(p+1)}else R=i[d];c(R,T?decodeURIComponent(T.replace(/\+/g," ")):"")}}}function vn(i){if(this.g=this.o=this.j="",this.s=null,this.m=this.l="",this.h=!1,i instanceof vn){this.h=i.h,cs(this,i.j),this.o=i.o,this.g=i.g,us(this,i.s),this.l=i.l;var c=i.i,d=new yr;d.i=c.i,c.g&&(d.g=new Map(c.g),d.h=c.h),Sa(this,d),this.m=i.m}else i&&(c=String(i).match(Ca))?(this.h=!1,cs(this,c[1]||"",!0),this.o=mr(c[2]||""),this.g=mr(c[3]||"",!0),us(this,c[4]),this.l=mr(c[5]||"",!0),Sa(this,c[6]||"",!0),this.m=mr(c[7]||"")):(this.h=!1,this.i=new yr(null,this.h))}vn.prototype.toString=function(){var i=[],c=this.j;c&&i.push(gr(c,Ra,!0),":");var d=this.g;return(d||c=="file")&&(i.push("//"),(c=this.o)&&i.push(gr(c,Ra,!0),"@"),i.push(encodeURIComponent(String(d)).replace(/%25([0-9a-fA-F]{2})/g,"%$1")),d=this.s,d!=null&&i.push(":",String(d))),(d=this.l)&&(this.g&&d.charAt(0)!="/"&&i.push("/"),i.push(gr(d,d.charAt(0)=="/"?fd:dd,!0))),(d=this.i.toString())&&i.push("?",d),(d=this.m)&&i.push("#",gr(d,md)),i.join("")};function Bt(i){return new vn(i)}function cs(i,c,d){i.j=d?mr(c,!0):c,i.j&&(i.j=i.j.replace(/:$/,""))}function us(i,c){if(c){if(c=Number(c),isNaN(c)||0>c)throw Error("Bad port number "+c);i.s=c}else i.s=null}function Sa(i,c,d){c instanceof yr?(i.i=c,gd(i.i,i.h)):(d||(c=gr(c,pd)),i.i=new yr(c,i.h))}function we(i,c,d){i.i.set(c,d)}function hs(i){return we(i,"zx",Math.floor(2147483648*Math.random()).toString(36)+Math.abs(Math.floor(2147483648*Math.random())^Date.now()).toString(36)),i}function mr(i,c){return i?c?decodeURI(i.replace(/%25/g,"%2525")):decodeURIComponent(i):""}function gr(i,c,d){return typeof i=="string"?(i=encodeURI(i).replace(c,hd),d&&(i=i.replace(/%25([0-9a-fA-F]{2})/g,"%$1")),i):null}function hd(i){return i=i.charCodeAt(0),"%"+(i>>4&15).toString(16)+(i&15).toString(16)}var Ra=/[#\/\?@]/g,dd=/[#\?:]/g,fd=/[#\?]/g,pd=/[#\?@]/g,md=/#/g;function yr(i,c){this.h=this.g=null,this.i=i||null,this.j=!!c}function tn(i){i.g||(i.g=new Map,i.h=0,i.i&&ud(i.i,function(c,d){i.add(decodeURIComponent(c.replace(/\+/g," ")),d)}))}n=yr.prototype,n.add=function(i,c){tn(this),this.i=null,i=Vn(this,i);var d=this.g.get(i);return d||this.g.set(i,d=[]),d.push(c),this.h+=1,this};function Na(i,c){tn(i),c=Vn(i,c),i.g.has(c)&&(i.i=null,i.h-=i.g.get(c).length,i.g.delete(c))}function ka(i,c){return tn(i),c=Vn(i,c),i.g.has(c)}n.forEach=function(i,c){tn(this),this.g.forEach(function(d,p){d.forEach(function(T){i.call(c,T,p,this)},this)},this)},n.na=function(){tn(this);const i=Array.from(this.g.values()),c=Array.from(this.g.keys()),d=[];for(let p=0;p<c.length;p++){const T=i[p];for(let R=0;R<T.length;R++)d.push(c[p])}return d},n.V=function(i){tn(this);let c=[];if(typeof i=="string")ka(this,i)&&(c=c.concat(this.g.get(Vn(this,i))));else{i=Array.from(this.g.values());for(let d=0;d<i.length;d++)c=c.concat(i[d])}return c},n.set=function(i,c){return tn(this),this.i=null,i=Vn(this,i),ka(this,i)&&(this.h-=this.g.get(i).length),this.g.set(i,[c]),this.h+=1,this},n.get=function(i,c){return i?(i=this.V(i),0<i.length?String(i[0]):c):c};function Pa(i,c,d){Na(i,c),0<d.length&&(i.i=null,i.g.set(Vn(i,c),S(d)),i.h+=d.length)}n.toString=function(){if(this.i)return this.i;if(!this.g)return"";const i=[],c=Array.from(this.g.keys());for(var d=0;d<c.length;d++){var p=c[d];const R=encodeURIComponent(String(p)),F=this.V(p);for(p=0;p<F.length;p++){var T=R;F[p]!==""&&(T+="="+encodeURIComponent(String(F[p]))),i.push(T)}}return this.i=i.join("&")};function Vn(i,c){return c=String(c),i.j&&(c=c.toLowerCase()),c}function gd(i,c){c&&!i.j&&(tn(i),i.i=null,i.g.forEach(function(d,p){var T=p.toLowerCase();p!=T&&(Na(this,p),Pa(this,T,d))},i)),i.j=c}function yd(i,c){const d=new te;if(u.Image){const p=new Image;p.onload=C(nn,d,"TestLoadImage: loaded",!0,c,p),p.onerror=C(nn,d,"TestLoadImage: error",!1,c,p),p.onabort=C(nn,d,"TestLoadImage: abort",!1,c,p),p.ontimeout=C(nn,d,"TestLoadImage: timeout",!1,c,p),u.setTimeout(function(){p.ontimeout&&p.ontimeout()},1e4),p.src=i}else c(!1)}function vd(i,c){const d=new te,p=new AbortController,T=setTimeout(()=>{p.abort(),nn(d,"TestPingServer: timeout",!1,c)},1e4);fetch(i,{signal:p.signal}).then(R=>{clearTimeout(T),R.ok?nn(d,"TestPingServer: ok",!0,c):nn(d,"TestPingServer: server error",!1,c)}).catch(()=>{clearTimeout(T),nn(d,"TestPingServer: error",!1,c)})}function nn(i,c,d,p,T){try{T&&(T.onload=null,T.onerror=null,T.onabort=null,T.ontimeout=null),p(d)}catch{}}function _d(){this.g=new Ci}function wd(i,c,d){const p=d||"";try{Aa(i,function(T,R){let F=T;f(T)&&(F=cr(T)),c.push(p+R+"="+encodeURIComponent(F))})}catch(T){throw c.push(p+"type="+encodeURIComponent("_badmap")),T}}function ds(i){this.l=i.Ub||null,this.j=i.eb||!1}P(ds,ur),ds.prototype.g=function(){return new fs(this.l,this.j)},ds.prototype.i=function(i){return function(){return i}}({});function fs(i,c){he.call(this),this.D=i,this.o=c,this.m=void 0,this.status=this.readyState=0,this.responseType=this.responseText=this.response=this.statusText="",this.onreadystatechange=null,this.u=new Headers,this.h=null,this.B="GET",this.A="",this.g=!1,this.v=this.j=this.l=null}P(fs,he),n=fs.prototype,n.open=function(i,c){if(this.readyState!=0)throw this.abort(),Error("Error reopening a connection");this.B=i,this.A=c,this.readyState=1,_r(this)},n.send=function(i){if(this.readyState!=1)throw this.abort(),Error("need to call open() first. ");this.g=!0;const c={headers:this.u,method:this.B,credentials:this.m,cache:void 0};i&&(c.body=i),(this.D||u).fetch(new Request(this.A,c)).then(this.Sa.bind(this),this.ga.bind(this))},n.abort=function(){this.response=this.responseText="",this.u=new Headers,this.status=0,this.j&&this.j.cancel("Request was aborted.").catch(()=>{}),1<=this.readyState&&this.g&&this.readyState!=4&&(this.g=!1,vr(this)),this.readyState=0},n.Sa=function(i){if(this.g&&(this.l=i,this.h||(this.status=this.l.status,this.statusText=this.l.statusText,this.h=i.headers,this.readyState=2,_r(this)),this.g&&(this.readyState=3,_r(this),this.g)))if(this.responseType==="arraybuffer")i.arrayBuffer().then(this.Qa.bind(this),this.ga.bind(this));else if(typeof u.ReadableStream<"u"&&"body"in i){if(this.j=i.body.getReader(),this.o){if(this.responseType)throw Error('responseType must be empty for "streamBinaryChunks" mode responses.');this.response=[]}else this.response=this.responseText="",this.v=new TextDecoder;ja(this)}else i.text().then(this.Ra.bind(this),this.ga.bind(this))};function ja(i){i.j.read().then(i.Pa.bind(i)).catch(i.ga.bind(i))}n.Pa=function(i){if(this.g){if(this.o&&i.value)this.response.push(i.value);else if(!this.o){var c=i.value?i.value:new Uint8Array(0);(c=this.v.decode(c,{stream:!i.done}))&&(this.response=this.responseText+=c)}i.done?vr(this):_r(this),this.readyState==3&&ja(this)}},n.Ra=function(i){this.g&&(this.response=this.responseText=i,vr(this))},n.Qa=function(i){this.g&&(this.response=i,vr(this))},n.ga=function(){this.g&&vr(this)};function vr(i){i.readyState=4,i.l=null,i.j=null,i.v=null,_r(i)}n.setRequestHeader=function(i,c){this.u.append(i,c)},n.getResponseHeader=function(i){return this.h&&this.h.get(i.toLowerCase())||""},n.getAllResponseHeaders=function(){if(!this.h)return"";const i=[],c=this.h.entries();for(var d=c.next();!d.done;)d=d.value,i.push(d[0]+": "+d[1]),d=c.next();return i.join(`\r
...
`}),c}function Pi(i,c,d){e:{for(p in d){var p=!1;break e}p=!0}p||(d=Oa(d),typeof i=="string"?d!=null&&encodeURIComponent(String(d)):we(i,c,d))}function Te(i){he.call(this),this.headers=new Map,this.o=i||null,this.h=!1,this.v=this.g=null,this.D="",this.m=0,this.l="",this.j=this.B=this.u=this.A=!1,this.I=null,this.H="",this.J=!1}P(Te,he);var Id=/^https?$/i,Ed=["POST","PUT"];n=Te.prototype,n.Ha=function(i){this.J=i},n.ea=function(i,c,d,p){if(this.g)throw Error("[goog.net.XhrIo] Object is active with another request="+this.D+"; newUri="+i);c=c?c.toUpperCase():"GET",this.D=i,this.l="",this.m=0,this.A=!1,this.h=!0,this.g=this.o?this.o.g():fe.g(),this.v=this.o?hr(this.o):hr(fe),this.g.onreadystatechange=x(this.Ea,this);try{this.B=!0,this.g.open(c,String(i),!0),this.B=!1}catch(R){Da(this,R);return}if(i=d||"",d=new Map(this.headers),p)if(Object.getPrototypeOf(p)===Object.prototype)for(var T in p)d.set(T,p[T]);else if(typeof p.keys=="function"&&typeof p.get=="function")for(const R of p.keys())d.set(R,p.get(R));else throw Error("Unknown input type for opt_headers: "+String(p));p=Array.from(d.keys()).find(R=>R.toLowerCase()=="content-type"),T=u.FormData&&i instanceof u.FormData,!(0<=Array.prototype.indexOf.call(Ed,c,void 0))||p||T||d.set("Content-Type","application/x-www-form-urlencoded;charset=utf-8");for(const[R,F]of d)this.g.setRequestHeader(R,F);this.H&&(this.g.responseType=this.H),"withCredentials"in this.g&&this.g.withCredentials!==this.J&&(this.g.withCredentials=this.J);try{Fa(this),this.u=!0,this.g.send(i),this.u=!1}catch(R){Da(this,R)}};function Da(i,c){i.h=!1,i.g&&(i.j=!0,i.g.abort(),i.j=!1),i.l=c,i.m=5,La(i),ps(i)}function La(i){i.A||(i.A=!0,Z(i,"complete"),Z(i,"error"))}n.abort=function(i){this.g&&this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1,this.m=i||7,Z(this,"complete"),Z(this,"abort"),ps(this))},n.N=function(){this.g&&(this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1),ps(this,!0)),Te.aa.N.call(this)},n.Ea=function(){this.s||(this.B||this.u||this.j?Ma(this):this.bb())},n.bb=function(){Ma(this)};function Ma(i){if(i.h&&typeof a<"u"&&(!i.v[1]||$t(i)!=4||i.Z()!=2)){if(i.u&&$t(i)==4)ae(i.Ea,0,i);else if(Z(i,"readystatechange"),$t(i)==4){i.h=!1;try{const F=i.Z();e:switch(F){case 200:case 201:case 202:case 204:case 206:case 304:case 1223:var c=!0;break e;default:c=!1}var d;if(!(d=c)){var p;if(p=F===0){var T=String(i.D).match(Ca)[1]||null;!T&&u.self&&u.self.location&&(T=u.self.location.protocol.slice(0,-1)),p=!Id.test(T?T.toLowerCase():"")}d=p}if(d)Z(i,"complete"),Z(i,"success");else{i.m=6;try{var R=2<$t(i)?i.g.statusText:""}catch{R=""}i.l=R+" ["+i.Z()+"]",La(i)}}finally{ps(i)}}}}function ps(i,c){if(i.g){Fa(i);const d=i.g,p=i.v[0]?()=>{}:null;i.g=null,i.v=null,c||Z(i,"ready");try{d.onreadystatechange=p}catch{}}}function Fa(i){i.I&&(u.clearTimeout(i.I),i.I=null)}n.isActive=function(){return!!this.g};function $t(i){return i.g?i.g.readyState:0}n.Z=function(){try{return 2<$t(this)?this.g.status:-1}catch{return-1}},n.oa=function(){try{return this.g?this.g.responseText:""}catch{return""}},n.Oa=function(i){if(this.g){var c=this.g.responseText;return i&&c.indexOf(i)==0&&(c=c.substring(i.length)),_a(c)}};function Va(i){try{if(!i.g)return null;if("response"in i.g)return i.g.response;switch(i.H){case"":case"text":return i.g.responseText;case"arraybuffer":if("mozResponseArrayBuffer"in i.g)return i.g.mozResponseArrayBuffer}return null}catch{return null}}function bd(i){const c={};i=(i.g&&2<=$t(i)&&i.g.getAllResponseHeaders()||"").split(`\r
`);for(let p=0;p<i.length;p++){if(H(i[p]))continue;var d=w(i[p]);const T=d[0];if(d=d[1],typeof d!="string")continue;d=d.trim();const R=c[T]||[];c[T]=R,R.push(d)}I(c,function(p){return p.join(", ")})}n.Ba=function(){return this.m},n.Ka=function(){return typeof this.l=="string"?this.l:String(this.l)};function wr(i,c,d){return d&&d.internalChannelParams&&d.internalChannelParams[i]||c}function Ua(i){this.Aa=0,this.i=[],this.j=new te,this.ia=this.qa=this.I=this.W=this.g=this.ya=this.D=this.H=this.m=this.S=this.o=null,this.Ya=this.U=0,this.Va=wr("failFast",!1,i),this.F=this.C=this.u=this.s=this.l=null,this.X=!0,this.za=this.T=-1,this.Y=this.v=this.B=0,this.Ta=wr("baseRetryDelayMs",5e3,i),this.cb=wr("retryDelaySeedMs",1e4,i),this.Wa=wr("forwardChannelMaxRetries",2,i),this.wa=wr("forwardChannelRequestTimeoutMs",2e4,i),this.pa=i&&i.xmlHttpFactory||void 0,this.Xa=i&&i.Tb||void 0,this.Ca=i&&i.useFetchStreams||!1,this.L=void 0,this.J=i&&i.supportsCrossDomainXhr||!1,this.K="",this.h=new Ia(i&&i.concurrentRequestLimit),this.Da=new _d,this.P=i&&i.fastHandshake||!1,this.O=i&&i.encodeInitMessageHeaders||!1,this.P&&this.O&&(this.O=!1),this.Ua=i&&i.Rb||!1,i&&i.xa&&this.j.xa(),i&&i.forceLongPolling&&(this.X=!1),this.ba=!this.P&&this.X&&i&&i.detectBufferingProxy||!1,this.ja=void 0,i&&i.longPollingTimeout&&0<i.longPollingTimeout&&(this.ja=i.longPollingTimeout),this.ca=void 0,this.R=0,this.M=!1,this.ka=this.A=null}n=Ua.prototype,n.la=8,n.G=1,n.connect=function(i,c,d,p){N(0),this.W=i,this.H=c||{},d&&p!==void 0&&(this.H.OSID=d,this.H.OAID=p),this.F=this.X,this.I=Ya(this,null,this.W),gs(this)};function ji(i){if(Ba(i),i.G==3){var c=i.U++,d=Bt(i.I);if(we(d,"SID",i.K),we(d,"RID",c),we(d,"TYPE","terminate"),Ir(i,d),c=new it(i,i.j,c),c.L=2,c.v=hs(Bt(d)),d=!1,u.navigator&&u.navigator.sendBeacon)try{d=u.navigator.sendBeacon(c.v.toString(),"")}catch{}!d&&u.Image&&(new Image().src=c.v,d=!0),d||(c.g=Ja(c.j,null),c.g.ea(c.v)),c.F=Date.now(),gn(c)}Ka(i)}function ms(i){i.g&&(Di(i),i.g.cancel(),i.g=null)}function Ba(i){ms(i),i.u&&(u.clearTimeout(i.u),i.u=null),ys(i),i.h.cancel(),i.s&&(typeof i.s=="number"&&u.clearTimeout(i.s),i.s=null)}function gs(i){if(!Ea(i.h)&&!i.s){i.s=!0;var c=i.Ga;ye||Ze(),Oe||(ye(),Oe=!0),pt.add(c,i),i.B=0}}function xd(i,c){return ba(i.h)>=i.h.j-(i.s?1:0)?!1:i.s?(i.i=c.D.concat(i.i),!0):i.G==1||i.G==2||i.B>=(i.Va?0:i.Wa)?!1:(i.s=M(x(i.Ga,i,c),za(i,i.B)),i.B++,!0)}n.Ga=function(i){if(this.s)if(this.s=null,this.G==1){if(!i){this.U=Math.floor(1e5*Math.random()),i=this.U++;const T=new it(this,this.j,i);let R=this.o;if(this.S&&(R?(R=m(R),_(R,this.S)):R=this.S),this.m!==null||this.O||(T.H=R,R=null),this.P)e:{for(var c=0,d=0;d<this.i.length;d++){t:{var p=this.i[d];if("__data__"in p.map&&(p=p.map.__data__,typeof p=="string")){p=p.length;break t}p=void 0}if(p===void 0)break;if(c+=p,4096<c){c=d;break e}if(c===4096||d===this.i.length-1){c=d+1;break e}}c=1e3}else c=1e3;c=Ga(this,T,c),d=Bt(this.I),we(d,"RID",i),we(d,"CVER",22),this.D&&we(d,"X-HTTP-Session-Id",this.D),Ir(this,d),R&&(this.O?c="headers="+encodeURIComponent(String(Oa(R)))+"&"+c:this.m&&Pi(d,this.m,R)),ki(this.h,T),this.Ua&&we(d,"TYPE","init"),this.P?(we(d,"$req",c),we(d,"SID","null"),T.T=!0,je(T,d,null)):je(T,d,c),this.G=2}}else this.G==3&&(i?$a(this,i):this.i.length==0||Ea(this.h)||$a(this))};function $a(i,c){var d;c?d=c.l:d=i.U++;const p=Bt(i.I);we(p,"SID",i.K),we(p,"RID",d),we(p,"AID",i.T),Ir(i,p),i.m&&i.o&&Pi(p,i.m,i.o),d=new it(i,i.j,d,i.B+1),i.m===null&&(d.H=i.o),c&&(i.i=c.D.concat(i.i)),c=Ga(i,d,1e3),d.I=Math.round(.5*i.wa)+Math.round(.5*i.wa*Math.random()),ki(i.h,d),je(d,p,c)}function Ir(i,c){i.H&&L(i.H,function(d,p){we(c,p,d)}),i.l&&Aa({},function(d,p){we(c,p,d)})}function Ga(i,c,d){d=Math.min(i.i.length,d);var p=i.l?x(i.l.Na,i.l,i):null;e:{var T=i.i;let R=-1;for(;;){const F=["count="+d];R==-1?0<d?(R=T[0].g,F.push("ofs="+R)):R=0:F.push("ofs="+R);let me=!0;for(let Ue=0;Ue<d;Ue++){let ue=T[Ue].g;const qe=T[Ue].map;if(ue-=R,0>ue)R=Math.max(0,T[Ue].g-100),me=!1;else try{wd(qe,F,"req"+ue+"_")}catch{p&&p(qe)}}if(me){p=F.join("&");break e}}}return i=i.i.splice(0,d),c.D=i,p}function Ha(i){if(!i.g&&!i.u){i.Y=1;var c=i.Fa;ye||Ze(),Oe||(ye(),Oe=!0),pt.add(c,i),i.v=0}}function Oi(i){return i.g||i.u||3<=i.v?!1:(i.Y++,i.u=M(x(i.Fa,i),za(i,i.v)),i.v++,!0)}n.Fa=function(){if(this.u=null,Wa(this),this.ba&&!(this.M||this.g==null||0>=this.R)){var i=2*this.R;this.j.info("BP detection timer enabled: "+i),this.A=M(x(this.ab,this),i)}},n.ab=function(){this.A&&(this.A=null,this.j.info("BP detection timeout reached."),this.j.info("Buffering proxy detected and switch to long-polling!"),this.F=!1,this.M=!0,N(10),ms(this),Wa(this))};function Di(i){i.A!=null&&(u.clearTimeout(i.A),i.A=null)}function Wa(i){i.g=new it(i,i.j,"rpc",i.Y),i.m===null&&(i.g.H=i.o),i.g.O=0;var c=Bt(i.qa);we(c,"RID","rpc"),we(c,"SID",i.K),we(c,"AID",i.T),we(c,"CI",i.F?"0":"1"),!i.F&&i.ja&&we(c,"TO",i.ja),we(c,"TYPE","xmlhttp"),Ir(i,c),i.m&&i.o&&Pi(c,i.m,i.o),i.L&&(i.g.I=i.L);var d=i.g;i=i.ia,d.L=1,d.v=hs(Bt(c)),d.m=null,d.P=!0,mt(d,i)}n.Za=function(){this.C!=null&&(this.C=null,ms(this),Oi(this),N(19))};function ys(i){i.C!=null&&(u.clearTimeout(i.C),i.C=null)}function qa(i,c){var d=null;if(i.g==c){ys(i),Di(i),i.g=null;var p=2}else if(Ni(i.h,c))d=c.D,xa(i.h,c),p=1;else return;if(i.G!=0){if(c.o)if(p==1){d=c.m?c.m.length:0,c=Date.now()-c.F;var T=i.B;p=Fn(),Z(p,new $(p,d)),gs(i)}else Ha(i);else if(T=c.s,T==3||T==0&&0<c.X||!(p==1&&xd(i,c)||p==2&&Oi(i)))switch(d&&0<d.length&&(c=i.h,c.i=c.i.concat(d)),T){case 1:_n(i,5);break;case 4:_n(i,10);break;case 3:_n(i,6);break;default:_n(i,2)}}}function za(i,c){let d=i.Ta+Math.floor(Math.random()*i.cb);return i.isActive()||(d*=2),d*c}function _n(i,c){if(i.j.info("Error code "+c),c==2){var d=x(i.fb,i),p=i.Xa;const T=!p;p=new vn(p||"//www.google.com/images/cleardot.gif"),u.location&&u.location.protocol=="http"||cs(p,"https"),hs(p),T?yd(p.toString(),d):vd(p.toString(),d)}else N(2);i.G=0,i.l&&i.l.sa(c),Ka(i),Ba(i)}n.fb=function(i){i?(this.j.info("Successfully pinged google.com"),N(2)):(this.j.info("Failed to ping google.com"),N(1))};function Ka(i){if(i.G=0,i.ka=[],i.l){const c=Ta(i.h);(c.length!=0||i.i.length!=0)&&(k(i.ka,c),k(i.ka,i.i),i.h.i.length=0,S(i.i),i.i.length=0),i.l.ra()}}function Ya(i,c,d){var p=d instanceof vn?Bt(d):new vn(d);if(p.g!="")c&&(p.g=c+"."+p.g),us(p,p.s);else{var T=u.location;p=T.protocol,c=c?c+"."+T.hostname:T.hostname,T=+T.port;var R=new vn(null);p&&cs(R,p),c&&(R.g=c),T&&us(R,T),d&&(R.l=d),p=R}return d=i.D,c=i.ya,d&&c&&we(p,d,c),we(p,"VER",i.la),Ir(i,p),p}function Ja(i,c,d){if(c&&!i.J)throw Error("Can't create secondary domain capable XhrIo object.");return c=i.Ca&&!i.pa?new Te(new ds({eb:d})):new Te(i.pa),c.Ha(i.J),c}n.isActive=function(){return!!this.l&&this.l.isActive(this)};function Qa(){}n=Qa.prototype,n.ua=function(){},n.ta=function(){},n.sa=function(){},n.ra=function(){},n.isActive=function(){return!0},n.Na=function(){};function vs(){}vs.prototype.g=function(i,c){return new ot(i,c)};function ot(i,c){he.call(this),this.g=new Ua(c),this.l=i,this.h=c&&c.messageUrlParams||null,i=c&&c.messageHeaders||null,c&&c.clientProtocolHeaderRequired&&(i?i["X-Client-Protocol"]="webchannel":i={"X-Client-Protocol":"webchannel"}),this.g.o=i,i=c&&c.initMessageHeaders||null,c&&c.messageContentType&&(i?i["X-WebChannel-Content-Type"]=c.messageContentType:i={"X-WebChannel-Content-Type":c.messageContentType}),c&&c.va&&(i?i["X-WebChannel-Client-Profile"]=c.va:i={"X-WebChannel-Client-Profile":c.va}),this.g.S=i,(i=c&&c.Sb)&&!H(i)&&(this.g.m=i),this.v=c&&c.supportsCrossDomainXhr||!1,this.u=c&&c.sendRawJson||!1,(c=c&&c.httpSessionIdParam)&&!H(c)&&(this.g.D=c,i=this.h,i!==null&&c in i&&(i=this.h,c in i&&delete i[c])),this.j=new Un(this)}P(ot,he),ot.prototype.m=function(){this.g.l=this.j,this.v&&(this.g.J=!0),this.g.connect(this.l,this.h||void 0)},ot.prototype.close=function(){ji(this.g)},ot.prototype.o=function(i){var c=this.g;if(typeof i=="string"){var d={};d.__data__=i,i=d}else this.u&&(d={},d.__data__=cr(i),i=d);c.i.push(new ad(c.Ya++,i)),c.G==3&&gs(c)},ot.prototype.N=function(){this.g.l=null,delete this.j,ji(this.g),delete this.g,ot.aa.N.call(this)};function Xa(i){dr.call(this),i.__headers__&&(this.headers=i.__headers__,this.statusCode=i.__status__,delete i.__headers__,delete i.__status__);var c=i.__sm__;if(c){e:{for(const d in c){i=d;break e}i=void 0}(this.i=i)&&(i=this.i,c=c!==null&&i in c?c[i]:void 0),this.data=c}else this.data=i}P(Xa,dr);function Za(){fr.call(this),this.status=1}P(Za,fr);function Un(i){this.g=i}P(Un,Qa),Un.prototype.ua=function(){Z(this.g,"a")},Un.prototype.ta=function(i){Z(this.g,new Xa(i))},Un.prototype.sa=function(i){Z(this.g,new Za)},Un.prototype.ra=function(){Z(this.g,"b")},vs.prototype.createWebChannel=vs.prototype.g,ot.prototype.send=ot.prototype.o,ot.prototype.open=ot.prototype.m,ot.prototype.close=ot.prototype.close,wu=function(){return new vs},_u=function(){return Fn()},vu=Ft,co={mb:0,pb:1,qb:2,Jb:3,Ob:4,Lb:5,Mb:6,Kb:7,Ib:8,Nb:9,PROXY:10,NOPROXY:11,Gb:12,Cb:13,Db:14,Bb:15,Eb:16,Fb:17,ib:18,hb:19,jb:20},Ee.NO_ERROR=0,Ee.TIMEOUT=8,Ee.HTTP_ERROR=6,Ps=Ee,Pe.COMPLETE="complete",yu=Pe,ss.EventType=en,en.OPEN="a",en.CLOSE="b",en.ERROR="c",en.MESSAGE="d",he.prototype.listen=he.prototype.K,Tr=ss,Te.prototype.listenOnce=Te.prototype.L,Te.prototype.getLastError=Te.prototype.Ka,Te.prototype.getLastErrorCode=Te.prototype.Ba,Te.prototype.getStatus=Te.prototype.Z,Te.prototype.getResponseJson=Te.prototype.Oa,Te.prototype.getResponseText=Te.prototype.oa,Te.prototype.send=Te.prototype.ea,Te.prototype.setWithCredentials=Te.prototype.Ha,gu=Te}).apply(typeof Is<"u"?Is:typeof self<"u"?self:typeof window<"u"?window:{});const Nl="@firebase/firestore";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function oe(n="Unexpected state"){const e=`FIRESTORE (${rr}) INTERNAL ASSERTION FAILED: `+n;throw Sn(e),new Error(e)}function Ae(n,e){n||oe()}function ve(n,e){return n}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Iu{constructor(e,t){this.user=t,this.type="OAuth",this.headers=new Map,this.headers.set("Authorization",`Bearer ${e}`)}}class Ig{getToken(){return Promise.resolve(null)}invalidateToken(){}start(e,t){e.enqueueRetryable(()=>t(Ye.UNAUTHENTICATED))}shutdown(){}}class Eg{constructor(e){this.token=e,this.changeListener=null}getToken(){return Promise.resolve(this.token)}invalidateToken(){}start(e,t){this.changeListener=t,e.enqueueRetryable(()=>t(this.token.user))}shutdown(){this.changeListener=null}}class bg{constructor(e){this.t=e,this.currentUser=Ye.UNAUTHENTICATED,this.i=0,this.forceRefresh=!1,this.auth=null}start(e,t){Ae(this.o===void 0);let r=this.i;const s=h=>this.i!==r?(r=this.i,t(h)):Promise.resolve();let o=new xn;this.o=()=>{this.i++,this.currentUser=this.u(),o.resolve(),o=new xn,e.enqueueRetryable(()=>s(this.currentUser))};const a=()=>{const h=o;e.enqueueRetryable(async()=>{await h.promise,await s(this.currentUser)})},u=h=>{W("FirebaseAuthCredentialsProvider","Auth detected"),this.auth=h,this.o&&(this.auth.addAuthTokenListener(this.o),a())};this.t.onInit(h=>u(h)),setTimeout(()=>{if(!this.auth){const h=this.t.getImmediate({optional:!0});h?u(h):(W("FirebaseAuthCredentialsProvider","Auth not yet detected"),o.resolve(),o=new xn)}},0),a()}getToken(){const e=this.i,t=this.forceRefresh;return this.forceRefresh=!1,this.auth?this.auth.getToken(t).then(r=>this.i!==e?(W("FirebaseAuthCredentialsProvider","getToken aborted due to token change."),this.getToken()):r?(Ae(typeof r.accessToken=="string"),new Iu(r.accessToken,this.currentUser)):null):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.auth&&this.o&&this.auth.removeAuthTokenListener(this.o),this.o=void 0}u(){const e=this.auth&&this.auth.getUid();return Ae(e===null||typeof e=="string"),new Ye(e)}}class xg{constructor(e,t,r){this.l=e,this.h=t,this.P=r,this.type="FirstParty",this.user=Ye.FIRST_PARTY,this.I=new Map}T(){return this.P?this.P():null}get headers(){this.I.set("X-Goog-AuthUser",this.l);const e=this.T();return e&&this.I.set("Authorization",e),this.h&&this.I.set("X-Goog-Iam-Authorization-Token",this.h),this.I}}class Tg{constructor(e,t,r){this.l=e,this.h=t,this.P=r}getToken(){return Promise.resolve(new xg(this.l,this.h,this.P))}start(e,t){e.enqueueRetryable(()=>t(Ye.FIRST_PARTY))}shutdown(){}invalidateToken(){}}class Ag{constructor(e){this.value=e,this.type="AppCheck",this.headers=new Map,e&&e.length>0&&this.headers.set("x-firebase-appcheck",this.value)}}class Cg{constructor(e){this.A=e,this.forceRefresh=!1,this.appCheck=null,this.R=null}start(e,t){Ae(this.o===void 0);const r=o=>{o.error!=null&&W("FirebaseAppCheckTokenProvider",`Error getting App Check token; using placeholder token instead. Error: ${o.error.message}`);const a=o.token!==this.R;return this.R=o.token,W("FirebaseAppCheckTokenProvider",`Received ${a?"new":"existing"} token.`),a?t(o.token):Promise.resolve()};this.o=o=>{e.enqueueRetryable(()=>r(o))};const s=o=>{W("FirebaseAppCheckTokenProvider","AppCheck detected"),this.appCheck=o,this.o&&this.appCheck.addTokenListener(this.o)};this.A.onInit(o=>s(o)),setTimeout(()=>{if(!this.appCheck){const o=this.A.getImmediate({optional:!0});o?s(o):W("FirebaseAppCheckTokenProvider","AppCheck not yet detected")}},0)}getToken(){const e=this.forceRefresh;return this.forceRefresh=!1,this.appCheck?this.appCheck.getToken(e).then(t=>t?(Ae(typeof t.token=="string"),this.R=t.token,new Ag(t.token)):null):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.appCheck&&this.o&&this.appCheck.removeTokenListener(this.o),this.o=void 0}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Go(n){var e,t;return((t=(((e=n==null?void 0:n.mapValue)===null||e===void 0?void 0:e.fields)||{}).__type__)===null||t===void 0?void 0:t.stringValue)==="server_timestamp"}function Au(n){const e=n.mapValue.fields.__previous_value__;return Go(e)?Au(e):e}function Ys(n){const e=Rn(n.mapValue.fields.__local_write_time__.timestampValue);return new Fe(e.seconds,e.nanos)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const sy=new nt(re.comparator);function Zs(){return sy}const Lu=new nt(re.comparator);function xs(...n){let e=Lu;for(const t of n)e=e.insert(t.key,t);return e}function Mu(n){let e=Lu;return n.forEach((t,r)=>e=e.insert(t,r.overlayedDocument)),e}function En(){return Nr()}function Fu(){return Nr()}function Nr(){return new sr(n=>n.toString(),(n,e)=>n.isEqual(e))}const iy=new nt(re.comparator),oy=new Qe(re.comparator);function Je(...n){let e=oy;for(const t of n)e=e.add(t);return e}const ay=new Qe(ge);function ly(){return ay}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Jo{constructor(){this.Tr=new Qe(Le.Er),this.dr=new Qe(Le.Ar)}isEmpty(){return this.Tr.isEmpty()}addReference(e,t){const r=new Le(e,t);this.Tr=this.Tr.add(r),this.dr=this.dr.add(r)}Rr(e,t){e.forEach(r=>this.addReference(r,t))}removeReference(e,t){this.Vr(new Le(e,t))}mr(e,t){e.forEach(r=>this.removeReference(r,t))}gr(e){const t=new re(new Se([])),r=new Le(t,e),s=new Le(t,e+1),o=[];return this.dr.forEachInRange([r,s],a=>{this.Vr(a),o.push(a.key)}),o}pr(){this.Tr.forEach(e=>this.Vr(e))}Vr(e){this.Tr=this.Tr.delete(e),this.dr=this.dr.delete(e)}yr(e){const t=new re(new Se([])),r=new Le(t,e),s=new Le(t,e+1);let o=Je();return this.dr.forEachInRange([r,s],a=>{o=o.add(a.key)}),o}containsKey(e){const t=new Le(e,0),r=this.Tr.firstAfterOrEqual(t);return r!==null&&e.isEqual(r.key)}}class Le{constructor(e,t){this.key=e,this.wr=t}static Er(e,t){return re.comparator(e.key,t.key)||ge(e.wr,t.wr)}static Ar(e,t){return ge(e.wr,t.wr)||re.comparator(e.key,t.key)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class zy{constructor(e,t){this.qr={},this.overlays={},this.Qr=new xu(0),this.Kr=!1,this.Kr=!0,this.$r=new $y,this.referenceDelegate=e(this),this.Ur=new qy(this),this.indexManager=new Dy,this.remoteDocumentCache=function(s){return new Hy(s)}(r=>this.referenceDelegate.Wr(r)),this.serializer=new jy(t),this.Gr=new Uy(this.serializer)}start(){return Promise.resolve()}shutdown(){return this.Kr=!1,Promise.resolve()}get started(){return this.Kr}setDatabaseDeletedListener(){}setNetworkEnabled(){}getIndexManager(e){return this.indexManager}getDocumentOverlayCache(e){let t=this.overlays[e.toKey()];return t||(t=new By,this.overlays[e.toKey()]=t),t}getMutationQueue(e,t){let r=this.qr[e.toKey()];return r||(r=new Gy(t,this.referenceDelegate),this.qr[e.toKey()]=r),r}getGlobalsCache(){return this.$r}getTargetCache(){return this.Ur}getRemoteDocumentCache(){return this.remoteDocumentCache}getBundleCache(){return this.Gr}runTransaction(e,t,r){W("MemoryPersistence","Starting transaction:",e);const s=new Ky(this.Qr.next());return this.referenceDelegate.zr(),r(s).next(o=>this.referenceDelegate.jr(s).next(()=>o)).toPromise().then(o=>(s.raiseOnCommittedEvent(),o))}Hr(e,t){return O.or(Object.values(this.qr).map(r=>()=>r.containsKey(e,t)))}}class Ky extends Og{constructor(e){super(),this.currentSequenceNumber=e}}class Qo{constructor(e){this.persistence=e,this.Jr=new Jo,this.Yr=null}static Zr(e){return new Qo(e)}get Xr(){if(this.Yr)return this.Yr;throw oe()}addReference(e,t,r){return this.Jr.addReference(r,t),this.Xr.delete(r.toString()),O.resolve()}removeReference(e,t,r){return this.Jr.removeReference(r,t),this.Xr.add(r.toString()),O.resolve()}markPotentiallyOrphaned(e,t){return this.Xr.add(t.toString()),O.resolve()}removeTarget(e,t){this.Jr.gr(t.targetId).forEach(s=>this.Xr.add(s.toString()));const r=this.persistence.getTargetCache();return r.getMatchingKeysForTargetId(e,t.targetId).next(s=>{s.forEach(o=>this.Xr.add(o.toString()))}).next(()=>r.removeTargetData(e,t))}zr(){this.Yr=new Set}jr(e){const t=this.persistence.getRemoteDocumentCache().newChangeBuffer();return O.forEach(this.Xr,r=>{const s=re.fromPath(r);return this.ei(e,s).next(o=>{o||t.removeEntry(s,be.min())})}).next(()=>(this.Yr=null,t.apply(e)))}updateLimboDocument(e,t){return this.ei(e,t).next(r=>{r?this.Xr.delete(t.toString()):this.Xr.add(t.toString())})}Wr(e){return 0}ei(e,t){return O.or([()=>O.resolve(this.Jr.containsKey(t)),()=>this.persistence.getTargetCache().containsKey(e,t),()=>this.persistence.Hr(e,t)])}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Jy{constructor(){this.Gi=!1,this.zi=!1,this.ji=100,this.Hi=function(){return Zd()?8:Dg(Xe())>0?6:4}()}initialize(e,t){this.Ji=e,this.indexManager=t,this.Gi=!0}getDocumentsMatchingQuery(e,t,r,s){const o={result:null};return this.Yi(e,t).next(a=>{o.result=a}).next(()=>{if(!o.result)return this.Zi(e,t,s,r).next(a=>{o.result=a})}).next(()=>{if(o.result)return;const a=new Yy;return this.Xi(e,t,a).next(u=>{if(o.result=u,this.zi)return this.es(e,t,a,u.size)})}).next(()=>o.result)}es(e,t,r,s){return r.documentReadCount<this.ji?(Er()<=ie.DEBUG&&W("QueryEngine","SDK will not create cache indexes for query:",br(t),"since it only creates cache indexes for collection contains","more than or equal to",this.ji,"documents"),O.resolve()):(Er()<=ie.DEBUG&&W("QueryEngine","Query:",br(t),"scans",r.documentReadCount,"local documents and returns",s,"documents as results."),r.documentReadCount>this.Hi*s?(Er()<=ie.DEBUG&&W("QueryEngine","The SDK decides to create cache indexes for query:",br(t),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(e,Tn(t))):O.resolve())}Yi(e,t){if(Fl(t))return O.resolve(null);let r=Tn(t);return this.indexManager.getIndexType(e,r).next(s=>s===0?null:(t.limit!==null&&s===1&&(t=po(t,null,"F"),r=Tn(t)),this.indexManager.getDocumentsMatchingTarget(e,r).next(o=>{const a=Je(...o);return this.Ji.getDocuments(e,a).next(u=>this.indexManager.getMinOffset(e,r).next(h=>{const f=this.ts(t,u);return this.ns(t,f,a,h.readTime)?this.Yi(e,po(t,null,"F")):this.rs(e,f,t,h)}))})))}Zi(e,t,r,s){return Fl(t)||s.isEqual(be.min())?O.resolve(null):this.Ji.getDocuments(e,r).next(o=>{const a=this.ts(t,o);return this.ns(t,a,r,s)?O.resolve(null):(Er()<=ie.DEBUG&&W("QueryEngine","Re-using previous result from %s to execute query: %s",s.toString(),br(t)),this.rs(e,a,t,Ng(s,-1)).next(u=>u))})}ts(e,t){let r=new Qe(ny(e));return t.forEach((s,o)=>{zo(e,o)&&(r=r.add(o))}),r}ns(e,t,r,s){if(e.limit===null)return!1;if(r.size!==t.size)return!0;const o=e.limitType==="F"?t.last():t.first();return!!o&&(o.hasPendingWrites||o.version.compareTo(s)>0)}Xi(e,t,r){return Er()<=ie.DEBUG&&W("QueryEngine","Using full collection scan to execute query:",br(t)),this.Ji.getDocumentsMatchingQuery(e,t,hn.min(),r)}rs(e,t,r,s){return this.Ji.getDocumentsMatchingQuery(e,r,s).next(o=>(t.forEach(a=>{o=o.insert(a.key,a)}),o))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ke="WebChannelConnection";class ov extends class{constructor(t){this.databaseInfo=t,this.databaseId=t.databaseId;const r=t.ssl?"https":"http",s=encodeURIComponent(this.databaseId.projectId),o=encodeURIComponent(this.databaseId.database);this.Do=r+"://"+t.host,this.vo=`projects/${s}/databases/${o}`,this.Co=this.databaseId.database==="(default)"?`project_id=${s}`:`project_id=${s}&database_id=${o}`}get Fo(){return!1}Mo(t,r,s,o,a){const u=Hi(),h=this.xo(t,r.toUriEncodedString());W("RestConnection",`Sending RPC '${t}' ${u}:`,h,s);const f={"google-cloud-resource-prefix":this.vo,"x-goog-request-params":this.Co};return this.Oo(f,o,a),this.No(t,h,f,s).then(y=>(W("RestConnection",`Received RPC '${t}' ${u}: `,y),y),y=>{throw zs("RestConnection",`RPC '${t}' ${u} failed with error: `,y,"url: ",h,"request:",s),y})}Lo(t,r,s,o,a,u){return this.Mo(t,r,s,o,a)}Oo(t,r,s){t["X-Goog-Api-Client"]=function(){return"gl-js/ fire/"+rr}(),t["Content-Type"]="text/plain",this.databaseInfo.appId&&(t["X-Firebase-GMPID"]=this.databaseInfo.appId),r&&r.headers.forEach((o,a)=>t[a]=o),s&&s.headers.forEach((o,a)=>t[a]=o)}xo(t,r){const s=sv[t];return`${this.Do}/v1/${r}:${s}`}terminate(){}}{constructor(e){super(e),this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}No(e,t,r,s){const o=Hi();return new Promise((a,u)=>{const h=new gu;h.setWithCredentials(!0),h.listenOnce(yu.COMPLETE,()=>{try{switch(h.getLastErrorCode()){case Ps.NO_ERROR:const y=h.getResponseJson();W(Ke,`XHR for RPC '${e}' ${o} received:`,JSON.stringify(y)),a(y);break;case Ps.TIMEOUT:W(Ke,`RPC '${e}' ${o} timed out`),u(new J(D.DEADLINE_EXCEEDED,"Request time out"));break;case Ps.HTTP_ERROR:const E=h.getStatus();if(W(Ke,`RPC '${e}' ${o} failed with status:`,E,"response text:",h.getResponseText()),E>0){let x=h.getResponseJson();Array.isArray(x)&&(x=x[0]);const C=x==null?void 0:x.error;if(C&&C.status&&C.message){const P=function(k){const G=k.toLowerCase().replace(/_/g,"-");return Object.values(D).indexOf(G)>=0?G:D.UNKNOWN}(C.status);u(new J(P,C.message))}else u(new J(D.UNKNOWN,"Server responded with status "+h.getStatus()))}else u(new J(D.UNAVAILABLE,"Connection failed."));break;default:oe()}}finally{W(Ke,`RPC '${e}' ${o} completed.`)}});const f=JSON.stringify(s);W(Ke,`RPC '${e}' ${o} sending request:`,s),h.send(t,"POST",f,r,15)})}Bo(e,t,r){const s=Hi(),o=[this.Do,"/","google.firestore.v1.Firestore","/",e,"/channel"],a=wu(),u=_u(),h={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},f=this.longPollingOptions.timeoutSeconds;f!==void 0&&(h.longPollingTimeout=Math.round(1e3*f)),this.useFetchStreams&&(h.useFetchStreams=!0),this.Oo(h.initMessageHeaders,t,r),h.encodeInitMessageHeaders=!0;const y=o.join("");W(Ke,`Creating RPC '${e}' stream ${s}: ${y}`,h);const E=a.createWebChannel(y,h);let x=!1,C=!1;const P=new iv({Io:k=>{C?W(Ke,`Not sending because RPC '${e}' stream ${s} is closed:`,k):(x||(W(Ke,`Opening RPC '${e}' stream ${s} transport.`),E.open(),x=!0),W(Ke,`RPC '${e}' stream ${s} sending:`,k),E.send(k))},To:()=>E.close()}),S=(k,G,H)=>{k.listen(G,U=>{try{H(U)}catch(B){setTimeout(()=>{throw B},0)}})};return S(E,Tr.EventType.OPEN,()=>{C||(W(Ke,`RPC '${e}' stream ${s} transport opened.`),P.yo())}),S(E,Tr.EventType.CLOSE,()=>{C||(C=!0,W(Ke,`RPC '${e}' stream ${s} transport closed`),P.So())}),S(E,Tr.EventType.ERROR,k=>{C||(C=!0,zs(Ke,`RPC '${e}' stream ${s} transport errored:`,k),P.So(new J(D.UNAVAILABLE,"The operation could not be completed")))}),S(E,Tr.EventType.MESSAGE,k=>{var G;if(!C){const H=k.data[0];Ae(!!H);const U=H,B=U.error||((G=U[0])===null||G===void 0?void 0:G.error);if(B){W(Ke,`RPC '${e}' stream ${s} received error:`,B);const de=B.status;let L=function(g){const _=Ce[g];if(_!==void 0)return wy(_)}(de),I=B.message;L===void 0&&(L=D.INTERNAL,I="Unknown error status: "+de+" with message "+B.message),C=!0,P.So(new J(L,I)),E.close()}else W(Ke,`RPC '${e}' stream ${s} received:`,H),P.bo(H)}}),S(u,vu.STAT_EVENT,k=>{k.stat===co.PROXY?W(Ke,`RPC '${e}' stream ${s} detected buffering proxy`):k.stat===co.NOPROXY&&W(Ke,`RPC '${e}' stream ${s} detected no buffering proxy`)}),setTimeout(()=>{P.wo()},0),P}}function Wi(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class na{constructor(e,t,r){this.converter=t,this._query=r,this.type="query",this.firestore=e}withConverter(e){return new na(this.firestore,e,this._query)}}class Yt{constructor(e,t,r){this.converter=t,this._key=r,this.type="document",this.firestore=e}get _path(){return this._key.path}get id(){return this._key.path.lastSegment()}get path(){return this._key.path.canonicalString()}get parent(){return new $r(this.firestore,this.converter,this._key.path.popLast())}withConverter(e){return new Yt(this.firestore,e,this._key)}}class $r extends na{constructor(e,t,r){super(e,t,Zg(r)),this._path=r,this.type="collection"}get id(){return this._query.path.lastSegment()}get path(){return this._query.path.canonicalString()}get parent(){const e=this._path.popLast();return e.isEmpty()?null:new Yt(this.firestore,null,new re(e))}withConverter(e){return new $r(this.firestore,e,this._path)}}function Ov(n,e,...t){if(n=tt(n),arguments.length===1&&(e=Eu.newId()),kv("doc","path",e),n instanceof ta){const r=Se.fromString(e,...t);return Zl(r),new Yt(n,null,new re(r))}{if(!(n instanceof Yt||n instanceof $r))throw new J(D.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const r=n._path.child(Se.fromString(e,...t));return Zl(r),new Yt(n.firestore,n instanceof $r?n.converter:null,new re(r))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Gr{constructor(e){this._byteString=e}static fromBase64String(e){try{return new Gr(kt.fromBase64String(e))}catch(t){throw new J(D.INVALID_ARGUMENT,"Failed to construct data from Base64 string: "+t)}}static fromUint8Array(e){return new Gr(kt.fromUint8Array(e))}toBase64(){return this._byteString.toBase64()}toUint8Array(){return this._byteString.toUint8Array()}toString(){return"Bytes(base64: "+this.toBase64()+")"}isEqual(e){return this._byteString.isEqual(e._byteString)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class oh{constructor(...e){for(let t=0;t<e.length;++t)if(e[t].length===0)throw new J(D.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new Ge(e)}isEqual(e){return this._internalPath.isEqual(e._internalPath)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class lh{constructor(e,t){if(!isFinite(e)||e<-90||e>90)throw new J(D.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+e);if(!isFinite(t)||t<-180||t>180)throw new J(D.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+t);this._lat=e,this._long=t}get latitude(){return this._lat}get longitude(){return this._long}isEqual(e){return this._lat===e._lat&&this._long===e._long}toJSON(){return{latitude:this._lat,longitude:this._long}}_compareTo(e){return ge(this._lat,e._lat)||ge(this._long,e._long)}}/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function zv(n,e,t){let r;return r=n?t&&(t.merge||t.mergeFields)?n.toFirestore(e,t):n.toFirestore(e):e,r}function Kv(n,e,t){n=_o(n,Yt);const r=_o(n.firestore,ih),s=zv(n.converter,e,t);return Yv(r,[$v(Bv(r),"setDoc",n._key,s,n.converter!==null,t).toMutation(n._key,Kt.none())])}function Yv(n,e){return function(r,s){const o=new xn;return r.asyncQueue.enqueueAndForget(async()=>Ev(await Nv(r),s,o)),o.promise}(Lv(n),e)}(function(e,t=!0){(function(s){rr=s})(er),Rt(new bt("firestore",(r,{instanceIdentifier:s,options:o})=>{const a=r.getProvider("app").getImmediate(),u=new ih(new bg(r.getProvider("auth-internal")),new Cg(r.getProvider("app-check-internal")),function(f,y){if(!Object.prototype.hasOwnProperty.apply(f.options,["projectId"]))throw new J(D.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new Js(f.options.projectId,y)}(a,s),a);return o=Object.assign({useFetchStreams:t},o),u._setSettings(o),u},"PUBLIC").setMultipleInstances(!0)),dt(Nl,"4.7.3",e),dt(Nl,"4.7.3","esm2017")})();const mh="@firebase/installations",sa="0.6.9";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const gh=1e4,yh=`w:${sa}`,vh="FIS_v2",Jv="https://firebaseinstallations.googleapis.com/v1",Qv=60*60*1e3,Xv="installations",Zv="Installations";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const et=new li("@firebase/analytics");/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
🔴🔴🔴 ===== CRITICAL: ONTRACK HANDLER FIRING! =====`),console.log("🔴 ONTRACK CALLED AT:",new Date().toISOString()),console.log("🔴 Track received:",{kind:te.track.kind,id:te.track.id,enabled:te.track.enabled});const V=z.current._remoteStream;if(console.log("🔴 Using persistent remote stream ID:",V.id),V.addTrack(te.track),console.log("✅ Track added to persistent remote stream"),console.log("📥 Remote stream now has",V.getTracks().length,"track(s)"),console.log("📥 Tracks:",V.getTracks().map(le=>({kind:le.kind,id:le.id,enabled:le.enabled}))),!ct.current){console.error("❌ CRITICAL ERROR: remoteVideoRef.current is NULL!"),console.error("   Cannot attach remote track - video element not available");return}ct.current.srcObject!==V?(console.log("📺 ATTACHING PERSISTENT STREAM to remoteVideoRef"),ct.current.srcObject=V,ct.current.muted=!1,console.log("📺 srcObject attached, attempting play()..."),ct.current.play().catch(()=>{console.log("ℹ️ Autoplay blocked - will play on user interaction")})):(console.log("📺 STREAM ALREADY ATTACHED - skipping re-attachment"),console.log("   Stream has",V.getTracks().length,"tracks now")),console.log(`✅ ✅ ✅ ONTRACK COMPLETE - Remote stream persisted and attached
...
📊 Total senders:`,V.length),V.forEach((le,pe)=>{var ke,We,Ee,Pe;console.log(`📊 Sender ${pe}:`,{kind:(ke=le.track)==null?void 0:ke.kind,enabled:(We=le.track)==null?void 0:We.enabled,readyState:(Ee=le.track)==null?void 0:Ee.readyState,id:(Pe=le.track)==null?void 0:Pe.id})})},1e3)):M.connectionState==="disconnected"?(L(!1),console.log("⚠️ WebRTC connection DISCONNECTED")):M.connectionState==="failed"?(L(!1),console.log("❌ WebRTC connection FAILED")):M.connectionState==="closed"&&(L(!1),console.log("❌ WebRTC connection CLOSED"))},!ee.current)throw console.error("❌ CRITICAL ERROR: localStreamRef.current is null/undefined in createPeerConnection!"),new Error("Local stream lost before createPeerConnection");return M};A.useEffect(()=>(console.log(`

🔌 ===== SOCKET LISTENERS SETUP (COMPONENT MOUNT) =====`),console.log("🔌 Setting up socket listeners - runs ONCE on component load"),console.log("🔌 Socket ID:",K.id),console.log("🔌 Socket connected:",K.connected),console.log("🔌 🔐 Using userIdRef.current for ALL ID comparisons:",he.current),K.off("partner_found"),K.off("webrtc_offer"),K.off("webrtc_answer"),K.off("ice_candidate"),K.off("receive_message"),K.off("partner_disconnected"),K.off("disconnect"),console.log("🔌 Removed old listeners (if any existed)"),K.on("partner_found",async N=>{var ke,We,Ee,Pe;console.log(`

📋 ===== PARTNER FOUND EVENT RECEIVED =====`),console.log("👥 RAW DATA from server:",JSON.stringify(N,null,2)),console.log("👥 My socket ID:",K.id),console.log("👥 currentUser object:",JSON.stringify(Z,null,2)),console.log("👥 userIdRef.current (SHOULD USE THIS):",he.current),console.log("👥 currentUser.googleId:",Z==null?void 0:Z.googleId),console.log("👥 currentUser.id:",Z==null?void 0:Z.id),console.log("👥 data.socketId:",N.socketId),console.log("👥 data.partnerId:",N.partnerId),console.log("👥 data.userName:",N.userName),b(!1),X(!0),Mt(!1),console.log(`
...
👤 OFFERER localStream:`,ee.current);const Ie=ee.current.getTracks();console.log("👤 OFFERER: All available tracks:",Ie),console.log("📹 OFFERER tracks detail:",Ie.map(Ve=>({kind:Ve.kind,id:Ve.id,enabled:Ve.enabled,state:Ve.readyState})));const Vt=fe.getSenders();if(console.log("📤 OFFERER: Existing senders count:",Vt.length),Vt.length>0)console.warn("⚠️ OFFERER WARNING: Tracks already added! Senders:",Vt.map(Ve=>{var je,mt;return{kind:(je=Ve.track)==null?void 0:je.kind,id:(mt=Ve.track)==null?void 0:mt.id}})),console.warn("   Not adding tracks again to avoid duplicates");else{console.log(`
...
✅ OFFERER: All tracks added to peer connection`);const Ve=fe.getSenders();console.log("📤 OFFERER senders count:",Ve.length),console.log("📤 OFFERER senders after addTrack:",Ve.map((je,mt)=>{var Ut,ls,gn;return{index:mt,kind:(Ut=je.track)==null?void 0:Ut.kind,id:(ls=je.track)==null?void 0:ls.id,trackExists:!!je.track,trackEnabled:(gn=je.track)==null?void 0:gn.enabled}})),console.log("🚀 OFFERER: Ready to send offer with",Ie.length,`tracks
...
📤 OFFERER: Sending offer with tracks:`,fe.getSenders().map(Ie=>{var Vt,Ve,je;return{kind:(Vt=Ie.track)==null?void 0:Vt.kind,id:(Ve=Ie.track)==null?void 0:Ve.id,enabled:(je=Ie.track)==null?void 0:je.enabled}})),console.log("📤 OFFERER: Partner socket ID from data:",N.socketId),console.log("📤 OFFERER: partnerSocketIdRef.current value:",st.current),console.log("🔌🔌🔌 CRITICAL: About to emit webrtc_offer with to:",N.socketId),console.log("🔌🔌🔌 CRITICAL: Is to value empty/null/undefined?",!N.socketId),K.emit("webrtc_offer",{offer:z.current.localDescription,to:N.socketId}),console.log("✅ OFFERER: webrtc_offer emitted successfully"),console.log("✅ OFFERER: webrtc_offer sent to socket ID:",N.socketId),console.log("✅ OFFERER: webrtc_offer contains",z.current.getSenders().length,"senders"),console.log("✅ OFFERER: Sent to socket:",N.socketId)}catch(fe){console.error("❌ OFFERER: Error in partner_found handler:",fe),console.error("❌ OFFERER: Stack trace:",fe.stack)}}),K.on("webrtc_offer",async N=>{console.log(`
...
📋 ===== ANSWERER SENDING ANSWER =====`);const te=z.current.getSenders();console.log("📤 ANSWERER: Final senders count:",te.length),console.log("📤 ANSWERER: Sending answer with tracks:",te.map(V=>{var le,pe,ke;return{kind:(le=V.track)==null?void 0:le.kind,id:(pe=V.track)==null?void 0:pe.id,enabled:(ke=V.track)==null?void 0:ke.enabled}})),console.log("🔌 CRITICAL: Offerer socket ID from offer:",N.from),console.log("🔌 SERVER sending ANSWER to:",N.from),K.emit("webrtc_answer",{answer:z.current.localDescription,to:N.from}),console.log("📤 ANSWERER: Answer emitted to offerer via socket:",N.from),console.log(`📋 ===== ANSWERER ANSWER SENT =====

`)}catch($){console.error(`
❌ ANSWERER: ERROR in webrtc_offer handler:`,$),console.error("❌ ANSWERER: Error message:",$.message),console.error("❌ ANSWERER: Stack trace:",$.stack)}}),K.on("webrtc_answer",async N=>{console.log(`
...
`)}catch($){console.error("❌ OFFERER: Error handling answer:",$),console.error("❌ OFFERER: Stack trace:",$.stack)}}),K.on("ice_candidate",async N=>{if(console.log(`
...
`)):console.warn("⚠️ No peer connection available for ICE candidate")}catch($){console.error("❌ Error adding ICE candidate:",$)}}),K.on("partner_disconnected",N=>{console.log(`
