...
📤 OFFERER: Sending offer with tracks:`,fe.getSenders().map(Ie=>{var Vt,Ve,je;return{kind:(Vt=Ie.track)==null?void 0:Vt.kind,id:(Ve=Ie.track)==null?void 0:Ve.id,enabled:(je=Ie.track)==null?void 0:je.enabled}})),console.log("📤 OFFERER: Partner socket ID from data:",R.socketId),console.log("📤 OFFERER: partnerSocketIdRef.current value:",it.current),console.log("🔌🔌🔌 CRITICAL: About to emit webrtc_offer with to:",R.socketId),console.log("🔌🔌🔌 CRITICAL: Is to value empty/null/undefined?",!R.socketId),K.emit("webrtc_offer",{offer:z.current.localDescription,to:R.socketId}),console.log("✅ OFFERER: webrtc_offer emitted successfully"),console.log("✅ OFFERER: webrtc_offer sent to socket ID:",R.socketId),console.log("✅ OFFERER: webrtc_offer contains",z.current.getSenders().length,"senders"),console.log("✅ OFFERER: Sent to socket:",R.socketId)}catch(fe){console.error("❌ OFFERER: Error in partner_found handler:",fe),console.error("❌ OFFERER: Stack trace:",fe.stack)}}),K.on("webrtc_offer",async R=>{console.log(`
...
//# sourceMappingURL=index-FV_t-wyc.js.map
