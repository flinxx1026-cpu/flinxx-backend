 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const $s=new li("@firebase/auth");function wp(n,...e){$s.logLevel<=oe.WARN&&$s.warn(`Auth (${tr}): ${n}`,...e)}function Ss(n,...e){$s.logLevel<=oe.ERROR&&$s.error(`Auth (${tr}): ${n}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ae(n="Unexpected state"){const e=`FIRESTORE (${sr}) INTERNAL ASSERTION FAILED: `+n;throw Sn(e),new Error(e)}function Ae(n,e){n||ae()}function ve(n,e){return n}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class se{constructor(e){this.path=e}static fromPath(e){return new se(Se.fromString(e))}static fromName(e){return new se(Se.fromString(e).popFirst(5))}static empty(){return new se(Se.emptyPath())}get collectionGroup(){return this.path.popLast().lastSegment()}hasCollectionId(e){return this.path.length>=2&&this.path.get(this.path.length-2)===e}getCollectionGroup(){return this.path.get(this.path.length-2)}getCollectionPath(){return this.path.popLast()}isEqual(e){return e!==null&&Se.comparator(this.path,e.path)===0}toString(){return this.path.toString()}static comparator(e,t){return Se.comparator(e.path,t.path)}static isDocumentKey(e){return e.length%2==0}static fromSegments(e){return new se(new Se(e.slice()))}}function Ng(n,e){const t=n.toTimestamp().seconds,r=n.toTimestamp().nanoseconds+1,s=be.fromTimestamp(r===1e9?new Fe(t+1,0):new Fe(t,r));return new hn(s,se.empty(),e)}function kg(n){return new hn(n.readTime,n.key,-1)}class hn{constructor(e,t,r){this.readTime=e,this.documentKey=t,this.largestBatchId=r}static min(){return new hn(be.min(),se.empty(),-1)}static max(){return new hn(be.max(),se.empty(),-1)}}function Pg(n,e){let t=n.readTime.compareTo(e.readTime);return t!==0?t:(t=se.comparator(n.documentKey,e.documentKey),t!==0?t:ge(n.largestBatchId,e.largestBatchId))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const sy=new rt(se.comparator);function Zs(){return sy}const Lu=new rt(se.comparator);function xs(...n){let e=Lu;for(const t of n)e=e.insert(t.key,t);return e}function Mu(n){let e=Lu;return n.forEach((t,r)=>e=e.insert(t,r.overlayedDocument)),e}function En(){return kr()}function Fu(){return kr()}function kr(){return new ir(n=>n.toString(),(n,e)=>n.isEqual(e))}const iy=new rt(se.comparator),oy=new Xe(se.comparator);function Ye(...n){let e=oy;for(const t of n)e=e.add(t);return e}const ay=new Xe(ge);function ly(){return ay}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Qo{constructor(){this.Tr=new Xe(Le.Er),this.dr=new Xe(Le.Ar)}isEmpty(){return this.Tr.isEmpty()}addReference(e,t){const r=new Le(e,t);this.Tr=this.Tr.add(r),this.dr=this.dr.add(r)}Rr(e,t){e.forEach(r=>this.addReference(r,t))}removeReference(e,t){this.Vr(new Le(e,t))}mr(e,t){e.forEach(r=>this.removeReference(r,t))}gr(e){const t=new se(new Se([])),r=new Le(t,e),s=new Le(t,e+1),o=[];return this.dr.forEachInRange([r,s],a=>{this.Vr(a),o.push(a.key)}),o}pr(){this.Tr.forEach(e=>this.Vr(e))}Vr(e){this.Tr=this.Tr.delete(e),this.dr=this.dr.delete(e)}yr(e){const t=new se(new Se([])),r=new Le(t,e),s=new Le(t,e+1);let o=Ye();return this.dr.forEachInRange([r,s],a=>{o=o.add(a.key)}),o}containsKey(e){const t=new Le(e,0),r=this.Tr.firstAfterOrEqual(t);return r!==null&&e.isEqual(r.key)}}class Le{constructor(e,t){this.key=e,this.wr=t}static Er(e,t){return se.comparator(e.key,t.key)||ge(e.wr,t.wr)}static Ar(e,t){return ge(e.wr,t.wr)||se.comparator(e.key,t.key)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Qy{constructor(){this.Gi=!1,this.zi=!1,this.ji=100,this.Hi=function(){return Zd()?8:Dg(Ze())>0?6:4}()}initialize(e,t){this.Ji=e,this.indexManager=t,this.Gi=!0}getDocumentsMatchingQuery(e,t,r,s){const o={result:null};return this.Yi(e,t).next(a=>{o.result=a}).next(()=>{if(!o.result)return this.Zi(e,t,s,r).next(a=>{o.result=a})}).next(()=>{if(o.result)return;const a=new Jy;return this.Xi(e,t,a).next(u=>{if(o.result=u,this.zi)return this.es(e,t,a,u.size)})}).next(()=>o.result)}es(e,t,r,s){return r.documentReadCount<this.ji?(br()<=oe.DEBUG&&W("QueryEngine","SDK will not create cache indexes for query:",xr(t),"since it only creates cache indexes for collection contains","more than or equal to",this.ji,"documents"),O.resolve()):(br()<=oe.DEBUG&&W("QueryEngine","Query:",xr(t),"scans",r.documentReadCount,"local documents and returns",s,"documents as results."),r.documentReadCount>this.Hi*s?(br()<=oe.DEBUG&&W("QueryEngine","The SDK decides to create cache indexes for query:",xr(t),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(e,Tn(t))):O.resolve())}Yi(e,t){if(Fl(t))return O.resolve(null);let r=Tn(t);return this.indexManager.getIndexType(e,r).next(s=>s===0?null:(t.limit!==null&&s===1&&(t=po(t,null,"F"),r=Tn(t)),this.indexManager.getDocumentsMatchingTarget(e,r).next(o=>{const a=Ye(...o);return this.Ji.getDocuments(e,a).next(u=>this.indexManager.getMinOffset(e,r).next(h=>{const f=this.ts(t,u);return this.ns(t,f,a,h.readTime)?this.Yi(e,po(t,null,"F")):this.rs(e,f,t,h)}))})))}Zi(e,t,r,s){return Fl(t)||s.isEqual(be.min())?O.resolve(null):this.Ji.getDocuments(e,r).next(o=>{const a=this.ts(t,o);return this.ns(t,a,r,s)?O.resolve(null):(br()<=oe.DEBUG&&W("QueryEngine","Re-using previous result from %s to execute query: %s",s.toString(),xr(t)),this.rs(e,a,t,Ng(s,-1)).next(u=>u))})}ts(e,t){let r=new Xe(ny(e));return t.forEach((s,o)=>{zo(e,o)&&(r=r.add(o))}),r}ns(e,t,r,s){if(e.limit===null)return!1;if(r.size!==t.size)return!0;const o=e.limitType==="F"?t.last():t.first();return!!o&&(o.hasPendingWrites||o.version.compareTo(s)>0)}Xi(e,t,r){return br()<=oe.DEBUG&&W("QueryEngine","Using full collection scan to execute query:",xr(t)),this.Ji.getDocumentsMatchingQuery(e,t,hn.min(),r)}rs(e,t,r,s){return this.Ji.getDocumentsMatchingQuery(e,r,s).next(o=>(t.forEach(a=>{o=o.insert(a.key,a)}),o))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
🔴🔴🔴 ===== CRITICAL: ONTRACK HANDLER FIRING! =====`),console.log("🔴 ONTRACK CALLED AT:",new Date().toISOString()),console.log("🔴 Track received:",{kind:te.track.kind,id:te.track.id,enabled:te.track.enabled});const V=z.current._remoteStream;if(console.log("🔴 Using persistent remote stream ID:",V.id),V.addTrack(te.track),console.log("✅ Track added to persistent remote stream"),console.log("📥 Remote stream now has",V.getTracks().length,"track(s)"),console.log("📥 Tracks:",V.getTracks().map(K=>({kind:K.kind,id:K.id,enabled:K.enabled}))),!ct.current){console.error("❌ CRITICAL ERROR: remoteVideoRef.current is NULL!"),console.error("   Cannot attach remote track - video element not available");return}ct.current.srcObject!==V?(console.log("📺 ATTACHING PERSISTENT STREAM to remoteVideoRef"),ct.current.srcObject=V,ct.current.muted=!1,console.log("📺 srcObject attached, attempting play()..."),ct.current.play().catch(()=>{console.log("ℹ️ Autoplay blocked - will play on user interaction")})):(console.log("📺 STREAM ALREADY ATTACHED - skipping re-attachment"),console.log("   Stream has",V.getTracks().length,"tracks now")),console.log(`✅ ✅ ✅ ONTRACK COMPLETE - Remote stream persisted and attached
...
📊 ===== RECEIVER DEBUG CHECK (after connected) =====`);const te=M.getReceivers();console.log("📊 Total receivers:",te.length),te.forEach((K,pe)=>{var ke,We,Ee,Pe,fe;console.log(`📊 Receiver ${pe}:`,{kind:(ke=K.track)==null?void 0:ke.kind,enabled:(We=K.track)==null?void 0:We.enabled,readyState:(Ee=K.track)==null?void 0:Ee.readyState,id:(Pe=K.track)==null?void 0:Pe.id,muted:(fe=K.track)==null?void 0:fe.muted})}),console.log("📊 Audio and video tracks should be present above");const V=M.getSenders();console.log(`
📊 Total senders:`,V.length),V.forEach((K,pe)=>{var ke,We,Ee,Pe;console.log(`📊 Sender ${pe}:`,{kind:(ke=K.track)==null?void 0:ke.kind,enabled:(We=K.track)==null?void 0:We.enabled,readyState:(Ee=K.track)==null?void 0:Ee.readyState,id:(Pe=K.track)==null?void 0:Pe.id})})},1e3)):M.connectionState==="disconnected"?(L(!1),console.log("⚠️ WebRTC connection DISCONNECTED")):M.connectionState==="failed"?(L(!1),console.log("❌ WebRTC connection FAILED")):M.connectionState==="closed"&&(L(!1),console.log("❌ WebRTC connection CLOSED"))},!ee.current)throw console.error("❌ CRITICAL ERROR: localStreamRef.current is null/undefined in createPeerConnection!"),new Error("Local stream lost before createPeerConnection");return M};A.useEffect(()=>(console.log(`
...
📋 ===== PARTNER FOUND EVENT RECEIVED =====`),console.log("👥 RAW DATA from server:",JSON.stringify(N,null,2)),console.log("👥 My socket ID:",J.id),console.log("👥 currentUser object:",JSON.stringify(ne,null,2)),console.log("👥 userIdRef.current (SHOULD USE THIS):",he.current),console.log("👥 currentUser.googleId:",ne==null?void 0:ne.googleId),console.log("👥 currentUser.id:",ne==null?void 0:ne.id),console.log("👥 data.socketId:",N.socketId),console.log("👥 data.partnerId:",N.partnerId),console.log("👥 data.userName:",N.userName),b(!1),Z(!0),Mt(!1),console.log(`
...
📤 OFFERER: Sending offer with tracks:`,fe.getSenders().map(Ie=>{var Vt,Ve,je;return{kind:(Vt=Ie.track)==null?void 0:Vt.kind,id:(Ve=Ie.track)==null?void 0:Ve.id,enabled:(je=Ie.track)==null?void 0:je.enabled}})),console.log("📤 OFFERER: Partner socket ID from data:",N.socketId),console.log("📤 OFFERER: partnerSocketIdRef.current value:",it.current),console.log("🔌🔌🔌 CRITICAL: About to emit webrtc_offer with to:",N.socketId),console.log("🔌🔌🔌 CRITICAL: Is to value empty/null/undefined?",!N.socketId),J.emit("webrtc_offer",{offer:z.current.localDescription,to:N.socketId}),console.log("✅ OFFERER: webrtc_offer emitted successfully"),console.log("✅ OFFERER: webrtc_offer sent to socket ID:",N.socketId),console.log("✅ OFFERER: webrtc_offer contains",z.current.getSenders().length,"senders"),console.log("✅ OFFERER: Sent to socket:",N.socketId)}catch(fe){console.error("❌ OFFERER: Error in partner_found handler:",fe),console.error("❌ OFFERER: Stack trace:",fe.stack)}}),J.on("webrtc_offer",async N=>{console.log(`

🎉🎉🎉🎉🎉🎉🎉🎉🎉🎉🎉🎉🎉🎉🎉🎉🎉🎉🎉🎉🎉🎉🎉`),console.log("🎉🎉🎉 ⭐️ ANSWERER HANDLER FIRED ⭐️ 🎉🎉🎉"),console.log("🎉🎉🎉🎉🎉🎉🎉🎉🎉🎉🎉🎉🎉🎉🎉🎉🎉🎉🎉🎉🎉🎉🎉"),console.log("📋 ===== ANSWERER RECEIVED OFFER ====="),console.log("⭐️ ANSWERER: WEBRTC_OFFER EVENT FIRED - OFFER WAS RECEIVED"),console.log("📨 ANSWERER: Received WebRTC offer from offerer"),console.log("📨 ANSWERER: My socket ID:",J.id),console.log("📨 ANSWERER: Offer from:",N.from),console.log("📨 ANSWERER: Full data:",N),console.log("📨 ANSWERER: data.from (offerer socket ID):",N.from),it.current=N.from,console.log("🔌 CRITICAL: Stored offerer socket ID:",it.current);try{if(z.current)console.log("⚠️ ANSWERER: WARNING - peerConnectionRef already exists (should be null for answerer)");else{console.log("📍 ANSWERER: Creating new peer connection for the first time");let V;try{V=await en()}catch(K){console.error("❌ ANSWERER: Error creating peer connection:",K);return}z.current=V,console.log("✅ ANSWERER: Peer connection created")}if(console.log(`
🔍 ANSWERER: ALWAYS executing track addition logic`),console.log("👤 ANSWERER: Checking localStreamRef.current..."),console.log("👤 ANSWERER localStreamRef.current:",ee.current),console.log("👤 ANSWERER localStreamRef.current === null?",ee.current===null),console.log("👤 ANSWERER localStreamRef.current === undefined?",ee.current===void 0),!ee.current){console.warn("⚠️ ANSWERER: localStreamRef.current is NULL - attempting emergency reacquisition");try{const V=await navigator.mediaDevices.getUserMedia({video:{width:{ideal:640},height:{ideal:480}},audio:!0});if(ee.current=V,le.current){le.current.srcObject=V,le.current.muted=!0;try{await le.current.play()}catch{console.warn("⚠️ Play error in answerer emergency reacquisition")}}console.log("✅ ANSWERER: Emergency stream acquisition successful")}catch(V){throw console.error("❌ ANSWERER: Emergency stream acquisition failed:",V.message),new Error("ANSWERER: Cannot reacquire camera stream - "+V.message)}}if(ee.current){console.log(`
✅ ANSWERER: localStream EXISTS - will add tracks`),console.log("📊 ANSWERER localStream object:",ee.current);const V=ee.current.getTracks();console.log("👤 ANSWERER: getAllTracks() returned:",V),console.log("👤 ANSWERER: Track array length:",V.length),V.length>0?console.log("👤 ANSWERER: Tracks detail:",V.map(pe=>({kind:pe.kind,id:pe.id,enabled:pe.enabled,readyState:pe.readyState}))):console.warn("⚠️ ANSWERER: WARNING - localStream exists but getTracks() returned empty array!");const K=z.current.getSenders();if(console.log("📤 ANSWERER: Existing senders count:",K.length),K.length>0)console.warn("⚠️ ANSWERER WARNING: Tracks already added! Senders:",K.map(pe=>{var ke,We;return{kind:(ke=pe.track)==null?void 0:ke.kind,id:(We=pe.track)==null?void 0:We.id}})),console.warn("   Not adding tracks again to avoid duplicates");else{console.log(`
...
✅ ANSWERER: Track addition complete (${pe} succeeded, ${ke} failed)`);const We=z.current.getSenders();console.log("📤 ANSWERER: Final senders count:",We.length),console.log("📤 ANSWERER: Senders:",We.map((Ee,Pe)=>{var fe,ut,ot;return{index:Pe,kind:(fe=Ee.track)==null?void 0:fe.kind,id:(ut=Ee.track)==null?void 0:ut.id,trackExists:!!Ee.track,trackEnabled:(ot=Ee.track)==null?void 0:ot.enabled}}))}}else throw console.error(`
...
📋 ===== ANSWERER SENDING ANSWER =====`);const te=z.current.getSenders();console.log("📤 ANSWERER: Final senders count:",te.length),console.log("📤 ANSWERER: Sending answer with tracks:",te.map(V=>{var K,pe,ke;return{kind:(K=V.track)==null?void 0:K.kind,id:(pe=V.track)==null?void 0:pe.id,enabled:(ke=V.track)==null?void 0:ke.enabled}})),console.log("🔌 CRITICAL: Offerer socket ID from offer:",N.from),console.log("🔌 SERVER sending ANSWER to:",N.from),J.emit("webrtc_answer",{answer:z.current.localDescription,to:N.from}),console.log("📤 ANSWERER: Answer emitted to offerer via socket:",N.from),console.log(`📋 ===== ANSWERER ANSWER SENT =====
...
//# sourceMappingURL=index-CnM5luOF.js.map
