 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function zp(n,e){const t=jn(n,"auth");if(t.isInitialized()){const s=t.getImmediate(),o=t.getOptions();if(Or(o,e??{}))return s;Nt(s,"already-initialized")}return t.initialize({options:e})}function Kp(n,e){const t=(e==null?void 0:e.persistence)||[],r=(Array.isArray(t)?t:[t]).map(zt);e!=null&&e.errorMap&&n._updateErrorMap(e.errorMap),n._initializeWithPersistence(r,e==null?void 0:e.popupRedirectResolver)}function Jp(n,e,t){const r=nr(n);J(r._canInitEmulator,r,"emulator-config-failed"),J(/^https?:\/\//.test(e),r,"invalid-emulator-scheme");const s=!1,o=Zc(e),{host:a,port:u}=Qp(e),h=u===null?"":`:${u}`;r.config.emulator={url:`${o}//${a}${h}/`},r.settings.appVerificationDisabledForTesting=!0,r.emulatorConfig=Object.freeze({host:a,port:u,protocol:o.replace(":",""),options:Object.freeze({disableWarnings:s})}),Yp()}function Zc(n){const e=n.indexOf(":");return e<0?"":n.substr(0,e+1)}function Qp(n){const e=Zc(n),t=/(\/\/)?([^?#/]+)/.exec(n.substr(e.length));if(!t)return{host:"",port:null};const r=t[2].split("@").pop()||"",s=/^(\[[^\]]+\])(:|$)/.exec(r);if(s){const o=s[1];return{host:o,port:vl(r.substr(o.length+1))}}else{const[o,a]=r.split(":");return{host:o,port:vl(a)}}}function vl(n){if(!n)return null;const e=Number(n);return isNaN(e)?null:e}function Yp(){function n(){const e=document.createElement("p"),t=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",t.position="fixed",t.width="100%",t.backgroundColor="#ffffff",t.border=".1em solid #000000",t.color="#b50000",t.bottom="0px",t.left="0px",t.margin="0px",t.zIndex="10000",t.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}typeof console<"u"&&typeof console.info=="function"&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials."),typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?window.addEventListener("DOMContentLoaded",n):n())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Gr{constructor(e){this._byteString=e}static fromBase64String(e){try{return new Gr(kt.fromBase64String(e))}catch(t){throw new Q(D.INVALID_ARGUMENT,"Failed to construct data from Base64 string: "+t)}}static fromUint8Array(e){return new Gr(kt.fromUint8Array(e))}toBase64(){return this._byteString.toBase64()}toUint8Array(){return this._byteString.toUint8Array()}toString(){return"Bytes(base64: "+this.toBase64()+")"}isEqual(e){return this._byteString.isEqual(e._byteString)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class oh{constructor(...e){for(let t=0;t<e.length;++t)if(e[t].length===0)throw new Q(D.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new He(e)}isEqual(e){return this._internalPath.isEqual(e._internalPath)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`),!1}},[S]);x.useEffect(()=>{pn.current={reinitializeCamera:hr}},[hr]),x.useEffect(()=>{if(!de)return;const R=setInterval(()=>{_($=>$+1)},1e3);return()=>clearInterval(R)},[de]),x.useEffect(()=>{U&&S&&console.log("🎬 [PARTNER FOUND] Transitioning to video chat screen")},[U,S]);const ss=async()=>{var R;try{if(console.log("📹 [START CAMERA] User clicked to start camera"),console.log("📹 [START CAMERA] Checking DOM state..."),console.log("   localVideoRef.current:",!!ae.current),console.log("   localVideoRef.current in DOM:",(R=ae.current)!=null&&R.parentElement?"YES":"NO"),console.log("   All videos in DOM:",document.querySelectorAll("video").length),!ae.current){console.error("📹 [START CAMERA] ❌ Video element not in DOM - cannot proceed");return}console.log("📹 [START CAMERA] Requesting camera from browser...");const $=await navigator.mediaDevices.getUserMedia({video:!0,audio:!1});Zt.current=$,ee.current=$,console.log("📹 [START CAMERA] ✅ Stream obtained:",$),console.log("📹 [START CAMERA] Stream tracks:",$.getTracks().map(M=>({kind:M.kind,enabled:M.enabled,id:M.id}))),ae.current&&(ae.current.srcObject=$,console.log("📹 [START CAMERA] ✅ Stream attached to video element"),ae.current.onloadedmetadata=()=>{console.log("📹 [START CAMERA] ✅ Video metadata loaded, calling play()"),ae.current.play().then(()=>{console.log("📹 [START CAMERA] ✅ Video playing - setting isLocalCameraReady=true"),At(!0)}).catch(M=>{console.warn("📹 [START CAMERA] ⚠️ Play warning (but video loaded):",M.message),At(!0)})})}catch($){console.error("📹 [START CAMERA] ❌ CRITICAL ERROR:",$),console.error("   Error name:",$.name),console.error("   Error message:",$.message),$.name==="NotAllowedError"?console.error("❌ Camera permission DENIED by user - User clicked deny in browser prompt"):$.name==="NotFoundError"?console.error("❌ No camera device found - Check if device has a camera"):$.name==="NotReadableError"?console.error("❌ Camera is already in use by another app - Close other apps using camera"):$.name==="SecurityError"&&console.error("❌ Camera access blocked by security policy - Must use HTTPS")}};x.useEffect(()=>()=>{console.log("📹 [DASHBOARD CLEANUP] Component unmounting"),console.log("📹 [DASHBOARD CLEANUP] ⚠️ NOT stopping camera - will be reused on return")},[]),x.useEffect(()=>{console.log("📹 [CAMERA INIT] Starting camera initialization on mount");let R=!0;return(async()=>{try{if(ee.current)console.log("📹 [CAMERA INIT] Stream already exists - reusing existing stream");else{console.log("📹 [CAMERA INIT] Requesting camera permissions from browser...");const V=await navigator.mediaDevices.getUserMedia({video:{width:{ideal:1280},height:{ideal:720}},audio:!0});if(!R){console.log("📹 [CAMERA INIT] Component unmounted, cleaning up stream"),V.getTracks().forEach(le=>le.stop());return}ee.current=V,Zt.current=V,console.log("📹 [CAMERA INIT] ✅ Camera stream obtained"),console.log("📹 [CAMERA INIT] Active tracks:",V.getTracks().map(le=>({kind:le.kind,enabled:le.enabled})))}if(await new Promise(V=>setTimeout(V,0)),!R)return;let M=0;const X=()=>{Le&&ee.current?(console.log("📹 [CAMERA INIT] Attaching stream to video element..."),Le.srcObject=ee.current,Le.muted=!0,console.log("📹 [CAMERA INIT] Calling play() on video element"),Le.play().then(()=>{R&&(console.log("📹 [CAMERA INIT] ✅ Video stream is now playing"),k(!0),At(!0))}).catch(V=>{R&&(console.warn("📹 [CAMERA INIT] ⚠️ Play error (stream may still display):",V.name,V.message),k(!0),At(!0))})):M<50?(M++,setTimeout(X,50)):(console.error("📹 [CAMERA INIT] ❌ Video ref never became available"),console.error("   sharedVideoRef:",!!Le),console.error("   localStreamRef.current:",!!ee.current),At(!0))};X()}catch(M){R&&(console.error("📹 [CAMERA INIT] ❌ Error:",M.name,M.message),M.name==="NotAllowedError"?console.error("   → User denied camera permission"):M.name==="NotFoundError"?console.error("   → No camera device found"):M.name==="NotReadableError"&&console.error("   → Camera is in use by another app"),At(!0))}})(),()=>{R=!1}},[]),x.useEffect(()=>{const R=setInterval(()=>{Le&&Le.paused&&Le.srcObject&&(console.warn("📹 [RESUME CHECK] Video was paused! Resuming..."),Le.play().catch($=>console.warn("📹 [RESUME CHECK] Resume error:",$.message)))},500);return()=>clearInterval(R)},[]),x.useEffect(()=>{const $=setInterval(()=>{try{if(!Le||!ee.current)return;const M=ee.current.getTracks(),X=M.find(V=>V.kind==="video");X&&!X.enabled&&(X.enabled=!0),!Le.srcObject&&ee.current&&M.length>0&&(Le.srcObject=ee.current,Le.muted=!0)}catch{}},5e3);return()=>clearInterval($)},[]),x.useEffect(()=>{const R=setInterval(()=>{try{Le&&Le.srcObject&&Le.paused&&Le.play().catch(()=>{})}catch{}},5e3);return()=>clearInterval(R)},[]);const en=async()=>{if(console.log("🔧 createPeerConnection called"),console.log("   Current localStreamRef:",ee.current),!ee.current){console.warn("⚠️ CRITICAL: localStreamRef.current is null - attempting to reacquire camera stream");try{const X=await navigator.mediaDevices.getUserMedia({video:{width:{ideal:640},height:{ideal:480}},audio:!0});if(ee.current=X,ae.current){ae.current.srcObject=X,ae.current.muted=!0;try{await ae.current.play()}catch(V){console.warn("⚠️ Play error during reacquisition:",V)}}console.log("✅ LOCAL STREAM RE-ACQUIRED SUCCESSFULLY"),console.log("   Tracks:",X.getTracks().map(V=>({kind:V.kind,id:V.id})))}catch(X){throw console.error("❌ FATAL: Could not reacquire camera stream:",X.message),new Error("Cannot proceed: local camera stream unavailable - "+X.message)}}AI();const R=await dr(),$=[{urls:["stun:global.xirsys.net","turn:global.xirsys.net:3478?transport=udp","turn:global.xirsys.net:3478?transport=tcp"],username:"nkhlvdv",credential:"a8e244b8-cf5b-11f0-8771-0242ac140002"},...R];console.log("🔧 ICE Servers Configuration:",{count:$.length,servers:$.map(X=>({urls:X.urls,username:X.username?"***":void 0,credential:X.credential?"***":void 0}))});const M=new RTCPeerConnection({iceServers:$,iceTransportPolicy:"all"});if(z.current=M,console.log("✅ RTCPeerConnection created with iceTransportPolicy: all"),M.onicecandidate=X=>{if(X.candidate){const V=X.candidate;console.log("🧊 ICE candidate generated:",{candidate:V.candidate,protocol:V.protocol,port:V.port,address:V.address,type:V.type,priority:V.priority,sdpMLineIndex:V.sdpMLineIndex,sdpMId:V.sdpMid}),V.type==="relay"?(console.log("🔄 RELAY (TURN) candidate generated - TURN server is reachable"),console.log("   Protocol:",V.protocol,"Port:",V.port)):V.type==="srflx"?(console.log("📍 SRFLX (server reflexive) candidate - STUN working"),console.log("   Found public address via STUN")):V.type==="host"&&console.log("🏠 HOST candidate - direct LAN connection possible"),console.log("🔌 Sending ICE candidate to partner socket:",it.current),K.emit("ice_candidate",{candidate:V,to:it.current}),console.log("📤 ICE candidate sent to peer")}else console.log("🧊 ICE gathering complete (null candidate received)"),console.log("📊 ICE gathering summary:"),console.log("   Connection State:",M.connectionState),console.log("   ICE Connection State:",M.iceConnectionState),console.log("   ICE Gathering State:",M.iceGatheringState)},M.oniceconnectionstatechange=()=>{const X=M.iceConnectionState;switch(console.log(`
🧊 ===== ICE CONNECTION STATE CHANGED =====`),console.log("🧊 New ICE Connection State:",X),X){case"new":console.log("🧊 State: NEW - Gathering ICE candidates");break;case"checking":console.log("🧊 State: CHECKING - Testing ICE candidate pairs"),console.log("🧊 Connection in progress - waiting for connectivity");break;case"connected":console.log("✅ State: CONNECTED - Found working ICE candidate pair"),console.log("🧊 Peer-to-peer communication established");break;case"completed":console.log("✅ State: COMPLETED - ICE checks completed, ready for media"),console.log("🧊 All connectivity checks passed");break;case"failed":console.error("❌ State: FAILED - All ICE candidate pairs failed"),console.error("❌ Could not establish peer-to-peer connection"),console.error("❌ TURN server may be unreachable or blocked by ISP"),console.error("🔍 Troubleshooting:"),console.error("   - Check console for TURN error details"),console.error("   - TURN error 701 = Network/ISP blocking ports 3478, 5349"),console.error("   - Solutions: Try VPN, different WiFi, or mobile hotspot"),console.error("   - User can retry with a retry button (do NOT auto-restart ICE)");break;case"disconnected":console.warn("⚠️ State: DISCONNECTED - Lost connection to peer"),console.warn("   Note: ICE restart is manual only to prevent stream loss");break;case"closed":console.log("🛑 State: CLOSED - Connection closed");break}console.log("📊 Full connection states:"),console.log("   Signaling State:",M.signalingState),console.log("   Connection State:",M.connectionState),console.log("   ICE Gathering State:",M.iceGatheringState)},z.current._remoteStream||(z.current._remoteStream=new MediaStream,console.log("✅ PERSISTENT REMOTE STREAM CREATED - will accumulate all incoming tracks")),M.ontrack=X=>{console.log(`

🔴🔴🔴 ===== CRITICAL: ONTRACK HANDLER FIRING! =====`),console.log("🔴 ONTRACK CALLED AT:",new Date().toISOString()),console.log("🔴 Track received:",{kind:X.track.kind,id:X.track.id,enabled:X.track.enabled});const V=z.current._remoteStream;if(console.log("🔴 Using persistent remote stream ID:",V.id),V.addTrack(X.track),console.log("✅ Track added to persistent remote stream"),console.log("📥 Remote stream now has",V.getTracks().length,"track(s)"),console.log("📥 Tracks:",V.getTracks().map(le=>({kind:le.kind,id:le.id,enabled:le.enabled}))),!ct.current){console.error("❌ CRITICAL ERROR: remoteVideoRef.current is NULL!"),console.error("   Cannot attach remote track - video element not available");return}ct.current.srcObject!==V?(console.log("📺 ATTACHING PERSISTENT STREAM to remoteVideoRef"),ct.current.srcObject=V,ct.current.muted=!1,console.log("📺 srcObject attached, attempting play()..."),ct.current.play().catch(()=>{console.log("ℹ️ Autoplay blocked - will play on user interaction")})):(console.log("📺 STREAM ALREADY ATTACHED - skipping re-attachment"),console.log("   Stream has",V.getTracks().length,"tracks now")),console.log(`✅ ✅ ✅ ONTRACK COMPLETE - Remote stream persisted and attached
...
`),it.current=R.socketId,console.log("🔌 CRITICAL: Stored partner socket ID:",it.current),console.log("🔌 CRITICAL: Verification - partnerSocketIdRef.current is now:",it.current),console.log("🎬 ABOUT TO CALL setHasPartner(true)"),B(!0),console.log("🎬 ✅ setHasPartner(true) CALLED - force attach effect should trigger");const X={...R,picture:R.userPicture||R.picture||null,userName:R.userName||R.name||"Anonymous",userLocation:R.userLocation||R.location||"Unknown",userAge:R.userAge||R.age||18};m(X),console.log("🎬 ✅ setPartnerInfo CALLED with data:",X);const V=K.id,le=R.socketId,pe=V<le;if(console.log("🔍 SOCKET ID COMPARISON:"),console.log("   My socket ID:",V),console.log("   Partner socket ID:",le),console.log("   Am I offerer? (myID < partnerID):",pe),console.log(`
...
✅ ANSWERER: Track addition complete (${pe} succeeded, ${ke} failed)`);const qe=z.current.getSenders();console.log("📤 ANSWERER: Final senders count:",qe.length),console.log("📤 ANSWERER: Senders:",qe.map((be,Pe)=>{var fe,ut,ot;return{index:Pe,kind:(fe=be.track)==null?void 0:fe.kind,id:(ut=be.track)==null?void 0:ut.id,trackExists:!!be.track,trackEnabled:(ot=be.track)==null?void 0:ot.enabled}}))}}else throw console.error(`
...
//# sourceMappingURL=index-DX0_IAse.js.map
