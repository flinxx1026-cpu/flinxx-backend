import{r as A,a as Td,R as Zs,u as ot,b as Ad,c as mc,B as Cd,d as Sd,e as ht}from"./vendor-CWYb8WqM.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))r(s);new MutationObserver(s=>{for(const o of s)if(o.type==="childList")for(const a of o.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&r(a)}).observe(document,{childList:!0,subtree:!0});function t(s){const o={};return s.integrity&&(o.integrity=s.integrity),s.referrerPolicy&&(o.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?o.credentials="include":s.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function r(s){if(s.ep)return;s.ep=!0;const o=t(s);fetch(s.href,o)}})();var yc={exports:{}},ei={};/**
 * @license React
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Eu(n){if(n.code!==L.FAILED_PRECONDITION||n.message!==Om)throw n;q("LocalStore","Unexpectedly lost primary lease")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Jy{constructor(){this.Gi=!1,this.zi=!1,this.ji=100,this.Hi=function(){return Zd()?8:Dm(Qe())>0?6:4}()}initialize(e,t){this.Ji=e,this.indexManager=t,this.Gi=!0}getDocumentsMatchingQuery(e,t,r,s){const o={result:null};return this.Yi(e,t).next(a=>{o.result=a}).next(()=>{if(!o.result)return this.Zi(e,t,s,r).next(a=>{o.result=a})}).next(()=>{if(o.result)return;const a=new Qy;return this.Xi(e,t,a).next(u=>{if(o.result=u,this.zi)return this.es(e,t,a,u.size)})}).next(()=>o.result)}es(e,t,r,s){return r.documentReadCount<this.ji?(gr()<=ie.DEBUG&&q("QueryEngine","SDK will not create cache indexes for query:",mr(t),"since it only creates cache indexes for collection contains","more than or equal to",this.ji,"documents"),j.resolve()):(gr()<=ie.DEBUG&&q("QueryEngine","Query:",mr(t),"scans",r.documentReadCount,"local documents and returns",s,"documents as results."),r.documentReadCount>this.Hi*s?(gr()<=ie.DEBUG&&q("QueryEngine","The SDK decides to create cache indexes for query:",mr(t),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(e,vn(t))):j.resolve())}Yi(e,t){if(Ll(t))return j.resolve(null);let r=vn(t);return this.indexManager.getIndexType(e,r).next(s=>s===0?null:(t.limit!==null&&s===1&&(t=ho(t,null,"F"),r=vn(t)),this.indexManager.getDocumentsMatchingTarget(e,r).next(o=>{const a=ze(...o);return this.Ji.getDocuments(e,a).next(u=>this.indexManager.getMinOffset(e,r).next(h=>{const f=this.ts(t,u);return this.ns(t,f,a,h.readTime)?this.Yi(e,ho(t,null,"F")):this.rs(e,f,t,h)}))})))}Zi(e,t,r,s){return Ll(t)||s.isEqual(we.min())?j.resolve(null):this.Ji.getDocuments(e,r).next(o=>{const a=this.ts(t,o);return this.ns(t,a,r,s)?j.resolve(null):(gr()<=ie.DEBUG&&q("QueryEngine","Re-using previous result from %s to execute query: %s",s.toString(),mr(t)),this.rs(e,a,t,Nm(s,-1)).next(u=>u))})}ts(e,t){let r=new Ke(ny(e));return t.forEach((s,o)=>{Ho(e,o)&&(r=r.add(o))}),r}ns(e,t,r,s){if(e.limit===null)return!1;if(r.size!==t.size)return!0;const o=e.limitType==="F"?t.last():t.first();return!!o&&(o.hasPendingWrites||o.version.compareTo(s)>0)}Xi(e,t,r){return gr()<=ie.DEBUG&&q("QueryEngine","Using full collection scan to execute query:",mr(t)),this.Ji.getDocumentsMatchingQuery(e,t,en.min(),r)}rs(e,t,r,s){return this.Ji.getDocumentsMatchingQuery(e,r,s).next(o=>(t.forEach(a=>{o=o.insert(a.key,a)}),o))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Gl{constructor(){this.ao=()=>this.uo(),this.co=()=>this.lo(),this.ho=[],this.Po()}_o(e){this.ho.push(e)}shutdown(){window.removeEventListener("online",this.ao),window.removeEventListener("offline",this.co)}Po(){window.addEventListener("online",this.ao),window.addEventListener("offline",this.co)}uo(){q("ConnectivityMonitor","Network connectivity changed: AVAILABLE");for(const e of this.ho)e(0)}lo(){q("ConnectivityMonitor","Network connectivity changed: UNAVAILABLE");for(const e of this.ho)e(1)}static D(){return typeof window<"u"&&window.addEventListener!==void 0&&window.removeEventListener!==void 0}}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const He="WebChannelConnection";class ov extends class{constructor(t){this.databaseInfo=t,this.databaseId=t.databaseId;const r=t.ssl?"https":"http",s=encodeURIComponent(this.databaseId.projectId),o=encodeURIComponent(this.databaseId.database);this.Do=r+"://"+t.host,this.vo=`projects/${s}/databases/${o}`,this.Co=this.databaseId.database==="(default)"?`project_id=${s}`:`project_id=${s}&database_id=${o}`}get Fo(){return!1}Mo(t,r,s,o,a){const u=$i(),h=this.xo(t,r.toUriEncodedString());q("RestConnection",`Sending RPC '${t}' ${u}:`,h,s);const f={"google-cloud-resource-prefix":this.vo,"x-goog-request-params":this.Co};return this.Oo(f,o,a),this.No(t,h,f,s).then(y=>(q("RestConnection",`Received RPC '${t}' ${u}: `,y),y),y=>{throw Fs("RestConnection",`RPC '${t}' ${u} failed with error: `,y,"url: ",h,"request:",s),y})}Lo(t,r,s,o,a,u){return this.Mo(t,r,s,o,a)}Oo(t,r,s){t["X-Goog-Api-Client"]=function(){return"gl-js/ fire/"+Yn}(),t["Content-Type"]="text/plain",this.databaseInfo.appId&&(t["X-Firebase-GMPID"]=this.databaseInfo.appId),r&&r.headers.forEach((o,a)=>t[a]=o),s&&s.headers.forEach((o,a)=>t[a]=o)}xo(t,r){const s=sv[t];return`${this.Do}/v1/${r}:${s}`}terminate(){}}{constructor(e){super(e),this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}No(e,t,r,s){const o=$i();return new Promise((a,u)=>{const h=new gu;h.setWithCredentials(!0),h.listenOnce(mu.COMPLETE,()=>{try{switch(h.getLastErrorCode()){case xs.NO_ERROR:const y=h.getResponseJson();q(He,`XHR for RPC '${e}' ${o} received:`,JSON.stringify(y)),a(y);break;case xs.TIMEOUT:q(He,`RPC '${e}' ${o} timed out`),u(new Y(L.DEADLINE_EXCEEDED,"Request time out"));break;case xs.HTTP_ERROR:const b=h.getStatus();if(q(He,`RPC '${e}' ${o} failed with status:`,b,"response text:",h.getResponseText()),b>0){let x=h.getResponseJson();Array.isArray(x)&&(x=x[0]);const C=x==null?void 0:x.error;if(C&&C.status&&C.message){const k=function(N){const U=N.toLowerCase().replace(/_/g,"-");return Object.values(L).indexOf(U)>=0?U:L.UNKNOWN}(C.status);u(new Y(k,C.message))}else u(new Y(L.UNKNOWN,"Server responded with status "+h.getStatus()))}else u(new Y(L.UNAVAILABLE,"Connection failed."));break;default:oe()}}finally{q(He,`RPC '${e}' ${o} completed.`)}});const f=JSON.stringify(s);q(He,`RPC '${e}' ${o} sending request:`,s),h.send(t,"POST",f,r,15)})}Bo(e,t,r){const s=$i(),o=[this.Do,"/","google.firestore.v1.Firestore","/",e,"/channel"],a=_u(),u=vu(),h={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},f=this.longPollingOptions.timeoutSeconds;f!==void 0&&(h.longPollingTimeout=Math.round(1e3*f)),this.useFetchStreams&&(h.useFetchStreams=!0),this.Oo(h.initMessageHeaders,t,r),h.encodeInitMessageHeaders=!0;const y=o.join("");q(He,`Creating RPC '${e}' stream ${s}: ${y}`,h);const b=a.createWebChannel(y,h);let x=!1,C=!1;const k=new iv({Io:N=>{C?q(He,`Not sending because RPC '${e}' stream ${s} is closed:`,N):(x||(q(He,`Opening RPC '${e}' stream ${s} transport.`),b.open(),x=!0),q(He,`RPC '${e}' stream ${s} sending:`,N),b.send(N))},To:()=>b.close()}),S=(N,U,$)=>{N.listen(U,D=>{try{$(D)}catch(H){setTimeout(()=>{throw H},0)}})};return S(b,vr.EventType.OPEN,()=>{C||(q(He,`RPC '${e}' stream ${s} transport opened.`),k.yo())}),S(b,vr.EventType.CLOSE,()=>{C||(C=!0,q(He,`RPC '${e}' stream ${s} transport closed`),k.So())}),S(b,vr.EventType.ERROR,N=>{C||(C=!0,Fs(He,`RPC '${e}' stream ${s} transport errored:`,N),k.So(new Y(L.UNAVAILABLE,"The operation could not be completed")))}),S(b,vr.EventType.MESSAGE,N=>{var U;if(!C){const $=N.data[0];be(!!$);const D=$,H=D.error||((U=D[0])===null||U===void 0?void 0:U.error);if(H){q(He,`RPC '${e}' stream ${s} received error:`,H);const ue=H.status;let V=function(m){const v=Ce[m];if(v!==void 0)return wy(v)}(ue),I=H.message;V===void 0&&(V=L.INTERNAL,I="Unknown error status: "+ue+" with message "+H.message),C=!0,k.So(new Y(V,I)),b.close()}else q(He,`RPC '${e}' stream ${s} received:`,$),k.bo($)}}),S(u,yu.STAT_EVENT,N=>{N.stat===ao.PROXY?q(He,`RPC '${e}' stream ${s} detected buffering proxy`):N.stat===ao.NOPROXY&&q(He,`RPC '${e}' stream ${s} detected no buffering proxy`)}),setTimeout(()=>{k.wo()},0),k}}function Gi(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Cv{constructor(e,t,r,s,o){this.authCredentials=e,this.appCheckCredentials=t,this.asyncQueue=r,this.databaseInfo=s,this.user=We.UNAUTHENTICATED,this.clientId=Iu.newId(),this.authCredentialListener=()=>Promise.resolve(),this.appCheckCredentialListener=()=>Promise.resolve(),this._uninitializedComponentsProvider=o,this.authCredentials.start(r,async a=>{q("FirestoreClient","Received user=",a.uid),await this.authCredentialListener(a),this.user=a}),this.appCheckCredentials.start(r,a=>(q("FirestoreClient","Received new app check token=",a),this.appCheckCredentialListener(a,this.user)))}get configuration(){return{asyncQueue:this.asyncQueue,databaseInfo:this.databaseInfo,clientId:this.clientId,authCredentials:this.authCredentials,appCheckCredentials:this.appCheckCredentials,initialUser:this.user,maxConcurrentLimboResolutions:100}}setCredentialChangeListener(e){this.authCredentialListener=e}setAppCheckTokenChangeListener(e){this.appCheckCredentialListener=e}terminate(){this.asyncQueue.enterRestrictedMode();const e=new yn;return this.asyncQueue.enqueueAndForgetEvenWhileRestricted(async()=>{try{this._onlineComponents&&await this._onlineComponents.terminate(),this._offlineComponents&&await this._offlineComponents.terminate(),this.authCredentials.shutdown(),this.appCheckCredentials.shutdown(),e.resolve()}catch(t){const r=eh(t,"Failed to shutdown persistence");e.reject(r)}}),e.promise}}async function qi(n,e){n.asyncQueue.verifyOperationInProgress(),q("FirestoreClient","Initializing OfflineComponentProvider");const t=n.configuration;await e.initialize(t);let r=t.initialUser;n.setCredentialChangeListener(async s=>{r.isEqual(s)||(await Ku(e.localStore,s),r=s)}),e.persistence.setDatabaseDeletedListener(()=>n.terminate()),n._offlineComponents=e}async function Ql(n,e){n.asyncQueue.verifyOperationInProgress();const t=await Sv(n);q("FirestoreClient","Initializing OnlineComponentProvider"),await e.initialize(t,n.configuration),n.setCredentialChangeListener(r=>ql(e.remoteStore,r)),n.setAppCheckTokenChangeListener((r,s)=>ql(e.remoteStore,s)),n._onlineComponents=e}async function Sv(n){if(!n._offlineComponents)if(n._uninitializedComponentsProvider){q("FirestoreClient","Using user provided OfflineComponentProvider");try{await qi(n,n._uninitializedComponentsProvider._offline)}catch(e){const t=e;if(!function(s){return s.name==="FirebaseError"?s.code===L.FAILED_PRECONDITION||s.code===L.UNIMPLEMENTED:!(typeof DOMException<"u"&&s instanceof DOMException)||s.code===22||s.code===20||s.code===11}(t))throw t;Fs("Error using user provided cache. Falling back to memory cache: "+t),await qi(n,new Ks)}}else q("FirestoreClient","Using default OfflineComponentProvider"),await qi(n,new Ks);return n._offlineComponents}async function Rv(n){return n._onlineComponents||(n._uninitializedComponentsProvider?(q("FirestoreClient","Using user provided OnlineComponentProvider"),await Ql(n,n._uninitializedComponentsProvider._online)):(q("FirestoreClient","Using default OnlineComponentProvider"),await Ql(n,new mo))),n._onlineComponents}function Nv(n){return Rv(n).then(e=>e.syncEngine)}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Xl{constructor(e){var t,r;if(e.host===void 0){if(e.ssl!==void 0)throw new Y(L.INVALID_ARGUMENT,"Can't provide ssl option if host option is not set");this.host="firestore.googleapis.com",this.ssl=!0}else this.host=e.host,this.ssl=(t=e.ssl)===null||t===void 0||t;if(this.credentials=e.credentials,this.ignoreUndefinedProperties=!!e.ignoreUndefinedProperties,this.localCache=e.localCache,e.cacheSizeBytes===void 0)this.cacheSizeBytes=41943040;else{if(e.cacheSizeBytes!==-1&&e.cacheSizeBytes<1048576)throw new Y(L.INVALID_ARGUMENT,"cacheSizeBytes must be at least 1048576");this.cacheSizeBytes=e.cacheSizeBytes}Pv("experimentalForceLongPolling",e.experimentalForceLongPolling,"experimentalAutoDetectLongPolling",e.experimentalAutoDetectLongPolling),this.experimentalForceLongPolling=!!e.experimentalForceLongPolling,this.experimentalForceLongPolling?this.experimentalAutoDetectLongPolling=!1:e.experimentalAutoDetectLongPolling===void 0?this.experimentalAutoDetectLongPolling=!0:this.experimentalAutoDetectLongPolling=!!e.experimentalAutoDetectLongPolling,this.experimentalLongPollingOptions=rh((r=e.experimentalLongPollingOptions)!==null&&r!==void 0?r:{}),function(o){if(o.timeoutSeconds!==void 0){if(isNaN(o.timeoutSeconds))throw new Y(L.INVALID_ARGUMENT,`invalid long polling timeout: ${o.timeoutSeconds} (must not be NaN)`);if(o.timeoutSeconds<5)throw new Y(L.INVALID_ARGUMENT,`invalid long polling timeout: ${o.timeoutSeconds} (minimum allowed value is 5)`);if(o.timeoutSeconds>30)throw new Y(L.INVALID_ARGUMENT,`invalid long polling timeout: ${o.timeoutSeconds} (maximum allowed value is 30)`)}}(this.experimentalLongPollingOptions),this.useFetchStreams=!!e.useFetchStreams}isEqual(e){return this.host===e.host&&this.ssl===e.ssl&&this.credentials===e.credentials&&this.cacheSizeBytes===e.cacheSizeBytes&&this.experimentalForceLongPolling===e.experimentalForceLongPolling&&this.experimentalAutoDetectLongPolling===e.experimentalAutoDetectLongPolling&&function(r,s){return r.timeoutSeconds===s.timeoutSeconds}(this.experimentalLongPollingOptions,e.experimentalLongPollingOptions)&&this.ignoreUndefinedProperties===e.ignoreUndefinedProperties&&this.useFetchStreams===e.useFetchStreams}}class Zo{constructor(e,t,r,s){this._authCredentials=e,this._appCheckCredentials=t,this._databaseId=r,this._app=s,this.type="firestore-lite",this._persistenceKey="(lite)",this._settings=new Xl({}),this._settingsFrozen=!1,this._terminateTask="notTerminated"}get app(){if(!this._app)throw new Y(L.FAILED_PRECONDITION,"Firestore was not initialized using the Firebase SDK. 'app' is not available");return this._app}get _initialized(){return this._settingsFrozen}get _terminated(){return this._terminateTask!=="notTerminated"}_setSettings(e){if(this._settingsFrozen)throw new Y(L.FAILED_PRECONDITION,"Firestore has already been started and its settings can no longer be changed. You can only modify settings before calling any other methods on a Firestore object.");this._settings=new Xl(e),e.credentials!==void 0&&(this._authCredentials=function(r){if(!r)return new Im;switch(r.type){case"firstParty":return new Tm(r.sessionIndex||"0",r.iamToken||null,r.authTokenFactory||null);case"provider":return r.client;default:throw new Y(L.INVALID_ARGUMENT,"makeAuthCredentialsProvider failed due to invalid credential type")}}(e.credentials))}_getSettings(){return this._settings}_freezeSettings(){return this._settingsFrozen=!0,this._settings}_delete(){return this._terminateTask==="notTerminated"&&(this._terminateTask=this._terminate()),this._terminateTask}async _restart(){this._terminateTask==="notTerminated"?await this._terminate():this._terminateTask="notTerminated"}toJSON(){return{app:this._app,databaseId:this._databaseId,settings:this._settings}}_terminate(){return function(t){const r=Jl.get(t);r&&(q("ComponentProvider","Removing Datastore"),Jl.delete(t),r.terminate())}(this),Promise.resolve()}}function Ov(n,e,t,r={}){var s;const o=(n=yo(n,Zo))._getSettings(),a=`${e}:${t}`;if(o.host!=="firestore.googleapis.com"&&o.host!==a&&Fs("Host has been set in both settings() and connectFirestoreEmulator(), emulator host will be used."),n._setSettings(Object.assign(Object.assign({},o),{host:a,ssl:!1})),r.mockUserToken){let u,h;if(typeof r.mockUserToken=="string")u=r.mockUserToken,h=We.MOCK_USER;else{u=zd(r.mockUserToken,(s=n._app)===null||s===void 0?void 0:s.options.projectId);const f=r.mockUserToken.sub||r.mockUserToken.user_id;if(!f)throw new Y(L.INVALID_ARGUMENT,"mockUserToken must contain 'sub' or 'user_id' field!");h=new We(f)}n._authCredentials=new Em(new wu(u,h))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Dr{constructor(e){this._byteString=e}static fromBase64String(e){try{return new Dr(Tt.fromBase64String(e))}catch(t){throw new Y(L.INVALID_ARGUMENT,"Failed to construct data from Base64 string: "+t)}}static fromUint8Array(e){return new Dr(Tt.fromUint8Array(e))}toBase64(){return this._byteString.toBase64()}toUint8Array(){return this._byteString.toUint8Array()}toString(){return"Bytes(base64: "+this.toBase64()+")"}isEqual(e){return this._byteString.isEqual(e._byteString)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ih{constructor(...e){for(let t=0;t<e.length;++t)if(e[t].length===0)throw new Y(L.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new Be(e)}isEqual(e){return this._internalPath.isEqual(e._internalPath)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ah{constructor(e,t){if(!isFinite(e)||e<-90||e>90)throw new Y(L.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+e);if(!isFinite(t)||t<-180||t>180)throw new Y(L.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+t);this._lat=e,this._long=t}get latitude(){return this._lat}get longitude(){return this._long}isEqual(e){return this._lat===e._lat&&this._long===e._long}toJSON(){return{latitude:this._lat,longitude:this._long}}_compareTo(e){return fe(this._lat,e._lat)||fe(this._long,e._long)}}/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`),!1}},[S]);A.useEffect(()=>{Qr.current={reinitializeCamera:nr}},[nr]),A.useEffect(()=>{if(!ue)return;const P=setInterval(()=>{v(B=>B+1)},1e3);return()=>clearInterval(P)},[ue]),A.useEffect(()=>{D&&S&&console.log("🎬 [PARTNER FOUND] Transitioning to video chat screen")},[D,S]);const Yr=async()=>{var P;try{if(console.log("📹 [START CAMERA] User clicked to start camera"),console.log("📹 [START CAMERA] Checking DOM state..."),console.log("   localVideoRef.current:",!!Q.current),console.log("   localVideoRef.current in DOM:",(P=Q.current)!=null&&P.parentElement?"YES":"NO"),console.log("   All videos in DOM:",document.querySelectorAll("video").length),!Q.current){console.error("📹 [START CAMERA] ❌ Video element not in DOM - cannot proceed");return}console.log("📹 [START CAMERA] Requesting camera from browser...");const B=await navigator.mediaDevices.getUserMedia({video:!0,audio:!1});Ie.current=B,ee.current=B,console.log("📹 [START CAMERA] ✅ Stream obtained:",B),console.log("📹 [START CAMERA] Stream tracks:",B.getTracks().map(M=>({kind:M.kind,enabled:M.enabled,id:M.id}))),Q.current&&(Q.current.srcObject=B,console.log("📹 [START CAMERA] ✅ Stream attached to video element"),Q.current.onloadedmetadata=()=>{console.log("📹 [START CAMERA] ✅ Video metadata loaded, calling play()"),Q.current.play().then(()=>{console.log("📹 [START CAMERA] ✅ Video playing - setting isLocalCameraReady=true"),ct(!0)}).catch(M=>{console.warn("📹 [START CAMERA] ⚠️ Play warning (but video loaded):",M.message),ct(!0)})})}catch(B){console.error("📹 [START CAMERA] ❌ CRITICAL ERROR:",B),console.error("   Error name:",B.name),console.error("   Error message:",B.message),B.name==="NotAllowedError"?console.error("❌ Camera permission DENIED by user - User clicked deny in browser prompt"):B.name==="NotFoundError"?console.error("❌ No camera device found - Check if device has a camera"):B.name==="NotReadableError"?console.error("❌ Camera is already in use by another app - Close other apps using camera"):B.name==="SecurityError"&&console.error("❌ Camera access blocked by security policy - Must use HTTPS")}};A.useEffect(()=>()=>{console.log("📹 [CLEANUP] Component unmounting - stopping camera"),Ie.current&&(Ie.current.getTracks().forEach(P=>{console.log("📹 [CLEANUP] Stopping track:",P.kind),P.stop()}),Ie.current=null)},[]),A.useEffect(()=>{if(console.log("[Camera] ⏳ Auto-start useEffect triggered, shouldStartAsIntro:",C),C){console.log("[Camera] ⏭️ Skipping auto camera init - user just completed profile (view=home)"),console.log('[Camera] Camera will start when user clicks "Start Video Chat" button'),console.log("[Camera] User must click button to start camera manually");return}async function P(){try{if(console.log("📹 [AUTO-START] Starting camera preview automatically..."),console.log("📹 [AUTO-START] Chat component mounted, attempting to initialize camera"),!Q.current){console.error("📹 [AUTO-START] ❌ Video element not in DOM yet, cannot initialize camera");return}console.log("📹 [AUTO-START] ✓ Video element found in DOM, requesting camera permissions");const M=await navigator.mediaDevices.getUserMedia({video:{width:{ideal:640},height:{ideal:480}},audio:!0});ee.current=M,Ie.current=M,console.log("📹 [AUTO-START] ✅ Camera stream obtained:",M),console.log("📹 [AUTO-START] Stream tracks:",M.getTracks().map(z=>({kind:z.kind,id:z.id}))),Q.current&&(Q.current.srcObject=M,Q.current.muted=!0,Q.current.onloadedmetadata=()=>{console.log("📹 [AUTO-START] ✅ Video metadata loaded, calling play()"),Q.current.play().then(()=>{console.log("📹 [AUTO-START] ✅ Video playing - setting isLocalCameraReady=true"),N(!0),ct(!0)}).catch(z=>{console.warn("📹 [AUTO-START] ⚠️ Play warning (but video loaded):",z.message),N(!0),ct(!0)})})}catch(M){console.error("📹 [AUTO-START] ❌ Camera error:",M.message),console.error("📹 [AUTO-START] Error name:",M.name),console.error("📹 [AUTO-START] Error code:",M.code),ct(!0)}}console.log("[Camera] Chat component useEffect triggered, scheduling camera init with delay");const B=setTimeout(()=>{console.log("[Camera] Delay complete, now calling startPreview()"),P()},100);return()=>{console.log("[Camera] Chat component unmounting, clearing camera init timer"),clearTimeout(B)}},[C]);const Nn=async()=>{if(console.log("🔧 createPeerConnection called"),console.log("   Current localStreamRef:",ee.current),!ee.current){console.warn("⚠️ CRITICAL: localStreamRef.current is null - attempting to reacquire camera stream");try{const z=await navigator.mediaDevices.getUserMedia({video:{width:{ideal:640},height:{ideal:480}},audio:!0});if(ee.current=z,Q.current){Q.current.srcObject=z,Q.current.muted=!0;try{await Q.current.play()}catch(G){console.warn("⚠️ Play error during reacquisition:",G)}}console.log("✅ LOCAL STREAM RE-ACQUIRED SUCCESSFULLY"),console.log("   Tracks:",z.getTracks().map(G=>({kind:G.kind,id:G.id})))}catch(z){throw console.error("❌ FATAL: Could not reacquire camera stream:",z.message),new Error("Cannot proceed: local camera stream unavailable - "+z.message)}}AI();const P=await bi(),B=[{urls:["stun:global.xirsys.net","turn:global.xirsys.net:3478?transport=udp","turn:global.xirsys.net:3478?transport=tcp"],username:"nkhlvdv",credential:"a8e244b8-cf5b-11f0-8771-0242ac140002"},...P];console.log("🔧 ICE Servers Configuration:",{count:B.length,servers:B.map(z=>({urls:z.urls,username:z.username?"***":void 0,credential:z.credential?"***":void 0}))});const M=new RTCPeerConnection({iceServers:B,iceTransportPolicy:"all"});if(W.current=M,console.log("✅ RTCPeerConnection created with iceTransportPolicy: all"),M.onicecandidate=z=>{if(z.candidate){const G=z.candidate;console.log("🧊 ICE candidate generated:",{candidate:G.candidate,protocol:G.protocol,port:G.port,address:G.address,type:G.type,priority:G.priority,sdpMLineIndex:G.sdpMLineIndex,sdpMId:G.sdpMid}),G.type==="relay"?(console.log("🔄 RELAY (TURN) candidate generated - TURN server is reachable"),console.log("   Protocol:",G.protocol,"Port:",G.port)):G.type==="srflx"?(console.log("📍 SRFLX (server reflexive) candidate - STUN working"),console.log("   Found public address via STUN")):G.type==="host"&&console.log("🏠 HOST candidate - direct LAN connection possible"),console.log("🔌 Sending ICE candidate to partner socket:",pe.current),K.emit("ice_candidate",{candidate:G,to:pe.current}),console.log("📤 ICE candidate sent to peer")}else console.log("🧊 ICE gathering complete (null candidate received)"),console.log("📊 ICE gathering summary:"),console.log("   Connection State:",M.connectionState),console.log("   ICE Connection State:",M.iceConnectionState),console.log("   ICE Gathering State:",M.iceGatheringState)},M.oniceconnectionstatechange=()=>{const z=M.iceConnectionState;switch(console.log(`
🧊 ===== ICE CONNECTION STATE CHANGED =====`),console.log("🧊 New ICE Connection State:",z),z){case"new":console.log("🧊 State: NEW - Gathering ICE candidates");break;case"checking":console.log("🧊 State: CHECKING - Testing ICE candidate pairs"),console.log("🧊 Connection in progress - waiting for connectivity");break;case"connected":console.log("✅ State: CONNECTED - Found working ICE candidate pair"),console.log("🧊 Peer-to-peer communication established");break;case"completed":console.log("✅ State: COMPLETED - ICE checks completed, ready for media"),console.log("🧊 All connectivity checks passed");break;case"failed":console.error("❌ State: FAILED - All ICE candidate pairs failed"),console.error("❌ Could not establish peer-to-peer connection"),console.error("❌ TURN server may be unreachable or blocked by ISP"),console.error("🔍 Troubleshooting:"),console.error("   - Check console for TURN error details"),console.error("   - TURN error 701 = Network/ISP blocking ports 3478, 5349"),console.error("   - Solutions: Try VPN, different WiFi, or mobile hotspot"),console.error("   - User can retry with a retry button (do NOT auto-restart ICE)");break;case"disconnected":console.warn("⚠️ State: DISCONNECTED - Lost connection to peer"),console.warn("   Note: ICE restart is manual only to prevent stream loss");break;case"closed":console.log("🛑 State: CLOSED - Connection closed");break}console.log("📊 Full connection states:"),console.log("   Signaling State:",M.signalingState),console.log("   Connection State:",M.connectionState),console.log("   ICE Gathering State:",M.iceGatheringState)},W.current._remoteStream||(W.current._remoteStream=new MediaStream,console.log("✅ PERSISTENT REMOTE STREAM CREATED - will accumulate all incoming tracks")),M.ontrack=z=>{console.log(`

🔴🔴🔴 ===== CRITICAL: ONTRACK HANDLER FIRING! =====`),console.log("🔴 ONTRACK CALLED AT:",new Date().toISOString()),console.log("🔴 Track received:",{kind:z.track.kind,id:z.track.id,enabled:z.track.enabled});const G=W.current._remoteStream;if(console.log("🔴 Using persistent remote stream ID:",G.id),G.addTrack(z.track),console.log("✅ Track added to persistent remote stream"),console.log("📥 Remote stream now has",G.getTracks().length,"track(s)"),console.log("📥 Tracks:",G.getTracks().map(Z=>({kind:Z.kind,id:Z.id,enabled:Z.enabled}))),!et.current){console.error("❌ CRITICAL ERROR: remoteVideoRef.current is NULL!"),console.error("   Cannot attach remote track - video element not available");return}et.current.srcObject!==G?(console.log("📺 ATTACHING PERSISTENT STREAM to remoteVideoRef"),et.current.srcObject=G,et.current.muted=!1,console.log("📺 srcObject attached, attempting play()..."),et.current.play().catch(()=>{console.log("ℹ️ Autoplay blocked - will play on user interaction")})):(console.log("📺 STREAM ALREADY ATTACHED - skipping re-attachment"),console.log("   Stream has",G.getTracks().length,"tracks now")),console.log(`✅ ✅ ✅ ONTRACK COMPLETE - Remote stream persisted and attached

`)},M.onconnectionstatechange=()=>{console.log(`
🔌 ===== CONNECTION STATE CHANGED =====`),console.log("🔌 New Connection State:",M.connectionState),console.log("   ICE Connection State:",M.iceConnectionState),console.log("   ICE Gathering State:",M.iceGatheringState),console.log("   Signaling State:",M.signalingState),M.connectionState==="connected"?(V(!0),console.log("✅ WebRTC connection ESTABLISHED"),setTimeout(()=>{console.log(`
📊 ===== RECEIVER DEBUG CHECK (after connected) =====`);const z=M.getReceivers();console.log("📊 Total receivers:",z.length),z.forEach((Z,ve)=>{var _e,xe,Te,Pe,le;console.log(`📊 Receiver ${ve}:`,{kind:(_e=Z.track)==null?void 0:_e.kind,enabled:(xe=Z.track)==null?void 0:xe.enabled,readyState:(Te=Z.track)==null?void 0:Te.readyState,id:(Pe=Z.track)==null?void 0:Pe.id,muted:(le=Z.track)==null?void 0:le.muted})}),console.log("📊 Audio and video tracks should be present above");const G=M.getSenders();console.log(`
📊 Total senders:`,G.length),G.forEach((Z,ve)=>{var _e,xe,Te,Pe;console.log(`📊 Sender ${ve}:`,{kind:(_e=Z.track)==null?void 0:_e.kind,enabled:(xe=Z.track)==null?void 0:xe.enabled,readyState:(Te=Z.track)==null?void 0:Te.readyState,id:(Pe=Z.track)==null?void 0:Pe.id})})},1e3)):M.connectionState==="disconnected"?(V(!1),console.log("⚠️ WebRTC connection DISCONNECTED")):M.connectionState==="failed"?(V(!1),console.log("❌ WebRTC connection FAILED")):M.connectionState==="closed"&&(V(!1),console.log("❌ WebRTC connection CLOSED"))},!ee.current)throw console.error("❌ CRITICAL ERROR: localStreamRef.current is null/undefined in createPeerConnection!"),new Error("Local stream lost before createPeerConnection");return M};A.useEffect(()=>(console.log(`
...
👥 SELF-MATCH CHECK - START`);const B=ke.current,M=P.partnerId;if(console.log("👥 COMPARISON VALUES:"),console.log("   myUserId type:",typeof B,"value:",B),console.log("   partnerUserId type:",typeof M,"value:",M),console.log("   Are they EQUAL?",B===M),console.log("   String comparison:",String(B)===String(M)),B===M){console.error(`
❌❌❌ CRITICAL ERROR: SELF-MATCH DETECTED! ❌❌❌`),console.error("   My user ID:",B,"type:",typeof B),console.error("   Partner user ID:",M,"type:",typeof M),console.error("   Match IDs:",B===M),console.error("   These should be DIFFERENT!"),Nt(!0),console.error("   Emitting skip_user..."),K.emit("skip_user",{partnerSocketId:P.socketId}),console.error("   Emitting find_partner..."),K.emit("find_partner",{userId:ke.current,userName:he.name||"Anonymous",userAge:he.age||18,userLocation:he.location||"Unknown"}),console.error("   Returning - match REJECTED");return}console.log("✅ SELF-MATCH CHECK PASSED - partner is different user"),console.log("   Accepting match and proceeding with WebRTC setup"),console.log(`👥 SELF-MATCH CHECK - END
`),pe.current=P.socketId,console.log("🔌 CRITICAL: Stored partner socket ID:",pe.current),console.log("🔌 CRITICAL: Verification - partnerSocketIdRef.current is now:",pe.current),console.log("🎬 ABOUT TO CALL setHasPartner(true)"),H(!0),console.log("🎬 ✅ setHasPartner(true) CALLED - force attach effect should trigger");const z={...P,picture:P.userPicture||P.picture||null,userName:P.userName||P.name||"Anonymous",userLocation:P.userLocation||P.location||"Unknown",userAge:P.userAge||P.age||18};g(z),console.log("🎬 ✅ setPartnerInfo CALLED with data:",z);const G=K.id,Z=P.socketId,ve=G<Z;if(console.log("🔍 SOCKET ID COMPARISON:"),console.log("   My socket ID:",G),console.log("   Partner socket ID:",Z),console.log("   Am I offerer? (myID < partnerID):",ve),console.log(`
...
🔄 ANSWERER: Setting remote description (offer from offerer)`),await W.current.setRemoteDescription(new RTCSessionDescription(P.offer)),console.log("✅ ANSWERER: Remote description set successfully"),console.log("🎬 ANSWERER: Creating answer");const B=await W.current.createAnswer({offerToReceiveVideo:!0,offerToReceiveAudio:!0});console.log("✅ ANSWERER: Answer created with receive constraints"),console.log("📋 ANSWERER SDP CHECK - Looking for a=sendrecv:");const M=B.sdp.split(`
`).filter(G=>G.includes("sendrecv")||G.includes("recvonly")||G.includes("sendonly"));console.log("   Media direction lines:"),M.forEach(G=>console.log("   ",G)),console.log("🔄 ANSWERER: Setting local description (answer)"),await W.current.setLocalDescription(B),console.log("✅ ANSWERER: Local description set successfully"),console.log(`
📋 ===== ANSWERER SENDING ANSWER =====`);const z=W.current.getSenders();console.log("📤 ANSWERER: Final senders count:",z.length),console.log("📤 ANSWERER: Sending answer with tracks:",z.map(G=>{var Z,ve,_e;return{kind:(Z=G.track)==null?void 0:Z.kind,id:(ve=G.track)==null?void 0:ve.id,enabled:(_e=G.track)==null?void 0:_e.enabled}})),console.log("🔌 CRITICAL: Offerer socket ID from offer:",P.from),console.log("🔌 SERVER sending ANSWER to:",P.from),K.emit("webrtc_answer",{answer:W.current.localDescription,to:P.from}),console.log("📤 ANSWERER: Answer emitted to offerer via socket:",P.from),console.log(`📋 ===== ANSWERER ANSWER SENT =====
