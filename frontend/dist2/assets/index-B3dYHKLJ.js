import{r as T,a as Td,R as on,u as dt,b as Ad,c as yc,B as Cd,d as Sd,e as gt}from"./vendor-CWYb8WqM.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))r(s);new MutationObserver(s=>{for(const o of s)if(o.type==="childList")for(const a of o.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&r(a)}).observe(document,{childList:!0,subtree:!0});function t(s){const o={};return s.integrity&&(o.integrity=s.integrity),s.referrerPolicy&&(o.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?o.credentials="include":s.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function r(s){if(s.ep)return;s.ep=!0;const o=t(s);fetch(s.href,o)}})();var vc={exports:{}},oi={};/**
 * @license React
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const tf="FirebaseError";class bt extends Error{constructor(e,t,r){super(t),this.code=e,this.customData=r,this.name=tf,Object.setPrototypeOf(this,bt.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,kn.prototype.create)}}class kn{constructor(e,t,r){this.service=e,this.serviceName=t,this.errors=r}create(e,...t){const r=t[0]||{},s=`${this.service}/${e}`,o=this.errors[e],a=o?nf(o,r):"Error",u=`${this.serviceName}: ${a} (${s}).`;return new bt(s,u,r)}}function nf(n,e){return n.replace(rf,(t,r)=>{const s=e[r];return s!=null?String(s):`<${r}?>`})}const rf=/\{\$([^}]+)}/g;function sf(n){for(const e in n)if(Object.prototype.hasOwnProperty.call(n,e))return!1;return!0}function Or(n,e){if(n===e)return!0;const t=Object.keys(n),r=Object.keys(e);for(const s of t){if(!r.includes(s))return!1;const o=n[s],a=e[s];if(nl(o)&&nl(a)){if(!Or(o,a))return!1}else if(o!==a)return!1}for(const s of r)if(!t.includes(s))return!1;return!0}function nl(n){return n!==null&&typeof n=="object"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Jt=new li("@firebase/app"),jf="@firebase/app-compat",Of="@firebase/analytics-compat",Df="@firebase/analytics",Lf="@firebase/app-check-compat",Mf="@firebase/app-check",Ff="@firebase/auth",Vf="@firebase/auth-compat",Uf="@firebase/database",Bf="@firebase/data-connect",$f="@firebase/database-compat",Gf="@firebase/functions",Wf="@firebase/functions-compat",Hf="@firebase/installations",qf="@firebase/installations-compat",zf="@firebase/messaging",Kf="@firebase/messaging-compat",Jf="@firebase/performance",Qf="@firebase/performance-compat",Yf="@firebase/remote-config",Xf="@firebase/remote-config-compat",Zf="@firebase/storage",ep="@firebase/storage-compat",tp="@firebase/firestore",np="@firebase/vertexai-preview",rp="@firebase/firestore-compat",sp="firebase",ip="10.14.1";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const so="[DEFAULT]",op={[ro]:"fire-core",[jf]:"fire-core-compat",[Df]:"fire-analytics",[Of]:"fire-analytics-compat",[Mf]:"fire-app-check",[Lf]:"fire-app-check-compat",[Ff]:"fire-auth",[Vf]:"fire-auth-compat",[Uf]:"fire-rtdb",[Bf]:"fire-data-connect",[$f]:"fire-rtdb-compat",[Gf]:"fire-fn",[Wf]:"fire-fn-compat",[Hf]:"fire-iid",[qf]:"fire-iid-compat",[zf]:"fire-fcm",[Kf]:"fire-fcm-compat",[Jf]:"fire-perf",[Qf]:"fire-perf-compat",[Yf]:"fire-rc",[Xf]:"fire-rc-compat",[Zf]:"fire-gcs",[ep]:"fire-gcs-compat",[tp]:"fire-fst",[rp]:"fire-fst-compat",[np]:"fire-vertex","fire-js":"fire-js",[sp]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Lr(n,e,t=!1){if(t)return e;try{return await e}catch(r){throw r instanceof bt&&Np(r)&&n.auth.currentUser===n&&await n.auth.signOut(),r}}function Np({code:n}){return n==="auth/user-disabled"||n==="auth/user-token-expired"}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Hn(n,e){return Ap(n,"POST","/v1/accounts:signInWithIdp",Oo(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ws extends bt{constructor(e,t,r,s){var o;super(t.code,t.message),this.operationType=r,this.user=s,Object.setPrototypeOf(this,Ws.prototype),this.customData={appName:e.name,tenantId:(o=e.tenantId)!==null&&o!==void 0?o:void 0,_serverResponse:t.customData._serverResponse,operationType:r}}static _fromErrorAndOperation(e,t,r,s){return new Ws(e,t,r,s)}}function tu(n,e,t,r){return(e==="reauthenticate"?t._getReauthenticationResolver(n):t._getIdTokenResponse(n)).catch(o=>{throw o.code==="auth/multi-factor-auth-required"?Ws._fromErrorAndOperation(n,o,e,r):o})}async function Zp(n,e,t=!1){const r=await Lr(n,e._linkToIdToken(n.auth,await n.getIdToken()),t);return Kn._forOperation(n,"link",r)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const $m=new zr(3e4,6e4);function bl(){const n=Ct().___jsl;if(n!=null&&n.H){for(const e of Object.keys(n.H))if(n.H[e].r=n.H[e].r||[],n.H[e].L=n.H[e].L||[],n.H[e].r=[...n.H[e].L],n.CP)for(let t=0;t<n.CP.length;t++)n.CP[t]=null}}function Gm(n){return new Promise((e,t)=>{var r,s,o;function a(){bl(),gapi.load("gapi.iframes",{callback:()=>{e(gapi.iframes.getContext())},ontimeout:()=>{bl(),t(It(n,"network-request-failed"))},timeout:$m.get()})}if(!((s=(r=Ct().gapi)===null||r===void 0?void 0:r.iframes)===null||s===void 0)&&s.Iframe)e(gapi.iframes.getContext());else if(!((o=Ct().gapi)===null||o===void 0)&&o.load)a();else{const u=qp("iframefcb");return Ct()[u]=()=>{gapi.load?a():t(It(n,"network-request-failed"))},Wp(`${Hp()}?onload=${u}`).catch(h=>t(h))}}).catch(e=>{throw ks=null,e})}let ks=null;function Wm(n){return ks=ks||Gm(n),ks}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Hm=new zr(5e3,15e3),qm="__/auth/iframe",zm="emulator/auth/iframe",Km={style:{position:"absolute",top:"-100px",width:"1px",height:"1px"},"aria-hidden":"true",tabindex:"-1"},Jm=new Map([["identitytoolkit.googleapis.com","p"],["staging-identitytoolkit.sandbox.googleapis.com","s"],["test-identitytoolkit.sandbox.googleapis.com","t"]]);function Qm(n){const e=n.config;J(e.authDomain,n,"auth-domain-config-required");const t=e.emulator?jo(e,zm):`https://${n.config.authDomain}/${qm}`,r={apiKey:e.apiKey,appName:n.name,v:er},s=Jm.get(n.config.apiHost);s&&(r.eid=s);const o=n._getFrameworks();return o.length&&(r.fw=o.join(",")),`${t}?${qr(r).slice(1)}`}async function Ym(n){const e=await Wm(n),t=Ct().gapi;return J(t,n,"internal-error"),e.open({where:document.body,url:Qm(n),messageHandlersFilter:t.iframes.CROSS_ORIGIN_IFRAMES_FILTER,attributes:Km,dontclear:!0},r=>new Promise(async(s,o)=>{await r.restyle({setHideOnLeave:!1});const a=It(n,"network-request-failed"),u=Ct().setTimeout(()=>{o(a)},Hm.get());function h(){Ct().clearTimeout(u),s(r)}r.ping(h).then(h,()=>{o(a)})}))}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const sy=new tt(se.comparator);function Zs(){return sy}const Lu=new tt(se.comparator);function xs(...n){let e=Lu;for(const t of n)e=e.insert(t.key,t);return e}function Mu(n){let e=Lu;return n.forEach((t,r)=>e=e.insert(t,r.overlayedDocument)),e}function In(){return Nr()}function Fu(){return Nr()}function Nr(){return new sr(n=>n.toString(),(n,e)=>n.isEqual(e))}const iy=new tt(se.comparator),oy=new Qe(se.comparator);function Je(...n){let e=oy;for(const t of n)e=e.add(t);return e}const ay=new Qe(ge);function ly(){return ay}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Qo{constructor(){this.Tr=new Qe(Le.Er),this.dr=new Qe(Le.Ar)}isEmpty(){return this.Tr.isEmpty()}addReference(e,t){const r=new Le(e,t);this.Tr=this.Tr.add(r),this.dr=this.dr.add(r)}Rr(e,t){e.forEach(r=>this.addReference(r,t))}removeReference(e,t){this.Vr(new Le(e,t))}mr(e,t){e.forEach(r=>this.removeReference(r,t))}gr(e){const t=new se(new Ne([])),r=new Le(t,e),s=new Le(t,e+1),o=[];return this.dr.forEachInRange([r,s],a=>{this.Vr(a),o.push(a.key)}),o}pr(){this.Tr.forEach(e=>this.Vr(e))}Vr(e){this.Tr=this.Tr.delete(e),this.dr=this.dr.delete(e)}yr(e){const t=new se(new Ne([])),r=new Le(t,e),s=new Le(t,e+1);let o=Je();return this.dr.forEachInRange([r,s],a=>{o=o.add(a.key)}),o}containsKey(e){const t=new Le(e,0),r=this.Tr.firstAfterOrEqual(t);return r!==null&&e.isEqual(r.key)}}class Le{constructor(e,t){this.key=e,this.wr=t}static Er(e,t){return se.comparator(e.key,t.key)||ge(e.wr,t.wr)}static Ar(e,t){return ge(e.wr,t.wr)||se.comparator(e.key,t.key)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Qy{constructor(){this.Gi=!1,this.zi=!1,this.ji=100,this.Hi=function(){return Zd()?8:Dg(Ye())>0?6:4}()}initialize(e,t){this.Ji=e,this.indexManager=t,this.Gi=!0}getDocumentsMatchingQuery(e,t,r,s){const o={result:null};return this.Yi(e,t).next(a=>{o.result=a}).next(()=>{if(!o.result)return this.Zi(e,t,s,r).next(a=>{o.result=a})}).next(()=>{if(o.result)return;const a=new Jy;return this.Xi(e,t,a).next(u=>{if(o.result=u,this.zi)return this.es(e,t,a,u.size)})}).next(()=>o.result)}es(e,t,r,s){return r.documentReadCount<this.ji?(Er()<=oe.DEBUG&&H("QueryEngine","SDK will not create cache indexes for query:",br(t),"since it only creates cache indexes for collection contains","more than or equal to",this.ji,"documents"),O.resolve()):(Er()<=oe.DEBUG&&H("QueryEngine","Query:",br(t),"scans",r.documentReadCount,"local documents and returns",s,"documents as results."),r.documentReadCount>this.Hi*s?(Er()<=oe.DEBUG&&H("QueryEngine","The SDK decides to create cache indexes for query:",br(t),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(e,xn(t))):O.resolve())}Yi(e,t){if(Fl(t))return O.resolve(null);let r=xn(t);return this.indexManager.getIndexType(e,r).next(s=>s===0?null:(t.limit!==null&&s===1&&(t=po(t,null,"F"),r=xn(t)),this.indexManager.getDocumentsMatchingTarget(e,r).next(o=>{const a=Je(...o);return this.Ji.getDocuments(e,a).next(u=>this.indexManager.getMinOffset(e,r).next(h=>{const f=this.ts(t,u);return this.ns(t,f,a,h.readTime)?this.Yi(e,po(t,null,"F")):this.rs(e,f,t,h)}))})))}Zi(e,t,r,s){return Fl(t)||s.isEqual(Ee.min())?O.resolve(null):this.Ji.getDocuments(e,r).next(o=>{const a=this.ts(t,o);return this.ns(t,a,r,s)?O.resolve(null):(Er()<=oe.DEBUG&&H("QueryEngine","Re-using previous result from %s to execute query: %s",s.toString(),br(t)),this.rs(e,a,t,Ng(s,-1)).next(u=>u))})}ts(e,t){let r=new Qe(ny(e));return t.forEach((s,o)=>{zo(e,o)&&(r=r.add(o))}),r}ns(e,t,r,s){if(e.limit===null)return!1;if(r.size!==t.size)return!0;const o=e.limitType==="F"?t.last():t.first();return!!o&&(o.hasPendingWrites||o.version.compareTo(s)>0)}Xi(e,t,r){return Er()<=oe.DEBUG&&H("QueryEngine","Using full collection scan to execute query:",br(t)),this.Ji.getDocumentsMatchingQuery(e,t,hn.min(),r)}rs(e,t,r,s){return this.Ji.getDocumentsMatchingQuery(e,r,s).next(o=>(t.forEach(a=>{o=o.insert(a.key,a)}),o))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
This typically indicates that your device does not have a healthy Internet connection at the moment. The client will operate in offline mode until it is able to successfully connect to the backend.`;this.D_?(Cn(t),this.D_=!1):H("OnlineStateTracker",t)}x_(){this.b_!==null&&(this.b_.cancel(),this.b_=null)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`),!1}},[S]);T.useEffect(()=>{pn.current={reinitializeCamera:ur}},[ur]),T.useEffect(()=>{if(!de)return;const P=setInterval(()=>{_(M=>M+1)},1e3);return()=>clearInterval(P)},[de]),T.useEffect(()=>{B&&S&&console.log("🎬 [PARTNER FOUND] Transitioning to video chat screen")},[B,S]);const ss=async()=>{var P;try{if(console.log("📹 [START CAMERA] User clicked to start camera"),console.log("📹 [START CAMERA] Checking DOM state..."),console.log("   localVideoRef.current:",!!ne.current),console.log("   localVideoRef.current in DOM:",(P=ne.current)!=null&&P.parentElement?"YES":"NO"),console.log("   All videos in DOM:",document.querySelectorAll("video").length),!ne.current){console.error("📹 [START CAMERA] ❌ Video element not in DOM - cannot proceed");return}console.log("📹 [START CAMERA] Requesting camera from browser...");const M=await navigator.mediaDevices.getUserMedia({video:!0,audio:!1});Xt.current=M,X.current=M,console.log("📹 [START CAMERA] ✅ Stream obtained:",M),console.log("📹 [START CAMERA] Stream tracks:",M.getTracks().map(V=>({kind:V.kind,enabled:V.enabled,id:V.id}))),ne.current&&(ne.current.srcObject=M,console.log("📹 [START CAMERA] ✅ Stream attached to video element"),ne.current.onloadedmetadata=()=>{console.log("📹 [START CAMERA] ✅ Video metadata loaded, calling play()"),ne.current.play().then(()=>{console.log("📹 [START CAMERA] ✅ Video playing - setting isLocalCameraReady=true"),Tt(!0)}).catch(V=>{console.warn("📹 [START CAMERA] ⚠️ Play warning (but video loaded):",V.message),Tt(!0)})})}catch(M){console.error("📹 [START CAMERA] ❌ CRITICAL ERROR:",M),console.error("   Error name:",M.name),console.error("   Error message:",M.message),M.name==="NotAllowedError"?console.error("❌ Camera permission DENIED by user - User clicked deny in browser prompt"):M.name==="NotFoundError"?console.error("❌ No camera device found - Check if device has a camera"):M.name==="NotReadableError"?console.error("❌ Camera is already in use by another app - Close other apps using camera"):M.name==="SecurityError"&&console.error("❌ Camera access blocked by security policy - Must use HTTPS")}};T.useEffect(()=>()=>{console.log("📹 [DASHBOARD CLEANUP] Component unmounting"),console.log("📹 [DASHBOARD CLEANUP] ⚠️ NOT stopping camera - will be reused on return")},[]),T.useEffect(()=>{const P=setTimeout(()=>{ot&&X.current&&(console.log("📹 [VERIFY] Stream attached:",{srcObject:!!ot.srcObject,paused:ot.paused,tracks:X.current.getTracks().length,readyState:ot.readyState,networkState:ot.networkState}),ot.paused&&(console.log("📹 [VERIFY] Video is paused, attempting play..."),ot.play().catch(M=>{console.warn("📹 [VERIFY] Play failed:",M.message)})))},1e3);return()=>clearTimeout(P)},[]);const Zt=async()=>{if(console.log("🔧 createPeerConnection called"),console.log("   Current localStreamRef:",X.current),!X.current){console.warn("⚠️ CRITICAL: localStreamRef.current is null - attempting to reacquire camera stream");try{const te=await navigator.mediaDevices.getUserMedia({video:{width:{ideal:640},height:{ideal:480}},audio:!0});if(X.current=te,ne.current){ne.current.srcObject=te,ne.current.muted=!0;try{await ne.current.play()}catch(U){console.warn("⚠️ Play error during reacquisition:",U)}}console.log("✅ LOCAL STREAM RE-ACQUIRED SUCCESSFULLY"),console.log("   Tracks:",te.getTracks().map(U=>({kind:U.kind,id:U.id})))}catch(te){throw console.error("❌ FATAL: Could not reacquire camera stream:",te.message),new Error("Cannot proceed: local camera stream unavailable - "+te.message)}}AI();const P=await hr(),M=[{urls:["stun:global.xirsys.net","turn:global.xirsys.net:3478?transport=udp","turn:global.xirsys.net:3478?transport=tcp"],username:"nkhlvdv",credential:"a8e244b8-cf5b-11f0-8771-0242ac140002"},...P];console.log("🔧 ICE Servers Configuration:",{count:M.length,servers:M.map(te=>({urls:te.urls,username:te.username?"***":void 0,credential:te.credential?"***":void 0}))});const V=new RTCPeerConnection({iceServers:M,iceTransportPolicy:"all"});if(z.current=V,console.log("✅ RTCPeerConnection created with iceTransportPolicy: all"),V.onicecandidate=te=>{if(te.candidate){const U=te.candidate;console.log("🧊 ICE candidate generated:",{candidate:U.candidate,protocol:U.protocol,port:U.port,address:U.address,type:U.type,priority:U.priority,sdpMLineIndex:U.sdpMLineIndex,sdpMId:U.sdpMid}),U.type==="relay"?(console.log("🔄 RELAY (TURN) candidate generated - TURN server is reachable"),console.log("   Protocol:",U.protocol,"Port:",U.port)):U.type==="srflx"?(console.log("📍 SRFLX (server reflexive) candidate - STUN working"),console.log("   Found public address via STUN")):U.type==="host"&&console.log("🏠 HOST candidate - direct LAN connection possible"),console.log("🔌 Sending ICE candidate to partner socket:",st.current),K.emit("ice_candidate",{candidate:U,to:st.current}),console.log("📤 ICE candidate sent to peer")}else console.log("🧊 ICE gathering complete (null candidate received)"),console.log("📊 ICE gathering summary:"),console.log("   Connection State:",V.connectionState),console.log("   ICE Connection State:",V.iceConnectionState),console.log("   ICE Gathering State:",V.iceGatheringState)},V.oniceconnectionstatechange=()=>{const te=V.iceConnectionState;switch(console.log(`
...
🔐 ===== CRITICAL STREAM VERIFICATION =====`),console.log("🔐 Checking localStreamRef.current status:"),console.log("   exists:",!!X.current),console.log("   tracks:",((Ie=X.current)==null?void 0:Ie.getTracks().length)||0),console.log("   video element srcObject:",!!((Ge=ne.current)!=null&&Ge.srcObject)),!X.current){console.error("🔐 ❌ CRITICAL: localStreamRef.current is NULL - cannot proceed to WebRTC"),console.error("   This means the camera stream was never acquired or was lost"),console.error("   Attempting emergency camera reacquisition...");try{const pe=await navigator.mediaDevices.getUserMedia({video:{width:{ideal:640},height:{ideal:480}},audio:!0});if(X.current=pe,ne.current){ne.current.srcObject=pe,ne.current.muted=!0;try{await ne.current.play()}catch{console.warn("⚠️ Play error in emergency reacquisition")}}console.log("🔐 ✅ EMERGENCY: Camera stream re-acquired")}catch(pe){console.error("🔐 ❌ EMERGENCY FAILED: Could not reacquire camera -",pe.message),console.error("   User must allow camera permission to continue");return}}if(console.log(`🔐 ✅ STREAM VERIFICATION PASSED - proceeding with WebRTC
...
🏠 OFFERER: Creating peer connection`),z.current){console.warn("⚠️ OFFERER: WARNING - Peer connection already exists! Not recreating."),console.warn("   Existing PC state:",{connectionState:z.current.connectionState,iceConnectionState:z.current.iceConnectionState,signalingState:z.current.signalingState});return}let pe;try{pe=await Zt()}catch(fe){console.error("❌ OFFERER: Error creating peer connection:",fe);return}if(z.current=pe,console.log("✅ OFFERER: Peer connection created"),console.log("📊 OFFERER Stream status after peer connection creation:",{exists:!!X.current,trackCount:(Se=X.current)==null?void 0:Se.getTracks().length,tracks:(Ae=X.current)==null?void 0:Ae.getTracks().map(fe=>({kind:fe.kind,enabled:fe.enabled,state:fe.readyState}))}),X.current){console.log(`
👤 OFFERER localStream:`,X.current);const fe=X.current.getTracks();console.log("👤 OFFERER: All available tracks:",fe),console.log("📹 OFFERER tracks detail:",fe.map(We=>({kind:We.kind,id:We.id,enabled:We.enabled,state:We.readyState})));const Ft=pe.getSenders();if(console.log("📤 OFFERER: Existing senders count:",Ft.length),Ft.length>0)console.warn("⚠️ OFFERER WARNING: Tracks already added! Senders:",Ft.map(We=>{var je,ct;return{kind:(je=We.track)==null?void 0:je.kind,id:(ct=We.track)==null?void 0:ct.id}})),console.warn("   Not adding tracks again to avoid duplicates");else{console.log(`
📹 OFFERER: Adding ${fe.length} local tracks to peer connection`),fe.forEach((je,ct)=>{console.log(`  [${ct}] Adding ${je.kind} track (id: ${je.id}, enabled: ${je.enabled})`);try{const Vt=pe.addTrack(je,X.current);console.log(`  [${ct}] ✅ addTrack succeeded, sender:`,Vt)}catch(Vt){console.error(`  [${ct}] ❌ addTrack failed:`,Vt)}}),console.log(`
✅ OFFERER: All tracks added to peer connection`);const We=pe.getSenders();console.log("📤 OFFERER senders count:",We.length),console.log("📤 OFFERER senders after addTrack:",We.map((je,ct)=>{var Vt,fr,as;return{index:ct,kind:(Vt=je.track)==null?void 0:Vt.kind,id:(fr=je.track)==null?void 0:fr.id,trackExists:!!je.track,trackEnabled:(as=je.track)==null?void 0:as.enabled}})),console.log("🚀 OFFERER: Ready to send offer with",fe.length,`tracks
...
📤 OFFERER: Sending offer with tracks:`,pe.getSenders().map(fe=>{var Ft,We,je;return{kind:(Ft=fe.track)==null?void 0:Ft.kind,id:(We=fe.track)==null?void 0:We.id,enabled:(je=fe.track)==null?void 0:je.enabled}})),console.log("📤 OFFERER: Partner socket ID from data:",P.socketId),console.log("📤 OFFERER: partnerSocketIdRef.current value:",st.current),console.log("🔌🔌🔌 CRITICAL: About to emit webrtc_offer with to:",P.socketId),console.log("🔌🔌🔌 CRITICAL: Is to value empty/null/undefined?",!P.socketId),K.emit("webrtc_offer",{offer:z.current.localDescription,to:P.socketId}),console.log("✅ OFFERER: webrtc_offer emitted successfully"),console.log("✅ OFFERER: webrtc_offer sent to socket ID:",P.socketId),console.log("✅ OFFERER: webrtc_offer contains",z.current.getSenders().length,"senders"),console.log("✅ OFFERER: Sent to socket:",P.socketId)}catch(pe){console.error("❌ OFFERER: Error in partner_found handler:",pe),console.error("❌ OFFERER: Stack trace:",pe.stack)}}),K.on("webrtc_offer",async P=>{console.log(`
...
🔍 ANSWERER: ALWAYS executing track addition logic`),console.log("👤 ANSWERER: Checking localStreamRef.current..."),console.log("👤 ANSWERER localStreamRef.current:",X.current),console.log("👤 ANSWERER localStreamRef.current === null?",X.current===null),console.log("👤 ANSWERER localStreamRef.current === undefined?",X.current===void 0),!X.current){console.warn("⚠️ ANSWERER: localStreamRef.current is NULL - attempting emergency reacquisition");try{const U=await navigator.mediaDevices.getUserMedia({video:{width:{ideal:640},height:{ideal:480}},audio:!0});if(X.current=U,ne.current){ne.current.srcObject=U,ne.current.muted=!0;try{await ne.current.play()}catch{console.warn("⚠️ Play error in answerer emergency reacquisition")}}console.log("✅ ANSWERER: Emergency stream acquisition successful")}catch(U){throw console.error("❌ ANSWERER: Emergency stream acquisition failed:",U.message),new Error("ANSWERER: Cannot reacquire camera stream - "+U.message)}}if(X.current){console.log(`
✅ ANSWERER: localStream EXISTS - will add tracks`),console.log("📊 ANSWERER localStream object:",X.current);const U=X.current.getTracks();console.log("👤 ANSWERER: getAllTracks() returned:",U),console.log("👤 ANSWERER: Track array length:",U.length),U.length>0?console.log("👤 ANSWERER: Tracks detail:",U.map(xe=>({kind:xe.kind,id:xe.id,enabled:xe.enabled,readyState:xe.readyState}))):console.warn("⚠️ ANSWERER: WARNING - localStream exists but getTracks() returned empty array!");const le=z.current.getSenders();if(console.log("📤 ANSWERER: Existing senders count:",le.length),le.length>0)console.warn("⚠️ ANSWERER WARNING: Tracks already added! Senders:",le.map(xe=>{var Ie,Ge;return{kind:(Ie=xe.track)==null?void 0:Ie.kind,id:(Ge=xe.track)==null?void 0:Ge.id}})),console.warn("   Not adding tracks again to avoid duplicates");else{console.log(`
📹 ANSWERER: Attempting to add ${U.length} local tracks to peer connection`);let xe=0,Ie=0;U.forEach((Se,Ae)=>{console.log(`  [${Ae}] About to add ${Se.kind} track (id: ${Se.id}, enabled: ${Se.enabled})`);try{const pe=z.current.addTrack(Se,X.current);console.log(`  [${Ae}] ✅ addTrack SUCCEEDED`),console.log(`  [${Ae}] Sender:`,pe),xe++}catch(pe){console.error(`  [${Ae}] ❌ addTrack FAILED`),console.error(`  [${Ae}] Error:`,pe.message),Ie++}}),console.log(`
...
🔄 ANSWERER: Setting remote description (offer from offerer)`),await z.current.setRemoteDescription(new RTCSessionDescription(P.offer)),console.log("✅ ANSWERER: Remote description set successfully"),console.log("🎬 ANSWERER: Creating answer");const M=await z.current.createAnswer({offerToReceiveVideo:!0,offerToReceiveAudio:!0});console.log("✅ ANSWERER: Answer created with receive constraints"),console.log("📋 ANSWERER SDP CHECK - Looking for a=sendrecv:");const V=M.sdp.split(`
`).filter(U=>U.includes("sendrecv")||U.includes("recvonly")||U.includes("sendonly"));console.log("   Media direction lines:"),V.forEach(U=>console.log("   ",U)),console.log("🔄 ANSWERER: Setting local description (answer)"),await z.current.setLocalDescription(M),console.log("✅ ANSWERER: Local description set successfully"),console.log(`
...
❌ ANSWERER: ERROR in webrtc_offer handler:`,M),console.error("❌ ANSWERER: Error message:",M.message),console.error("❌ ANSWERER: Stack trace:",M.stack)}}),K.on("webrtc_answer",async P=>{console.log(`
...
`)}catch(M){console.error("❌ OFFERER: Error handling answer:",M),console.error("❌ OFFERER: Stack trace:",M.stack)}}),K.on("ice_candidate",async P=>{if(console.log(`
...
`)):console.warn("⚠️ No peer connection available for ICE candidate")}catch(M){console.error("❌ Error adding ICE candidate:",M)}}),K.on("partner_disconnected",P=>{console.log(`
