 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function km(n,e,t){return Pm(n,e,t)}async function Pm(n,e,t){if(Ct(n.app))return Promise.reject(cn(n));const r=nr(n);Mc(n,e,ci),await r._initializationPromise;const s=Vo(r,t);return await Rm(s,r),s._openRedirect(r,e,"signInViaRedirect")}async function jm(n,e){return await nr(n)._initializationPromise,fu(n,e,!1)}async function fu(n,e,t=!1){if(Ct(n.app))return Promise.reject(cn(n));const r=nr(n),s=Vo(r,e),a=await new Cm(r,s,t).execute();return a&&!t&&(delete a.user._redirectEventId,await r._persistUserIfCurrent(a.user),await r._setRedirectUser(null,e)),a}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const $m=new Kr(3e4,6e4);function El(){const n=St().___jsl;if(n!=null&&n.H){for(const e of Object.keys(n.H))if(n.H[e].r=n.H[e].r||[],n.H[e].L=n.H[e].L||[],n.H[e].r=[...n.H[e].L],n.CP)for(let t=0;t<n.CP.length;t++)n.CP[t]=null}}function Gm(n){return new Promise((e,t)=>{var r,s,o;function a(){El(),gapi.load("gapi.iframes",{callback:()=>{e(gapi.iframes.getContext())},ontimeout:()=>{El(),t(bt(n,"network-request-failed"))},timeout:$m.get()})}if(!((s=(r=St().gapi)===null||r===void 0?void 0:r.iframes)===null||s===void 0)&&s.Iframe)e(gapi.iframes.getContext());else if(!((o=St().gapi)===null||o===void 0)&&o.load)a();else{const u=qp("iframefcb");return St()[u]=()=>{gapi.load?a():t(bt(n,"network-request-failed"))},Hp(`${Wp()}?onload=${u}`).catch(h=>t(h))}}).catch(e=>{throw ks=null,e})}let ks=null;function Hm(n){return ks=ks||Gm(n),ks}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Gi="webStorageSupport";class cg{constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=iu,this._completeRedirectFn=fu,this._overrideRedirectResult=Nm}async _openPopup(e,t,r,s){var o;Yt((o=this.eventManagers[e._key()])===null||o===void 0?void 0:o.manager,"_initialize() not called before _openPopup()");const a=await Tl(e,t,r,oo(),s);return rg(e,a,Fo())}async _openRedirect(e,t,r,s){await this._originValidation(e);const o=await Tl(e,t,r,oo(),s);return hm(o),new Promise(()=>{})}_initialize(e){const t=e._key();if(this.eventManagers[t]){const{manager:s,promise:o}=this.eventManagers[t];return s?Promise.resolve(s):(Yt(o,"If manager is not set, promise should be"),o)}const r=this.initAndGetManager(e);return this.eventManagers[t]={promise:r},r.catch(()=>{delete this.eventManagers[t]}),r}async initAndGetManager(e){const t=await Ym(e),r=new Dm(e);return t.register("authEvent",s=>(Y(s==null?void 0:s.authEvent,e,"invalid-auth-event"),{status:r.onEvent(s.authEvent)?"ACK":"ERROR"}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[e._key()]={manager:r},this.iframes[e._key()]=t,r}_isIframeWebStorageSupported(e,t){this.iframes[e._key()].send(Gi,{type:Gi},s=>{var o;const a=(o=s==null?void 0:s[0])===null||o===void 0?void 0:o[Gi];a!==void 0&&t(!!a),Nt(e,"internal-error")},gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(e){const t=e._key();return this.originValidationPromises[t]||(this.originValidationPromises[t]=Um(e)),this.originValidationPromises[t]}get _shouldInitProactively(){return Yc()||Wc()||Lo()}}const ug=cg;var Al="@firebase/auth",Cl="1.7.9";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Eu(n){if(n.code!==L.FAILED_PRECONDITION||n.message!==jg)throw n;W("LocalStore","Unexpectedly lost primary lease")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Qy{constructor(){this.Gi=!1,this.zi=!1,this.ji=100,this.Hi=function(){return Zd()?8:Dg(Ze())>0?6:4}()}initialize(e,t){this.Ji=e,this.indexManager=t,this.Gi=!0}getDocumentsMatchingQuery(e,t,r,s){const o={result:null};return this.Yi(e,t).next(a=>{o.result=a}).next(()=>{if(!o.result)return this.Zi(e,t,s,r).next(a=>{o.result=a})}).next(()=>{if(o.result)return;const a=new Jy;return this.Xi(e,t,a).next(u=>{if(o.result=u,this.zi)return this.es(e,t,a,u.size)})}).next(()=>o.result)}es(e,t,r,s){return r.documentReadCount<this.ji?(br()<=ie.DEBUG&&W("QueryEngine","SDK will not create cache indexes for query:",Er(t),"since it only creates cache indexes for collection contains","more than or equal to",this.ji,"documents"),O.resolve()):(br()<=ie.DEBUG&&W("QueryEngine","Query:",Er(t),"scans",r.documentReadCount,"local documents and returns",s,"documents as results."),r.documentReadCount>this.Hi*s?(br()<=ie.DEBUG&&W("QueryEngine","The SDK decides to create cache indexes for query:",Er(t),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(e,Tn(t))):O.resolve())}Yi(e,t){if(Fl(t))return O.resolve(null);let r=Tn(t);return this.indexManager.getIndexType(e,r).next(s=>s===0?null:(t.limit!==null&&s===1&&(t=po(t,null,"F"),r=Tn(t)),this.indexManager.getDocumentsMatchingTarget(e,r).next(o=>{const a=Ye(...o);return this.Ji.getDocuments(e,a).next(u=>this.indexManager.getMinOffset(e,r).next(h=>{const f=this.ts(t,u);return this.ns(t,f,a,h.readTime)?this.Yi(e,po(t,null,"F")):this.rs(e,f,t,h)}))})))}Zi(e,t,r,s){return Fl(t)||s.isEqual(xe.min())?O.resolve(null):this.Ji.getDocuments(e,r).next(o=>{const a=this.ts(t,o);return this.ns(t,a,r,s)?O.resolve(null):(br()<=ie.DEBUG&&W("QueryEngine","Re-using previous result from %s to execute query: %s",s.toString(),Er(t)),this.rs(e,a,t,Ng(s,-1)).next(u=>u))})}ts(e,t){let r=new Xe(ny(e));return t.forEach((s,o)=>{zo(e,o)&&(r=r.add(o))}),r}ns(e,t,r,s){if(e.limit===null)return!1;if(r.size!==t.size)return!0;const o=e.limitType==="F"?t.last():t.first();return!!o&&(o.hasPendingWrites||o.version.compareTo(s)>0)}Xi(e,t,r){return br()<=ie.DEBUG&&W("QueryEngine","Using full collection scan to execute query:",Er(t)),this.Ji.getDocumentsMatchingQuery(e,t,hn.min(),r)}rs(e,t,r,s){return this.Ji.getDocumentsMatchingQuery(e,r,s).next(o=>(t.forEach(a=>{o=o.insert(a.key,a)}),o))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class cv extends class{}{constructor(e,t,r,s){super(),this.authCredentials=e,this.appCheckCredentials=t,this.connection=r,this.serializer=s,this.y_=!1}w_(){if(this.y_)throw new X(L.FAILED_PRECONDITION,"The client has already been terminated.")}Mo(e,t,r,s){return this.w_(),Promise.all([this.authCredentials.getToken(),this.appCheckCredentials.getToken()]).then(([o,a])=>this.connection.Mo(e,go(t,r),s,o,a)).catch(o=>{throw o.name==="FirebaseError"?(o.code===L.UNAUTHENTICATED&&(this.authCredentials.invalidateToken(),this.appCheckCredentials.invalidateToken()),o):new X(L.UNKNOWN,o.toString())})}Lo(e,t,r,s,o){return this.w_(),Promise.all([this.authCredentials.getToken(),this.appCheckCredentials.getToken()]).then(([a,u])=>this.connection.Lo(e,go(t,r),s,a,u,o)).catch(a=>{throw a.name==="FirebaseError"?(a.code===L.UNAUTHENTICATED&&(this.authCredentials.invalidateToken(),this.appCheckCredentials.invalidateToken()),a):new X(L.UNKNOWN,a.toString())})}terminate(){this.y_=!0,this.connection.terminate()}}class uv{constructor(e,t){this.asyncQueue=e,this.onlineStateHandler=t,this.state="Unknown",this.S_=0,this.b_=null,this.D_=!0}v_(){this.S_===0&&(this.C_("Unknown"),this.b_=this.asyncQueue.enqueueAfterDelay("online_state_timeout",1e4,()=>(this.b_=null,this.F_("Backend didn't respond within 10 seconds."),this.C_("Offline"),Promise.resolve())))}M_(e){this.state==="Online"?this.C_("Unknown"):(this.S_++,this.S_>=1&&(this.x_(),this.F_(`Connection failed 1 times. Most recent error: ${e.toString()}`),this.C_("Offline")))}set(e){this.x_(),this.S_=0,e==="Online"&&(this.D_=!1),this.C_(e)}C_(e){e!==this.state&&(this.state=e,this.onlineStateHandler(e))}F_(e){const t=`Could not reach Cloud Firestore backend. ${e}
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Gr{constructor(e){this._byteString=e}static fromBase64String(e){try{return new Gr(kt.fromBase64String(e))}catch(t){throw new X(L.INVALID_ARGUMENT,"Failed to construct data from Base64 string: "+t)}}static fromUint8Array(e){return new Gr(kt.fromUint8Array(e))}toBase64(){return this._byteString.toBase64()}toUint8Array(){return this._byteString.toUint8Array()}toString(){return"Bytes(base64: "+this.toBase64()+")"}isEqual(e){return this._byteString.isEqual(e._byteString)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class oh{constructor(...e){for(let t=0;t<e.length;++t)if(e[t].length===0)throw new X(L.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new He(e)}isEqual(e){return this._internalPath.isEqual(e._internalPath)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class lh{constructor(e,t){if(!isFinite(e)||e<-90||e>90)throw new X(L.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+e);if(!isFinite(t)||t<-180||t>180)throw new X(L.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+t);this._lat=e,this._long=t}get latitude(){return this._lat}get longitude(){return this._long}isEqual(e){return this._lat===e._lat&&this._long===e._long}toJSON(){return{latitude:this._lat,longitude:this._long}}_compareTo(e){return ye(this._lat,e._lat)||ye(this._long,e._long)}}/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`),!1}},[S]);x.useEffect(()=>{pn.current={reinitializeCamera:hr}},[hr]),x.useEffect(()=>{if(!de)return;const R=setInterval(()=>{_(V=>V+1)},1e3);return()=>clearInterval(R)},[de]),x.useEffect(()=>{B&&S&&console.log("🎬 [PARTNER FOUND] Transitioning to video chat screen")},[B,S]);const ss=async()=>{var R;try{if(console.log("📹 [START CAMERA] User clicked to start camera"),console.log("📹 [START CAMERA] Checking DOM state..."),console.log("   localVideoRef.current:",!!ae.current),console.log("   localVideoRef.current in DOM:",(R=ae.current)!=null&&R.parentElement?"YES":"NO"),console.log("   All videos in DOM:",document.querySelectorAll("video").length),!ae.current){console.error("📹 [START CAMERA] ❌ Video element not in DOM - cannot proceed");return}console.log("📹 [START CAMERA] Requesting camera from browser...");const V=await navigator.mediaDevices.getUserMedia({video:!0,audio:!1});Zt.current=V,J.current=V,console.log("📹 [START CAMERA] ✅ Stream obtained:",V),console.log("📹 [START CAMERA] Stream tracks:",V.getTracks().map(D=>({kind:D.kind,enabled:D.enabled,id:D.id}))),ae.current&&(ae.current.srcObject=V,console.log("📹 [START CAMERA] ✅ Stream attached to video element"),ae.current.onloadedmetadata=()=>{console.log("📹 [START CAMERA] ✅ Video metadata loaded, calling play()"),ae.current.play().then(()=>{console.log("📹 [START CAMERA] ✅ Video playing - setting isLocalCameraReady=true"),At(!0)}).catch(D=>{console.warn("📹 [START CAMERA] ⚠️ Play warning (but video loaded):",D.message),At(!0)})})}catch(V){console.error("📹 [START CAMERA] ❌ CRITICAL ERROR:",V),console.error("   Error name:",V.name),console.error("   Error message:",V.message),V.name==="NotAllowedError"?console.error("❌ Camera permission DENIED by user - User clicked deny in browser prompt"):V.name==="NotFoundError"?console.error("❌ No camera device found - Check if device has a camera"):V.name==="NotReadableError"?console.error("❌ Camera is already in use by another app - Close other apps using camera"):V.name==="SecurityError"&&console.error("❌ Camera access blocked by security policy - Must use HTTPS")}};x.useEffect(()=>()=>{console.log("📹 [DASHBOARD CLEANUP] Component unmounting"),console.log("📹 [DASHBOARD CLEANUP] ⚠️ NOT stopping camera - will be reused on return")},[]),x.useEffect(()=>{console.log("📹 [CAMERA INIT] Starting camera initialization on mount");let R=!0;return(async()=>{try{if(J.current)console.log("📹 [CAMERA INIT] Stream already exists - reusing existing stream");else{console.log("📹 [CAMERA INIT] Requesting camera permissions from browser...");const U=await navigator.mediaDevices.getUserMedia({video:{width:{ideal:1280},height:{ideal:720}},audio:!0});if(!R){console.log("📹 [CAMERA INIT] Component unmounted, cleaning up stream"),U.getTracks().forEach(le=>le.stop());return}J.current=U,Zt.current=U,console.log("📹 [CAMERA INIT] ✅ Camera stream obtained"),console.log("📹 [CAMERA INIT] Active tracks:",U.getTracks().map(le=>({kind:le.kind,enabled:le.enabled})))}if(await new Promise(U=>setTimeout(U,0)),!R)return;let D=0;const Q=()=>{pe&&J.current?(console.log("📹 [CAMERA INIT] Attaching stream to video element..."),pe.srcObject=J.current,pe.muted=!0,console.log("📹 [CAMERA INIT] Calling play() on video element"),pe.play().then(()=>{R&&(console.log("📹 [CAMERA INIT] ✅ Video stream is now playing"),k(!0),At(!0))}).catch(U=>{R&&(console.warn("📹 [CAMERA INIT] ⚠️ Play error (stream may still display):",U.name,U.message),k(!0),At(!0))})):D<50?(D++,setTimeout(Q,50)):(console.error("📹 [CAMERA INIT] ❌ Video ref never became available"),console.error("   sharedVideoRef:",!!pe),console.error("   localStreamRef.current:",!!J.current),At(!0))};Q()}catch(D){R&&(console.error("📹 [CAMERA INIT] ❌ Error:",D.name,D.message),D.name==="NotAllowedError"?console.error("   → User denied camera permission"):D.name==="NotFoundError"?console.error("   → No camera device found"):D.name==="NotReadableError"&&console.error("   → Camera is in use by another app"),At(!0))}})(),()=>{R=!1}},[]),x.useEffect(()=>{const R=setInterval(()=>{pe&&pe.paused&&pe.srcObject&&(console.warn("📹 [RESUME CHECK] Video was paused! Resuming..."),pe.play().catch(V=>console.warn("📹 [RESUME CHECK] Resume error:",V.message)))},500);return()=>clearInterval(R)},[]),x.useEffect(()=>{let R=0;const V=setInterval(()=>{try{if(!pe)return;if(J.current&&(pe!=null&&pe.srcObject)){const D=J.current.getTracks(),Q=D.find(U=>U.kind==="video");Q&&!Q.enabled&&(console.warn("📹 [TRACK MONITOR] ⚠️ Video track was disabled! Re-enabling..."),Q.enabled=!0),D.length===0&&console.error("📹 [TRACK MONITOR] ❌ Stream has no tracks! Stream was lost")}else if(pe&&!pe.srcObject&&J.current){const D=Date.now();D-R>2e3&&(console.warn("📹 [TRACK MONITOR] ❌ Video element lost srcObject! Emergency re-attach..."),R=D,pe&&J.current&&(pe.srcObject=J.current,pe.muted=!0,pe.play().catch(Q=>console.warn("Play error:",Q))))}}catch(D){console.debug("📹 [TRACK MONITOR] Minor error:",D.message)}},1e3);return()=>clearInterval(V)},[]),x.useEffect(()=>{const R=setInterval(()=>{try{if(!pe)return;if(!pe.srcObject&&J.current){console.warn("📹 [HEALTH] 🚨 Video srcObject lost! Re-attaching stream NOW...");try{pe.srcObject=J.current,pe.muted=!0,pe.play().then(()=>console.log("📹 [HEALTH] ✅ Stream reattached and playing")).catch(V=>console.warn("📹 [HEALTH] Play error:",V.message))}catch(V){console.error("📹 [HEALTH] Error reattaching:",V)}}pe.srcObject&&pe.paused&&(console.warn("📹 [HEALTH] ⚠️ Video element is PAUSED! Resuming..."),pe.play().catch(V=>console.warn("📹 [HEALTH] Resume error:",V.message)))}catch(V){console.debug("📹 [HEALTH] Minor error:",V.message)}},2e3);return()=>clearInterval(R)},[]);const en=async()=>{if(console.log("🔧 createPeerConnection called"),console.log("   Current localStreamRef:",J.current),!J.current){console.warn("⚠️ CRITICAL: localStreamRef.current is null - attempting to reacquire camera stream");try{const Q=await navigator.mediaDevices.getUserMedia({video:{width:{ideal:640},height:{ideal:480}},audio:!0});if(J.current=Q,ae.current){ae.current.srcObject=Q,ae.current.muted=!0;try{await ae.current.play()}catch(U){console.warn("⚠️ Play error during reacquisition:",U)}}console.log("✅ LOCAL STREAM RE-ACQUIRED SUCCESSFULLY"),console.log("   Tracks:",Q.getTracks().map(U=>({kind:U.kind,id:U.id})))}catch(Q){throw console.error("❌ FATAL: Could not reacquire camera stream:",Q.message),new Error("Cannot proceed: local camera stream unavailable - "+Q.message)}}AI();const R=await dr(),V=[{urls:["stun:global.xirsys.net","turn:global.xirsys.net:3478?transport=udp","turn:global.xirsys.net:3478?transport=tcp"],username:"nkhlvdv",credential:"a8e244b8-cf5b-11f0-8771-0242ac140002"},...R];console.log("🔧 ICE Servers Configuration:",{count:V.length,servers:V.map(Q=>({urls:Q.urls,username:Q.username?"***":void 0,credential:Q.credential?"***":void 0}))});const D=new RTCPeerConnection({iceServers:V,iceTransportPolicy:"all"});if(z.current=D,console.log("✅ RTCPeerConnection created with iceTransportPolicy: all"),D.onicecandidate=Q=>{if(Q.candidate){const U=Q.candidate;console.log("🧊 ICE candidate generated:",{candidate:U.candidate,protocol:U.protocol,port:U.port,address:U.address,type:U.type,priority:U.priority,sdpMLineIndex:U.sdpMLineIndex,sdpMId:U.sdpMid}),U.type==="relay"?(console.log("🔄 RELAY (TURN) candidate generated - TURN server is reachable"),console.log("   Protocol:",U.protocol,"Port:",U.port)):U.type==="srflx"?(console.log("📍 SRFLX (server reflexive) candidate - STUN working"),console.log("   Found public address via STUN")):U.type==="host"&&console.log("🏠 HOST candidate - direct LAN connection possible"),console.log("🔌 Sending ICE candidate to partner socket:",it.current),K.emit("ice_candidate",{candidate:U,to:it.current}),console.log("📤 ICE candidate sent to peer")}else console.log("🧊 ICE gathering complete (null candidate received)"),console.log("📊 ICE gathering summary:"),console.log("   Connection State:",D.connectionState),console.log("   ICE Connection State:",D.iceConnectionState),console.log("   ICE Gathering State:",D.iceGatheringState)},D.oniceconnectionstatechange=()=>{const Q=D.iceConnectionState;switch(console.log(`
🧊 ===== ICE CONNECTION STATE CHANGED =====`),console.log("🧊 New ICE Connection State:",Q),Q){case"new":console.log("🧊 State: NEW - Gathering ICE candidates");break;case"checking":console.log("🧊 State: CHECKING - Testing ICE candidate pairs"),console.log("🧊 Connection in progress - waiting for connectivity");break;case"connected":console.log("✅ State: CONNECTED - Found working ICE candidate pair"),console.log("🧊 Peer-to-peer communication established");break;case"completed":console.log("✅ State: COMPLETED - ICE checks completed, ready for media"),console.log("🧊 All connectivity checks passed");break;case"failed":console.error("❌ State: FAILED - All ICE candidate pairs failed"),console.error("❌ Could not establish peer-to-peer connection"),console.error("❌ TURN server may be unreachable or blocked by ISP"),console.error("🔍 Troubleshooting:"),console.error("   - Check console for TURN error details"),console.error("   - TURN error 701 = Network/ISP blocking ports 3478, 5349"),console.error("   - Solutions: Try VPN, different WiFi, or mobile hotspot"),console.error("   - User can retry with a retry button (do NOT auto-restart ICE)");break;case"disconnected":console.warn("⚠️ State: DISCONNECTED - Lost connection to peer"),console.warn("   Note: ICE restart is manual only to prevent stream loss");break;case"closed":console.log("🛑 State: CLOSED - Connection closed");break}console.log("📊 Full connection states:"),console.log("   Signaling State:",D.signalingState),console.log("   Connection State:",D.connectionState),console.log("   ICE Gathering State:",D.iceGatheringState)},z.current._remoteStream||(z.current._remoteStream=new MediaStream,console.log("✅ PERSISTENT REMOTE STREAM CREATED - will accumulate all incoming tracks")),D.ontrack=Q=>{console.log(`
...
📊 ===== RECEIVER DEBUG CHECK (after connected) =====`);const Q=D.getReceivers();console.log("📊 Total receivers:",Q.length),Q.forEach((le,me)=>{var Pe,qe,Ee,je,fe;console.log(`📊 Receiver ${me}:`,{kind:(Pe=le.track)==null?void 0:Pe.kind,enabled:(qe=le.track)==null?void 0:qe.enabled,readyState:(Ee=le.track)==null?void 0:Ee.readyState,id:(je=le.track)==null?void 0:je.id,muted:(fe=le.track)==null?void 0:fe.muted})}),console.log("📊 Audio and video tracks should be present above");const U=D.getSenders();console.log(`
📊 Total senders:`,U.length),U.forEach((le,me)=>{var Pe,qe,Ee,je;console.log(`📊 Sender ${me}:`,{kind:(Pe=le.track)==null?void 0:Pe.kind,enabled:(qe=le.track)==null?void 0:qe.enabled,readyState:(Ee=le.track)==null?void 0:Ee.readyState,id:(je=le.track)==null?void 0:je.id})})},1e3)):D.connectionState==="disconnected"?(M(!1),console.log("⚠️ WebRTC connection DISCONNECTED")):D.connectionState==="failed"?(M(!1),console.log("❌ WebRTC connection FAILED")):D.connectionState==="closed"&&(M(!1),console.log("❌ WebRTC connection CLOSED"))},!J.current)throw console.error("❌ CRITICAL ERROR: localStreamRef.current is null/undefined in createPeerConnection!"),new Error("Local stream lost before createPeerConnection");return D};x.useEffect(()=>(console.log(`

🔌 ===== SOCKET LISTENERS SETUP (COMPONENT MOUNT) =====`),console.log("🔌 Setting up socket listeners - runs ONCE on component load"),console.log("🔌 Socket ID:",K.id),console.log("🔌 Socket connected:",K.connected),console.log("🔌 🔐 Using userIdRef.current for ALL ID comparisons:",he.current),K.off("partner_found"),K.off("webrtc_offer"),K.off("webrtc_answer"),K.off("ice_candidate"),K.off("receive_message"),K.off("partner_disconnected"),K.off("disconnect"),console.log("🔌 Removed old listeners (if any existed)"),K.on("partner_found",async R=>{var Pe,qe,Ee,je;console.log(`
...
👥 SELF-MATCH CHECK - START`);const V=he.current,D=R.partnerId;if(console.log("👥 COMPARISON VALUES:"),console.log("   myUserId type:",typeof V,"value:",V),console.log("   partnerUserId type:",typeof D,"value:",D),console.log("   Are they EQUAL?",V===D),console.log("   String comparison:",String(V)===String(D)),V===D){console.error(`
❌❌❌ CRITICAL ERROR: SELF-MATCH DETECTED! ❌❌❌`),console.error("   My user ID:",V,"type:",typeof V),console.error("   Partner user ID:",D,"type:",typeof D),console.error("   Match IDs:",V===D),console.error("   These should be DIFFERENT!"),Mt(!0),console.error("   Emitting skip_user..."),K.emit("skip_user",{partnerSocketId:R.socketId}),console.error("   Emitting find_partner..."),K.emit("find_partner",{userId:he.current,userName:te.name||"Anonymous",userAge:te.age||18,userLocation:te.location||"Unknown"}),console.error("   Returning - match REJECTED");return}console.log("✅ SELF-MATCH CHECK PASSED - partner is different user"),console.log("   Accepting match and proceeding with WebRTC setup"),console.log(`👥 SELF-MATCH CHECK - END
`),it.current=R.socketId,console.log("🔌 CRITICAL: Stored partner socket ID:",it.current),console.log("🔌 CRITICAL: Verification - partnerSocketIdRef.current is now:",it.current),console.log("🎬 ABOUT TO CALL setHasPartner(true)"),$(!0),console.log("🎬 ✅ setHasPartner(true) CALLED - force attach effect should trigger");const Q={...R,picture:R.userPicture||R.picture||null,userName:R.userName||R.name||"Anonymous",userLocation:R.userLocation||R.location||"Unknown",userAge:R.userAge||R.age||18};m(Q),console.log("🎬 ✅ setPartnerInfo CALLED with data:",Q);const U=K.id,le=R.socketId,me=U<le;if(console.log("🔍 SOCKET ID COMPARISON:"),console.log("   My socket ID:",U),console.log("   Partner socket ID:",le),console.log("   Am I offerer? (myID < partnerID):",me),console.log(`
🔐 ===== CRITICAL STREAM VERIFICATION =====`),console.log("🔐 Checking localStreamRef.current status:"),console.log("   exists:",!!J.current),console.log("   tracks:",((Pe=J.current)==null?void 0:Pe.getTracks().length)||0),console.log("   video element srcObject:",!!((qe=ae.current)!=null&&qe.srcObject)),!J.current){console.error("🔐 ❌ CRITICAL: localStreamRef.current is NULL - cannot proceed to WebRTC"),console.error("   This means the camera stream was never acquired or was lost"),console.error("   Attempting emergency camera reacquisition...");try{const fe=await navigator.mediaDevices.getUserMedia({video:{width:{ideal:640},height:{ideal:480}},audio:!0});if(J.current=fe,ae.current){ae.current.srcObject=fe,ae.current.muted=!0;try{await ae.current.play()}catch{console.warn("⚠️ Play error in emergency reacquisition")}}console.log("🔐 ✅ EMERGENCY: Camera stream re-acquired")}catch(fe){console.error("🔐 ❌ EMERGENCY FAILED: Could not reacquire camera -",fe.message),console.error("   User must allow camera permission to continue");return}}if(console.log(`🔐 ✅ STREAM VERIFICATION PASSED - proceeding with WebRTC
`),!me){console.log("📭 I am the ANSWERER - waiting for offer from offerer");return}console.log("📬 I am the OFFERER - creating peer connection and sending offer");try{if(console.log(`
🏠 OFFERER: Creating peer connection`),z.current){console.warn("⚠️ OFFERER: WARNING - Peer connection already exists! Not recreating."),console.warn("   Existing PC state:",{connectionState:z.current.connectionState,iceConnectionState:z.current.iceConnectionState,signalingState:z.current.signalingState});return}let fe;try{fe=await en()}catch(be){console.error("❌ OFFERER: Error creating peer connection:",be);return}if(z.current=fe,console.log("✅ OFFERER: Peer connection created"),console.log("📊 OFFERER Stream status after peer connection creation:",{exists:!!J.current,trackCount:(Ee=J.current)==null?void 0:Ee.getTracks().length,tracks:(je=J.current)==null?void 0:je.getTracks().map(be=>({kind:be.kind,enabled:be.enabled,state:be.readyState}))}),J.current){console.log(`
👤 OFFERER localStream:`,J.current);const be=J.current.getTracks();console.log("👤 OFFERER: All available tracks:",be),console.log("📹 OFFERER tracks detail:",be.map(Ue=>({kind:Ue.kind,id:Ue.id,enabled:Ue.enabled,state:Ue.readyState})));const Vt=fe.getSenders();if(console.log("📤 OFFERER: Existing senders count:",Vt.length),Vt.length>0)console.warn("⚠️ OFFERER WARNING: Tracks already added! Senders:",Vt.map(Ue=>{var Oe,mt;return{kind:(Oe=Ue.track)==null?void 0:Oe.kind,id:(mt=Ue.track)==null?void 0:mt.id}})),console.warn("   Not adding tracks again to avoid duplicates");else{console.log(`
📹 OFFERER: Adding ${be.length} local tracks to peer connection`),be.forEach((Oe,mt)=>{console.log(`  [${mt}] Adding ${Oe.kind} track (id: ${Oe.id}, enabled: ${Oe.enabled})`);try{const Ut=fe.addTrack(Oe,J.current);console.log(`  [${mt}] ✅ addTrack succeeded, sender:`,Ut)}catch(Ut){console.error(`  [${mt}] ❌ addTrack failed:`,Ut)}}),console.log(`
...
`)}}else console.error("❌ OFFERER: No local stream available - TRACKS WILL NOT BE SENT!"),console.error("❌ OFFERER: localStreamRef.current is:",J.current);console.log(`
...
📤 OFFERER: Sending offer with tracks:`,fe.getSenders().map(be=>{var Vt,Ue,Oe;return{kind:(Vt=be.track)==null?void 0:Vt.kind,id:(Ue=be.track)==null?void 0:Ue.id,enabled:(Oe=be.track)==null?void 0:Oe.enabled}})),console.log("📤 OFFERER: Partner socket ID from data:",R.socketId),console.log("📤 OFFERER: partnerSocketIdRef.current value:",it.current),console.log("🔌🔌🔌 CRITICAL: About to emit webrtc_offer with to:",R.socketId),console.log("🔌🔌🔌 CRITICAL: Is to value empty/null/undefined?",!R.socketId),K.emit("webrtc_offer",{offer:z.current.localDescription,to:R.socketId}),console.log("✅ OFFERER: webrtc_offer emitted successfully"),console.log("✅ OFFERER: webrtc_offer sent to socket ID:",R.socketId),console.log("✅ OFFERER: webrtc_offer contains",z.current.getSenders().length,"senders"),console.log("✅ OFFERER: Sent to socket:",R.socketId)}catch(fe){console.error("❌ OFFERER: Error in partner_found handler:",fe),console.error("❌ OFFERER: Stack trace:",fe.stack)}}),K.on("webrtc_offer",async R=>{console.log(`
...
🔍 ANSWERER: ALWAYS executing track addition logic`),console.log("👤 ANSWERER: Checking localStreamRef.current..."),console.log("👤 ANSWERER localStreamRef.current:",J.current),console.log("👤 ANSWERER localStreamRef.current === null?",J.current===null),console.log("👤 ANSWERER localStreamRef.current === undefined?",J.current===void 0),!J.current){console.warn("⚠️ ANSWERER: localStreamRef.current is NULL - attempting emergency reacquisition");try{const U=await navigator.mediaDevices.getUserMedia({video:{width:{ideal:640},height:{ideal:480}},audio:!0});if(J.current=U,ae.current){ae.current.srcObject=U,ae.current.muted=!0;try{await ae.current.play()}catch{console.warn("⚠️ Play error in answerer emergency reacquisition")}}console.log("✅ ANSWERER: Emergency stream acquisition successful")}catch(U){throw console.error("❌ ANSWERER: Emergency stream acquisition failed:",U.message),new Error("ANSWERER: Cannot reacquire camera stream - "+U.message)}}if(J.current){console.log(`
✅ ANSWERER: localStream EXISTS - will add tracks`),console.log("📊 ANSWERER localStream object:",J.current);const U=J.current.getTracks();console.log("👤 ANSWERER: getAllTracks() returned:",U),console.log("👤 ANSWERER: Track array length:",U.length),U.length>0?console.log("👤 ANSWERER: Tracks detail:",U.map(me=>({kind:me.kind,id:me.id,enabled:me.enabled,readyState:me.readyState}))):console.warn("⚠️ ANSWERER: WARNING - localStream exists but getTracks() returned empty array!");const le=z.current.getSenders();if(console.log("📤 ANSWERER: Existing senders count:",le.length),le.length>0)console.warn("⚠️ ANSWERER WARNING: Tracks already added! Senders:",le.map(me=>{var Pe,qe;return{kind:(Pe=me.track)==null?void 0:Pe.kind,id:(qe=me.track)==null?void 0:qe.id}})),console.warn("   Not adding tracks again to avoid duplicates");else{console.log(`
📹 ANSWERER: Attempting to add ${U.length} local tracks to peer connection`);let me=0,Pe=0;U.forEach((Ee,je)=>{console.log(`  [${je}] About to add ${Ee.kind} track (id: ${Ee.id}, enabled: ${Ee.enabled})`);try{const fe=z.current.addTrack(Ee,J.current);console.log(`  [${je}] ✅ addTrack SUCCEEDED`),console.log(`  [${je}] Sender:`,fe),me++}catch(fe){console.error(`  [${je}] ❌ addTrack FAILED`),console.error(`  [${je}] Error:`,fe.message),Pe++}}),console.log(`
✅ ANSWERER: Track addition complete (${me} succeeded, ${Pe} failed)`);const qe=z.current.getSenders();console.log("📤 ANSWERER: Final senders count:",qe.length),console.log("📤 ANSWERER: Senders:",qe.map((Ee,je)=>{var fe,ut,ot;return{index:je,kind:(fe=Ee.track)==null?void 0:fe.kind,id:(ut=Ee.track)==null?void 0:ut.id,trackExists:!!Ee.track,trackEnabled:(ot=Ee.track)==null?void 0:ot.enabled}}))}}else throw console.error(`
...
🔄 ANSWERER: Setting remote description (offer from offerer)`),await z.current.setRemoteDescription(new RTCSessionDescription(R.offer)),console.log("✅ ANSWERER: Remote description set successfully"),console.log("🎬 ANSWERER: Creating answer");const V=await z.current.createAnswer({offerToReceiveVideo:!0,offerToReceiveAudio:!0});console.log("✅ ANSWERER: Answer created with receive constraints"),console.log("📋 ANSWERER SDP CHECK - Looking for a=sendrecv:");const D=V.sdp.split(`
`).filter(U=>U.includes("sendrecv")||U.includes("recvonly")||U.includes("sendonly"));console.log("   Media direction lines:"),D.forEach(U=>console.log("   ",U)),console.log("🔄 ANSWERER: Setting local description (answer)"),await z.current.setLocalDescription(V),console.log("✅ ANSWERER: Local description set successfully"),console.log(`
📋 ===== ANSWERER SENDING ANSWER =====`);const Q=z.current.getSenders();console.log("📤 ANSWERER: Final senders count:",Q.length),console.log("📤 ANSWERER: Sending answer with tracks:",Q.map(U=>{var le,me,Pe;return{kind:(le=U.track)==null?void 0:le.kind,id:(me=U.track)==null?void 0:me.id,enabled:(Pe=U.track)==null?void 0:Pe.enabled}})),console.log("🔌 CRITICAL: Offerer socket ID from offer:",R.from),console.log("🔌 SERVER sending ANSWER to:",R.from),K.emit("webrtc_answer",{answer:z.current.localDescription,to:R.from}),console.log("📤 ANSWERER: Answer emitted to offerer via socket:",R.from),console.log(`📋 ===== ANSWERER ANSWER SENT =====

`)}catch(V){console.error(`
❌ ANSWERER: ERROR in webrtc_offer handler:`,V),console.error("❌ ANSWERER: Error message:",V.message),console.error("❌ ANSWERER: Stack trace:",V.stack)}}),K.on("webrtc_answer",async R=>{console.log(`
...
`)}catch(V){console.error("❌ OFFERER: Error handling answer:",V),console.error("❌ OFFERER: Stack trace:",V.stack)}}),K.on("ice_candidate",async R=>{if(console.log(`
...
`)):console.warn("⚠️ No peer connection available for ICE candidate")}catch(V){console.error("❌ Error adding ICE candidate:",V)}}),K.on("partner_disconnected",R=>{console.log(`
