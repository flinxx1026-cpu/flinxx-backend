import{r as A,a as Td,R as zt,u as dt,b as Ad,c as yc,B as Cd,d as Sd,e as gt}from"./vendor-CWYb8WqM.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))r(s);new MutationObserver(s=>{for(const o of s)if(o.type==="childList")for(const a of o.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&r(a)}).observe(document,{childList:!0,subtree:!0});function t(s){const o={};return s.integrity&&(o.integrity=s.integrity),s.referrerPolicy&&(o.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?o.credentials="include":s.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function r(s){if(s.ep)return;s.ep=!0;const o=t(s);fetch(s.href,o)}})();var vc={exports:{}},oi={};/**
 * @license React
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class zr{constructor(e,t){this.shortDelay=e,this.longDelay=t,Yt(t>e,"Short delay should be less than long delay!"),this.isMobile=Kd()||Yd()}get(){return bp()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const pl=new Map;function qt(n){Yt(n instanceof Function,"Expected a class definition");let e=pl.get(n);return e?(Yt(e instanceof n,"Instance stored in cache mismatched with class"),e):(e=new n,pl.set(n,e),e)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Fp(n,e={}){return tr(n,"GET","/v2/passwordPolicy",Oo(n,e))}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class sn extends Kr{constructor(){super("github.com")}static credential(e){return Tn._fromParams({providerId:sn.PROVIDER_ID,signInMethod:sn.GITHUB_SIGN_IN_METHOD,accessToken:e})}static credentialFromResult(e){return sn.credentialFromTaggedObject(e)}static credentialFromError(e){return sn.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e||!("oauthAccessToken"in e)||!e.oauthAccessToken)return null;try{return sn.credential(e.oauthAccessToken)}catch{return null}}}sn.GITHUB_SIGN_IN_METHOD="github.com";sn.PROVIDER_ID="github.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class on extends Kr{constructor(){super("twitter.com")}static credential(e,t){return Tn._fromParams({providerId:on.PROVIDER_ID,signInMethod:on.TWITTER_SIGN_IN_METHOD,oauthToken:e,oauthTokenSecret:t})}static credentialFromResult(e){return on.credentialFromTaggedObject(e)}static credentialFromError(e){return on.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e)return null;const{oauthAccessToken:t,oauthTokenSecret:r}=e;if(!t||!r)return null;try{return on.credential(t,r)}catch{return null}}}on.TWITTER_SIGN_IN_METHOD="twitter.com";on.PROVIDER_ID="twitter.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Fo(n,e){return e?qt(e):(J(n._popupRedirectResolver,n,"argument-error"),n._popupRedirectResolver)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function km(n,e,t){return Pm(n,e,t)}async function Pm(n,e,t){if(At(n.app))return Promise.reject(cn(n));const r=nr(n);Mc(n,e,ci),await r._initializationPromise;const s=Fo(r,t);return await Rm(s,r),s._openRedirect(r,e,"signInViaRedirect")}async function jm(n,e){return await nr(n)._initializationPromise,fu(n,e,!1)}async function fu(n,e,t=!1){if(At(n.app))return Promise.reject(cn(n));const r=nr(n),s=Fo(r,e),a=await new Cm(r,s,t).execute();return a&&!t&&(delete a.user._redirectEventId,await r._persistUserIfCurrent(a.user),await r._setRedirectUser(null,e)),a}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Gi="webStorageSupport";class cg{constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=iu,this._completeRedirectFn=fu,this._overrideRedirectResult=Nm}async _openPopup(e,t,r,s){var o;Yt((o=this.eventManagers[e._key()])===null||o===void 0?void 0:o.manager,"_initialize() not called before _openPopup()");const a=await Tl(e,t,r,oo(),s);return rg(e,a,Vo())}async _openRedirect(e,t,r,s){await this._originValidation(e);const o=await Tl(e,t,r,oo(),s);return hm(o),new Promise(()=>{})}_initialize(e){const t=e._key();if(this.eventManagers[t]){const{manager:s,promise:o}=this.eventManagers[t];return s?Promise.resolve(s):(Yt(o,"If manager is not set, promise should be"),o)}const r=this.initAndGetManager(e);return this.eventManagers[t]={promise:r},r.catch(()=>{delete this.eventManagers[t]}),r}async initAndGetManager(e){const t=await Ym(e),r=new Dm(e);return t.register("authEvent",s=>(J(s==null?void 0:s.authEvent,e,"invalid-auth-event"),{status:r.onEvent(s.authEvent)?"ACK":"ERROR"}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[e._key()]={manager:r},this.iframes[e._key()]=t,r}_isIframeWebStorageSupported(e,t){this.iframes[e._key()].send(Gi,{type:Gi},s=>{var o;const a=(o=s==null?void 0:s[0])===null||o===void 0?void 0:o[Gi];a!==void 0&&t(!!a),Rt(e,"internal-error")},gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(e){const t=e._key();return this.originValidationPromises[t]||(this.originValidationPromises[t]=Um(e)),this.originValidationPromises[t]}get _shouldInitProactively(){return Yc()||Hc()||Lo()}}const ug=cg;var Al="@firebase/auth",Cl="1.7.9";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function oe(n="Unexpected state"){const e=`FIRESTORE (${rr}) INTERNAL ASSERTION FAILED: `+n;throw Cn(e),new Error(e)}function Ce(n,e){n||oe()}function ve(n,e){return n}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Eu(n){if(n.code!==D.FAILED_PRECONDITION||n.message!==jg)throw n;H("LocalStore","Unexpectedly lost primary lease")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Go(n){var e,t;return((t=(((e=n==null?void 0:n.mapValue)===null||e===void 0?void 0:e.fields)||{}).__type__)===null||t===void 0?void 0:t.stringValue)==="server_timestamp"}function Au(n){const e=n.mapValue.fields.__previous_value__;return Go(e)?Au(e):e}function Js(n){const e=Sn(n.mapValue.fields.__local_write_time__.timestampValue);return new Ve(e.seconds,e.nanos)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Qy{constructor(){this.Gi=!1,this.zi=!1,this.ji=100,this.Hi=function(){return Zd()?8:Dg(Ye())>0?6:4}()}initialize(e,t){this.Ji=e,this.indexManager=t,this.Gi=!0}getDocumentsMatchingQuery(e,t,r,s){const o={result:null};return this.Yi(e,t).next(a=>{o.result=a}).next(()=>{if(!o.result)return this.Zi(e,t,s,r).next(a=>{o.result=a})}).next(()=>{if(o.result)return;const a=new Jy;return this.Xi(e,t,a).next(u=>{if(o.result=u,this.zi)return this.es(e,t,a,u.size)})}).next(()=>o.result)}es(e,t,r,s){return r.documentReadCount<this.ji?(br()<=ie.DEBUG&&H("QueryEngine","SDK will not create cache indexes for query:",Er(t),"since it only creates cache indexes for collection contains","more than or equal to",this.ji,"documents"),O.resolve()):(br()<=ie.DEBUG&&H("QueryEngine","Query:",Er(t),"scans",r.documentReadCount,"local documents and returns",s,"documents as results."),r.documentReadCount>this.Hi*s?(br()<=ie.DEBUG&&H("QueryEngine","The SDK decides to create cache indexes for query:",Er(t),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(e,xn(t))):O.resolve())}Yi(e,t){if(Vl(t))return O.resolve(null);let r=xn(t);return this.indexManager.getIndexType(e,r).next(s=>s===0?null:(t.limit!==null&&s===1&&(t=po(t,null,"F"),r=xn(t)),this.indexManager.getDocumentsMatchingTarget(e,r).next(o=>{const a=Je(...o);return this.Ji.getDocuments(e,a).next(u=>this.indexManager.getMinOffset(e,r).next(h=>{const f=this.ts(t,u);return this.ns(t,f,a,h.readTime)?this.Yi(e,po(t,null,"F")):this.rs(e,f,t,h)}))})))}Zi(e,t,r,s){return Vl(t)||s.isEqual(be.min())?O.resolve(null):this.Ji.getDocuments(e,r).next(o=>{const a=this.ts(t,o);return this.ns(t,a,r,s)?O.resolve(null):(br()<=ie.DEBUG&&H("QueryEngine","Re-using previous result from %s to execute query: %s",s.toString(),Er(t)),this.rs(e,a,t,Ng(s,-1)).next(u=>u))})}ts(e,t){let r=new Qe(ny(e));return t.forEach((s,o)=>{zo(e,o)&&(r=r.add(o))}),r}ns(e,t,r,s){if(e.limit===null)return!1;if(r.size!==t.size)return!0;const o=e.limitType==="F"?t.last():t.first();return!!o&&(o.hasPendingWrites||o.version.compareTo(s)>0)}Xi(e,t,r){return br()<=ie.DEBUG&&H("QueryEngine","Using full collection scan to execute query:",Er(t)),this.Ji.getDocumentsMatchingQuery(e,t,hn.min(),r)}rs(e,t,r,s){return this.Ji.getDocumentsMatchingQuery(e,r,s).next(o=>(t.forEach(a=>{o=o.insert(a.key,a)}),o))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`),!1}},[S]);A.useEffect(()=>{pn.current={reinitializeCamera:ur}},[ur]),A.useEffect(()=>{if(!de)return;const P=setInterval(()=>{_(V=>V+1)},1e3);return()=>clearInterval(P)},[de]),A.useEffect(()=>{B&&S&&console.log("🎬 [PARTNER FOUND] Transitioning to video chat screen")},[B,S]);const ss=async()=>{var P;try{if(console.log("📹 [START CAMERA] User clicked to start camera"),console.log("📹 [START CAMERA] Checking DOM state..."),console.log("   localVideoRef.current:",!!ae.current),console.log("   localVideoRef.current in DOM:",(P=ae.current)!=null&&P.parentElement?"YES":"NO"),console.log("   All videos in DOM:",document.querySelectorAll("video").length),!ae.current){console.error("📹 [START CAMERA] ❌ Video element not in DOM - cannot proceed");return}console.log("📹 [START CAMERA] Requesting camera from browser...");const V=await navigator.mediaDevices.getUserMedia({video:!0,audio:!1});Zt.current=V,X.current=V,console.log("📹 [START CAMERA] ✅ Stream obtained:",V),console.log("📹 [START CAMERA] Stream tracks:",V.getTracks().map(M=>({kind:M.kind,enabled:M.enabled,id:M.id}))),ae.current&&(ae.current.srcObject=V,console.log("📹 [START CAMERA] ✅ Stream attached to video element"),ae.current.onloadedmetadata=()=>{console.log("📹 [START CAMERA] ✅ Video metadata loaded, calling play()"),ae.current.play().then(()=>{console.log("📹 [START CAMERA] ✅ Video playing - setting isLocalCameraReady=true"),Tt(!0)}).catch(M=>{console.warn("📹 [START CAMERA] ⚠️ Play warning (but video loaded):",M.message),Tt(!0)})})}catch(V){console.error("📹 [START CAMERA] ❌ CRITICAL ERROR:",V),console.error("   Error name:",V.name),console.error("   Error message:",V.message),V.name==="NotAllowedError"?console.error("❌ Camera permission DENIED by user - User clicked deny in browser prompt"):V.name==="NotFoundError"?console.error("❌ No camera device found - Check if device has a camera"):V.name==="NotReadableError"?console.error("❌ Camera is already in use by another app - Close other apps using camera"):V.name==="SecurityError"&&console.error("❌ Camera access blocked by security policy - Must use HTTPS")}};A.useEffect(()=>()=>{console.log("📹 [DASHBOARD CLEANUP] Component unmounting"),console.log("📹 [DASHBOARD CLEANUP] ⚠️ NOT stopping camera - will be reused on return")},[]),A.useEffect(()=>{const P=setTimeout(()=>{ot&&X.current&&(console.log("📹 [VERIFY] Stream attached:",{srcObject:!!ot.srcObject,paused:ot.paused,tracks:X.current.getTracks().length,readyState:ot.readyState,networkState:ot.networkState}),ot.paused&&(console.log("📹 [VERIFY] Video is paused, attempting play..."),ot.play().catch(V=>{console.warn("📹 [VERIFY] Play failed:",V.message)})))},1e3);return()=>clearTimeout(P)},[]);const en=async()=>{if(console.log("🔧 createPeerConnection called"),console.log("   Current localStreamRef:",X.current),!X.current){console.warn("⚠️ CRITICAL: localStreamRef.current is null - attempting to reacquire camera stream");try{const ee=await navigator.mediaDevices.getUserMedia({video:{width:{ideal:640},height:{ideal:480}},audio:!0});if(X.current=ee,ae.current){ae.current.srcObject=ee,ae.current.muted=!0;try{await ae.current.play()}catch(U){console.warn("⚠️ Play error during reacquisition:",U)}}console.log("✅ LOCAL STREAM RE-ACQUIRED SUCCESSFULLY"),console.log("   Tracks:",ee.getTracks().map(U=>({kind:U.kind,id:U.id})))}catch(ee){throw console.error("❌ FATAL: Could not reacquire camera stream:",ee.message),new Error("Cannot proceed: local camera stream unavailable - "+ee.message)}}AI();const P=await hr(),V=[{urls:["stun:global.xirsys.net","turn:global.xirsys.net:3478?transport=udp","turn:global.xirsys.net:3478?transport=tcp"],username:"nkhlvdv",credential:"a8e244b8-cf5b-11f0-8771-0242ac140002"},...P];console.log("🔧 ICE Servers Configuration:",{count:V.length,servers:V.map(ee=>({urls:ee.urls,username:ee.username?"***":void 0,credential:ee.credential?"***":void 0}))});const M=new RTCPeerConnection({iceServers:V,iceTransportPolicy:"all"});if(z.current=M,console.log("✅ RTCPeerConnection created with iceTransportPolicy: all"),M.onicecandidate=ee=>{if(ee.candidate){const U=ee.candidate;console.log("🧊 ICE candidate generated:",{candidate:U.candidate,protocol:U.protocol,port:U.port,address:U.address,type:U.type,priority:U.priority,sdpMLineIndex:U.sdpMLineIndex,sdpMId:U.sdpMid}),U.type==="relay"?(console.log("🔄 RELAY (TURN) candidate generated - TURN server is reachable"),console.log("   Protocol:",U.protocol,"Port:",U.port)):U.type==="srflx"?(console.log("📍 SRFLX (server reflexive) candidate - STUN working"),console.log("   Found public address via STUN")):U.type==="host"&&console.log("🏠 HOST candidate - direct LAN connection possible"),console.log("🔌 Sending ICE candidate to partner socket:",st.current),K.emit("ice_candidate",{candidate:U,to:st.current}),console.log("📤 ICE candidate sent to peer")}else console.log("🧊 ICE gathering complete (null candidate received)"),console.log("📊 ICE gathering summary:"),console.log("   Connection State:",M.connectionState),console.log("   ICE Connection State:",M.iceConnectionState),console.log("   ICE Gathering State:",M.iceGatheringState)},M.oniceconnectionstatechange=()=>{const ee=M.iceConnectionState;switch(console.log(`
...
🔴🔴🔴 ===== CRITICAL: ONTRACK HANDLER FIRING! =====`),console.log("🔴 ONTRACK CALLED AT:",new Date().toISOString()),console.log("🔴 Track received:",{kind:ee.track.kind,id:ee.track.id,enabled:ee.track.enabled});const U=z.current._remoteStream;if(console.log("🔴 Using persistent remote stream ID:",U.id),U.addTrack(ee.track),console.log("✅ Track added to persistent remote stream"),console.log("📥 Remote stream now has",U.getTracks().length,"track(s)"),console.log("📥 Tracks:",U.getTracks().map(le=>({kind:le.kind,id:le.id,enabled:le.enabled}))),!lt.current){console.error("❌ CRITICAL ERROR: remoteVideoRef.current is NULL!"),console.error("   Cannot attach remote track - video element not available");return}lt.current.srcObject!==U?(console.log("📺 ATTACHING PERSISTENT STREAM to remoteVideoRef"),lt.current.srcObject=U,lt.current.muted=!1,console.log("📺 srcObject attached, attempting play()..."),lt.current.play().catch(()=>{console.log("ℹ️ Autoplay blocked - will play on user interaction")})):(console.log("📺 STREAM ALREADY ATTACHED - skipping re-attachment"),console.log("   Stream has",U.getTracks().length,"tracks now")),console.log(`✅ ✅ ✅ ONTRACK COMPLETE - Remote stream persisted and attached
...
📊 ===== RECEIVER DEBUG CHECK (after connected) =====`);const ee=M.getReceivers();console.log("📊 Total receivers:",ee.length),ee.forEach((le,xe)=>{var Ie,Ge,Se,Ae,pe;console.log(`📊 Receiver ${xe}:`,{kind:(Ie=le.track)==null?void 0:Ie.kind,enabled:(Ge=le.track)==null?void 0:Ge.enabled,readyState:(Se=le.track)==null?void 0:Se.readyState,id:(Ae=le.track)==null?void 0:Ae.id,muted:(pe=le.track)==null?void 0:pe.muted})}),console.log("📊 Audio and video tracks should be present above");const U=M.getSenders();console.log(`
📊 Total senders:`,U.length),U.forEach((le,xe)=>{var Ie,Ge,Se,Ae;console.log(`📊 Sender ${xe}:`,{kind:(Ie=le.track)==null?void 0:Ie.kind,enabled:(Ge=le.track)==null?void 0:Ge.enabled,readyState:(Se=le.track)==null?void 0:Se.readyState,id:(Ae=le.track)==null?void 0:Ae.id})})},1e3)):M.connectionState==="disconnected"?(L(!1),console.log("⚠️ WebRTC connection DISCONNECTED")):M.connectionState==="failed"?(L(!1),console.log("❌ WebRTC connection FAILED")):M.connectionState==="closed"&&(L(!1),console.log("❌ WebRTC connection CLOSED"))},!X.current)throw console.error("❌ CRITICAL ERROR: localStreamRef.current is null/undefined in createPeerConnection!"),new Error("Local stream lost before createPeerConnection");return M};A.useEffect(()=>(console.log(`
...
📋 ===== PARTNER FOUND EVENT RECEIVED =====`),console.log("👥 RAW DATA from server:",JSON.stringify(P,null,2)),console.log("👥 My socket ID:",K.id),console.log("👥 currentUser object:",JSON.stringify(te,null,2)),console.log("👥 userIdRef.current (SHOULD USE THIS):",he.current),console.log("👥 currentUser.googleId:",te==null?void 0:te.googleId),console.log("👥 currentUser.id:",te==null?void 0:te.id),console.log("👥 data.socketId:",P.socketId),console.log("👥 data.partnerId:",P.partnerId),console.log("👥 data.userName:",P.userName),E(!1),Z(!0),Dt(!1),console.log(`
👥 SELF-MATCH CHECK - START`);const V=he.current,M=P.partnerId;if(console.log("👥 COMPARISON VALUES:"),console.log("   myUserId type:",typeof V,"value:",V),console.log("   partnerUserId type:",typeof M,"value:",M),console.log("   Are they EQUAL?",V===M),console.log("   String comparison:",String(V)===String(M)),V===M){console.error(`
❌❌❌ CRITICAL ERROR: SELF-MATCH DETECTED! ❌❌❌`),console.error("   My user ID:",V,"type:",typeof V),console.error("   Partner user ID:",M,"type:",typeof M),console.error("   Match IDs:",V===M),console.error("   These should be DIFFERENT!"),Dt(!0),console.error("   Emitting skip_user..."),K.emit("skip_user",{partnerSocketId:P.socketId}),console.error("   Emitting find_partner..."),K.emit("find_partner",{userId:he.current,userName:te.name||"Anonymous",userAge:te.age||18,userLocation:te.location||"Unknown"}),console.error("   Returning - match REJECTED");return}console.log("✅ SELF-MATCH CHECK PASSED - partner is different user"),console.log("   Accepting match and proceeding with WebRTC setup"),console.log(`👥 SELF-MATCH CHECK - END
`),st.current=P.socketId,console.log("🔌 CRITICAL: Stored partner socket ID:",st.current),console.log("🔌 CRITICAL: Verification - partnerSocketIdRef.current is now:",st.current),console.log("🎬 ABOUT TO CALL setHasPartner(true)"),$(!0),console.log("🎬 ✅ setHasPartner(true) CALLED - force attach effect should trigger");const ee={...P,picture:P.userPicture||P.picture||null,userName:P.userName||P.name||"Anonymous",userLocation:P.userLocation||P.location||"Unknown",userAge:P.userAge||P.age||18};m(ee),console.log("🎬 ✅ setPartnerInfo CALLED with data:",ee);const U=K.id,le=P.socketId,xe=U<le;if(console.log("🔍 SOCKET ID COMPARISON:"),console.log("   My socket ID:",U),console.log("   Partner socket ID:",le),console.log("   Am I offerer? (myID < partnerID):",xe),console.log(`
🔐 ===== CRITICAL STREAM VERIFICATION =====`),console.log("🔐 Checking localStreamRef.current status:"),console.log("   exists:",!!X.current),console.log("   tracks:",((Ie=X.current)==null?void 0:Ie.getTracks().length)||0),console.log("   video element srcObject:",!!((Ge=ae.current)!=null&&Ge.srcObject)),!X.current){console.error("🔐 ❌ CRITICAL: localStreamRef.current is NULL - cannot proceed to WebRTC"),console.error("   This means the camera stream was never acquired or was lost"),console.error("   Attempting emergency camera reacquisition...");try{const pe=await navigator.mediaDevices.getUserMedia({video:{width:{ideal:640},height:{ideal:480}},audio:!0});if(X.current=pe,ae.current){ae.current.srcObject=pe,ae.current.muted=!0;try{await ae.current.play()}catch{console.warn("⚠️ Play error in emergency reacquisition")}}console.log("🔐 ✅ EMERGENCY: Camera stream re-acquired")}catch(pe){console.error("🔐 ❌ EMERGENCY FAILED: Could not reacquire camera -",pe.message),console.error("   User must allow camera permission to continue");return}}if(console.log(`🔐 ✅ STREAM VERIFICATION PASSED - proceeding with WebRTC
...
🏠 OFFERER: Creating peer connection`),z.current){console.warn("⚠️ OFFERER: WARNING - Peer connection already exists! Not recreating."),console.warn("   Existing PC state:",{connectionState:z.current.connectionState,iceConnectionState:z.current.iceConnectionState,signalingState:z.current.signalingState});return}let pe;try{pe=await en()}catch(fe){console.error("❌ OFFERER: Error creating peer connection:",fe);return}if(z.current=pe,console.log("✅ OFFERER: Peer connection created"),console.log("📊 OFFERER Stream status after peer connection creation:",{exists:!!X.current,trackCount:(Se=X.current)==null?void 0:Se.getTracks().length,tracks:(Ae=X.current)==null?void 0:Ae.getTracks().map(fe=>({kind:fe.kind,enabled:fe.enabled,state:fe.readyState}))}),X.current){console.log(`
👤 OFFERER localStream:`,X.current);const fe=X.current.getTracks();console.log("👤 OFFERER: All available tracks:",fe),console.log("📹 OFFERER tracks detail:",fe.map(We=>({kind:We.kind,id:We.id,enabled:We.enabled,state:We.readyState})));const Vt=pe.getSenders();if(console.log("📤 OFFERER: Existing senders count:",Vt.length),Vt.length>0)console.warn("⚠️ OFFERER WARNING: Tracks already added! Senders:",Vt.map(We=>{var je,ct;return{kind:(je=We.track)==null?void 0:je.kind,id:(ct=We.track)==null?void 0:ct.id}})),console.warn("   Not adding tracks again to avoid duplicates");else{console.log(`
📹 OFFERER: Adding ${fe.length} local tracks to peer connection`),fe.forEach((je,ct)=>{console.log(`  [${ct}] Adding ${je.kind} track (id: ${je.id}, enabled: ${je.enabled})`);try{const Ft=pe.addTrack(je,X.current);console.log(`  [${ct}] ✅ addTrack succeeded, sender:`,Ft)}catch(Ft){console.error(`  [${ct}] ❌ addTrack failed:`,Ft)}}),console.log(`
✅ OFFERER: All tracks added to peer connection`);const We=pe.getSenders();console.log("📤 OFFERER senders count:",We.length),console.log("📤 OFFERER senders after addTrack:",We.map((je,ct)=>{var Ft,fr,as;return{index:ct,kind:(Ft=je.track)==null?void 0:Ft.kind,id:(fr=je.track)==null?void 0:fr.id,trackExists:!!je.track,trackEnabled:(as=je.track)==null?void 0:as.enabled}})),console.log("🚀 OFFERER: Ready to send offer with",fe.length,`tracks
...
📤 OFFERER: Sending offer with tracks:`,pe.getSenders().map(fe=>{var Vt,We,je;return{kind:(Vt=fe.track)==null?void 0:Vt.kind,id:(We=fe.track)==null?void 0:We.id,enabled:(je=fe.track)==null?void 0:je.enabled}})),console.log("📤 OFFERER: Partner socket ID from data:",P.socketId),console.log("📤 OFFERER: partnerSocketIdRef.current value:",st.current),console.log("🔌🔌🔌 CRITICAL: About to emit webrtc_offer with to:",P.socketId),console.log("🔌🔌🔌 CRITICAL: Is to value empty/null/undefined?",!P.socketId),K.emit("webrtc_offer",{offer:z.current.localDescription,to:P.socketId}),console.log("✅ OFFERER: webrtc_offer emitted successfully"),console.log("✅ OFFERER: webrtc_offer sent to socket ID:",P.socketId),console.log("✅ OFFERER: webrtc_offer contains",z.current.getSenders().length,"senders"),console.log("✅ OFFERER: Sent to socket:",P.socketId)}catch(pe){console.error("❌ OFFERER: Error in partner_found handler:",pe),console.error("❌ OFFERER: Stack trace:",pe.stack)}}),K.on("webrtc_offer",async P=>{console.log(`
...
🔍 ANSWERER: ALWAYS executing track addition logic`),console.log("👤 ANSWERER: Checking localStreamRef.current..."),console.log("👤 ANSWERER localStreamRef.current:",X.current),console.log("👤 ANSWERER localStreamRef.current === null?",X.current===null),console.log("👤 ANSWERER localStreamRef.current === undefined?",X.current===void 0),!X.current){console.warn("⚠️ ANSWERER: localStreamRef.current is NULL - attempting emergency reacquisition");try{const U=await navigator.mediaDevices.getUserMedia({video:{width:{ideal:640},height:{ideal:480}},audio:!0});if(X.current=U,ae.current){ae.current.srcObject=U,ae.current.muted=!0;try{await ae.current.play()}catch{console.warn("⚠️ Play error in answerer emergency reacquisition")}}console.log("✅ ANSWERER: Emergency stream acquisition successful")}catch(U){throw console.error("❌ ANSWERER: Emergency stream acquisition failed:",U.message),new Error("ANSWERER: Cannot reacquire camera stream - "+U.message)}}if(X.current){console.log(`
...
🔄 ANSWERER: Setting remote description (offer from offerer)`),await z.current.setRemoteDescription(new RTCSessionDescription(P.offer)),console.log("✅ ANSWERER: Remote description set successfully"),console.log("🎬 ANSWERER: Creating answer");const V=await z.current.createAnswer({offerToReceiveVideo:!0,offerToReceiveAudio:!0});console.log("✅ ANSWERER: Answer created with receive constraints"),console.log("📋 ANSWERER SDP CHECK - Looking for a=sendrecv:");const M=V.sdp.split(`
`).filter(U=>U.includes("sendrecv")||U.includes("recvonly")||U.includes("sendonly"));console.log("   Media direction lines:"),M.forEach(U=>console.log("   ",U)),console.log("🔄 ANSWERER: Setting local description (answer)"),await z.current.setLocalDescription(V),console.log("✅ ANSWERER: Local description set successfully"),console.log(`
📋 ===== ANSWERER SENDING ANSWER =====`);const ee=z.current.getSenders();console.log("📤 ANSWERER: Final senders count:",ee.length),console.log("📤 ANSWERER: Sending answer with tracks:",ee.map(U=>{var le,xe,Ie;return{kind:(le=U.track)==null?void 0:le.kind,id:(xe=U.track)==null?void 0:xe.id,enabled:(Ie=U.track)==null?void 0:Ie.enabled}})),console.log("🔌 CRITICAL: Offerer socket ID from offer:",P.from),console.log("🔌 SERVER sending ANSWER to:",P.from),K.emit("webrtc_answer",{answer:z.current.localDescription,to:P.from}),console.log("📤 ANSWERER: Answer emitted to offerer via socket:",P.from),console.log(`📋 ===== ANSWERER ANSWER SENT =====

`)}catch(V){console.error(`
❌ ANSWERER: ERROR in webrtc_offer handler:`,V),console.error("❌ ANSWERER: Error message:",V.message),console.error("❌ ANSWERER: Stack trace:",V.stack)}}),K.on("webrtc_answer",async P=>{console.log(`
...
`)}catch(V){console.error("❌ OFFERER: Error handling answer:",V),console.error("❌ OFFERER: Stack trace:",V.stack)}}),K.on("ice_candidate",async P=>{if(console.log(`
...
`)):console.warn("⚠️ No peer connection available for ICE candidate")}catch(V){console.error("❌ Error adding ICE candidate:",V)}}),K.on("partner_disconnected",P=>{console.log(`

🔴🔴🔴🔴🔴 ===== PARTNER DISCONNECTED EVENT RECEIVED ===== 🔴🔴🔴🔴🔴`),console.log("🔴 Event Data:",P),console.log("🔴 Timestamp:",new Date().toISOString()),console.log("🔴 Partner has closed the browser/tab"),console.log("🔴 Cleaning up WebRTC connection..."),z.current?(console.log("🔴 Closing peer connection"),console.log("   Current state:",z.current.connectionState),z.current.close(),z.current=null,console.log("🔴 Peer connection closed successfully")):console.log("🔴 WARNING: peerConnectionRef.current was null"),lt.current&&(console.log("🔴 Clearing remote video ref"),lt.current.srcObject=null),console.log("🔴 Calling endChat() to reset UI"),is(),console.log("🔴🔴🔴 Cleanup complete - ready for new partner")}),K.on("disconnect",()=>{console.log("Socket disconnected"),Vn()}),console.log(`
